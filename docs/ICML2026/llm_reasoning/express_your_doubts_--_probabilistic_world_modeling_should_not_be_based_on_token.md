...
description: >-
  [ICML 2026 (Position Paper)][LLM Reasoning][token logprob] This position paper argues that **using the token softmax probabilities (logprob) of LLMs as "world event probabilities" is theoretically incorrect**—because dis…
tags:
