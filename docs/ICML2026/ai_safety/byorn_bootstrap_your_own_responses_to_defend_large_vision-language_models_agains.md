...
description: >-
  [ICML 2026][AI Safety][Backdoor Defense] BYORn identifies poisoned samples by detecting high-perplexity target responses inconsistent with input semantics and dynamically replaces them with clean responses generated by the model itself. This breaks the association between backdoor triggers and malicious outputs, reducing the average Attack Success Rate (ASR) by 40 percentage points while maintaining clean task performance.
tags:
  - "ICML 2026"
  - "AI Safety"
  - "Backdoor Defense"
