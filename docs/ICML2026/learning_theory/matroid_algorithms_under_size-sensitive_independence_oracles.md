...
description: >-
  [ICML 2026][Matroid] The authors propose a "size-sensitive matroid oracle" model where the query cost grows linearly with the size of the query set. They prove that under this model…
tags:
  - "ICML 2026"
  - "Matroid"
  - "independence oracle"
