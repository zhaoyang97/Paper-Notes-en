...
description: >-
  1527 ICLR2026 paper notes covering Image Generation (138), Reinforcement Learning (126), Model Compression (100), Multimodal VLM (85), LLM Reasoning (82), 3D Vision (62), Interpretability (60), LLM Safety (52) and other 49 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
## 🔍 Information Retrieval & RAG (31) { #information_retrieval }
...
[Browse all 31 Information Retrieval & RAG papers →](information_retrieval/)

---

## 💻 Code Intelligence (19) { #code_intelligence }
...
[Browse all 19 Code Intelligence papers →](code_intelligence/)
...
## 🧩 Multimodal VLM (85) { #multimodal_vlm }
...
[Browse all 85 Multimodal VLM papers →](multimodal_vlm/)
...
[Browse all 13 Medical NLP papers →](medical_nlp/)
