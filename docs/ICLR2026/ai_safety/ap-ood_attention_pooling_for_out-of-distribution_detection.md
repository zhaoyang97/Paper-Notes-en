...
description: >-
  [ICLR 2026][AI Safety][out-of-distribution detection] This paper proposes AP-OOD, which replaces the mean pooling in Mahalanobis distance-based OOD detection with learnable attention pooling…
tags:
  - "ICLR 2026"
  - "AI Safety"
