...
description: >-
  [ICLR 2026][LLM Reasoning][Self-supervised RL] Co-rewarding proposes a self-supervised RL framework that addresses training collapse in self-rewarding RL through two complementary supervision perspectives: a data-side me…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "Self-supervised RL"
