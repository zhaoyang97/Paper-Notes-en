---
title: >-
  ICLR2026 Image Restoration Papers · 61 Notes
description: >-
  61 ICLR2026 papers in the Image Restoration area, covering Diffusion Models, Image Restoration, Super-Resolution, Compression, Adversarial Robustness, Speech & Audio and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Image Restoration"
  - "AI paper notes"
...
item_list:
  ...
  - u: "content-aware_mamba_for_learned_image_compression/"
    t: "Content-Aware Mamba for Learned Image Compression"
  - u: "continuous_space-time_video_super-resolution_with_3d_fourier_fields/"
    t: "Continuous Space-Time Video Super-Resolution with 3D Fourier Fields"
  - u: "dealthdr_learning_hdr_video_reconstruction_from_degraded_alternating_exposure_se/"
    t: "DeAltHDR: Learning HDR Video Reconstruction from Degraded Alternating Exposure Sequences"
  - u: "delivr_differential_spatiotemporal_lie_bias_for_efficient_video_deraining/"
    t: "DeLiVR: Differential Spatiotemporal Lie Bias for Efficient Video Deraining"
  - u: "denoising_neural_reranker_for_recommender_systems/"
    t: "Denoising Neural Reranker for Recommender Systems"
  ...
  - u: "improved_adversarial_diffusion_compression_for_real-world_video_super-resolution/"
    t: "Improved Adversarial Diffusion Compression for Real-World Video Super-Resolution"
  ...
  - u: "kernelfusion_zero-shot_blind_super-resolution_via_patch_diffusion/"
    t: "KernelFusion: Zero-Shot Blind Super-Resolution via Patch Diffusion"
  ...
  - u: "learning_heterogeneous_degradation_representation_for_real-world_super-resolutio/"
...
**[Content-Aware Mamba for Learned Image Compression](content-aware_mamba_for_learned_image_compression.md)**
...
**[Continuous Space-Time Video Super-Resolution with 3D Fourier Fields](continuous_space-time_video_super-resolution_with_3d_fourier_fields.md)**
...
**[DeAltHDR: Learning HDR Video Reconstruction from Degraded Alternating Exposure Sequences](dealthdr_learning_hdr_video_reconstruction_from_degraded_alternating_exposure_se.md)**
...
**[DeLiVR: Differential Spatiotemporal Lie Bias for Efficient Video Deraining](delivr_differential_spatiotemporal_lie_bias_for_efficient_video_deraining.md)**
...
**[Denoising Neural Reranker for Recommender Systems](denoising_neural_reranker_for_recommender_systems.md)**
...
**[DISK: Differentiable Sparse Kernel Complex for Efficient Spatially-Variant Convolution](disk_differentiable_sparse_kernel_complex_for_efficient_spatially-variant_convol.md)**
...
**[Energy-oriented Diffusion Bridge for Image Restoration with Foundational Diffusion Models](energy-oriented_diffusion_bridge_for_image_restoration_with_foundational_diffusi.md)**
...
**[Improved Adversarial Diffusion Compression for Real-World Video Super-Resolution](improved_adversarial_diffusion_compression_for_real-world_video_super-resolution.md)**
...
**[KernelFusion: Zero-Shot Blind Super-Resolution via Patch Diffusion](kernelfusion_zero-shot_blind_super-resolution_via_patch_diffusion.md)**
...
**[Learning Heterogeneous Degradation Representation for Real-World Super-Resolution](learning_heterogeneous_degradation_representation_for_real-world_super-resolutio.md)**
...
**[LearnIR: Learnable Posterior Sampling for Real-World Image Restoration](learnir_learnable_posterior_sampling_for_real-world_image_restoration.md)**
...
**[LinearSR: Unlocking Linear Attention for Stable and Efficient Image Super-Resolution](linearsr_unlocking_linear_attention_for_stable_and_efficient_image_super-resolut.md)**
...
**[LiveMoments: Reselected Key Photo Restoration in Live Photos via Reference-guided Diffusion](livemoments_reselected_key_photo_restoration_in_live_photos_via_reference-guided.md)**
...
**[Optimizing ID Consistency in Multimodal Large Models: Facial Restoration via Alignment, Entanglement, and Disentanglement](optimizing_id_consistency_in_multimodal_large_models_facial_restoration_via_alig.md)**
...
**[Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling](pixel_to_gaussian_ultra-fast_continuous_super-resolution_with_2d_gaussian_modeli.md)**
...
**[PlantRSR: A New Plant Dataset and Method for Reference-based Super-Resolution](plantrsr_a_new_plant_dataset_and_method_for_reference-based_super-resolution.md)**
...
**[Test-Time Domain Generalization for Image Super-Resolution](test-time_domain_generalization_for_image_super-resolution.md)**
...
**[Text-Aware Image Restoration with Diffusion Models](text-aware_image_restoration_with_diffusion_models.md)**
...
**[Texture Vector-Quantization and Reconstruction Aware Prediction for Generative Super-Resolution](texture_vector-quantization_and_reconstruction_aware_prediction_for_generative_s.md)**
...
**[Trajectory-aware Shifted State Space Models for Online Video Super-Resolution](trajectory-aware_shifted_state_space_models_for_online_video_super-resolution.md)**
...
**[Vivid-VR: Distilling Concepts from Text-to-Video Diffusion Transformer for Photorealistic Video Restoration](vivid-vr_distilling_concepts_from_text-to-video_diffusion_transformer_for_photor.md)**
