...
description: >-
  [AAAI 2026][AI Safety][Knowledge Distillation] This paper proposes the Credal Ensemble Distillation (CED) framework, which distills a deep ensemble (DE) teacher into a single-model student called CREDIT. Rather than pred…
tags:
  - "AAAI 2026"
  - "AI Safety"
