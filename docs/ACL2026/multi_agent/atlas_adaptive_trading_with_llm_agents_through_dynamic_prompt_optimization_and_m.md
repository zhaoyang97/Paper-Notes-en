...
description: >-
  [ACL 2026][Multi-Agent][LLM trading agent] This paper proposes ATLAS, a multi-agent financial trading framework, and Adaptive-OPRO, a prompt optimization method. ATLAS employs specialized analyst agents to prepare hetero…
tags:
  - "ACL 2026"
  - "Multi-Agent"
  - "LLM trading agent"
