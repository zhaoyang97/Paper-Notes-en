...
description: >-
  [CVPR 2026][LLM Safety][Large Vision-Language Models] This paper introduces the concept of Attention Imbalance to explain object hallucination in LVLMs, and proposes a lightweight decoding-time intervention method, AIR…
tags:
  - "CVPR 2026"
  - "LLM Safety"
...
- [\[ACL 2026\] Aligning with Your Own Voice: Self-Corrected Preference Learning for Hallucination Mitigation in LVLMs](../../ACL2026/llm_safety/aligning_with_your_own_voice_self-corrected_preference_learning_for_hallucinatio.md)
