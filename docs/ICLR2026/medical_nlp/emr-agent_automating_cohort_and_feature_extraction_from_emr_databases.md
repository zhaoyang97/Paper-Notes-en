...
description: >-
  [ICLR 2026][Medical NLP][Electronic Medical Records] This paper proposes EMR-AGENT, the first LLM agent-based framework for automated EMR preprocessing. By replacing hand-crafted rules with dynamic SQL interaction…
tags:
  - "ICLR 2026"
  - "Medical NLP"
