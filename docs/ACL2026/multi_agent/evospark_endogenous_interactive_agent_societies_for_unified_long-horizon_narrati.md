...
description: >-
  [ACL 2026][Multi-Agent][multi-agent narrative] EvoSpark proposes a multi-agent framework for long-horizon narrative evolution, addressing social memory stacking and narrative–spatial misalignment through three core desig…
tags:
  - "ACL 2026"
  - "Multi-Agent"
