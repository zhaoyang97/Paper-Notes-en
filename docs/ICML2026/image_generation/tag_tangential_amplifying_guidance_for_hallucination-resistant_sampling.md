...
description: >-
  [ICML 2026][Image Generation][Tangential Amplifying] TAG decomposes each diffusion update step along the current latent variable direction into "radial + tangential" components. It applies an additional amplification fac…
tags:
  - "ICML 2026"
  - "Image Generation"
