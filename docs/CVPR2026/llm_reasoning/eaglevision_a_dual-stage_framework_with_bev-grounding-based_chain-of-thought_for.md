...
description: >-
  [CVPR 2026][Reasoning][Spatial Reasoning] The proposed EagleVision is a dual-stage framework. In the macro-perception stage, it utilizes Semantic-Perspective Fusion DPP (SPF-DPP) to jointly optimize semantic relevance and perspective diversity in $SE(3)$ space for keyframe selection. In the micro-verification stage, the model actively queries new perspective frames on a BEV plane to conduct iterative spatial CoT reasoning (hypothesis $\rightarrow$ view $\rightarrow$ verificat…
tags:
  - "CVPR 2026"
  - "Reasoning"
  - "Spatial Reasoning"
