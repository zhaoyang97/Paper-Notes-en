...
description: >-
  [ACL 2026][Causal Inference][Cross-Modal Generalization] Systematically studies whether LMs can cross-modally generalize text-learned taxonomic knowledge to visual inputs in VLMs, finding generalization exists but requires visual coherence among category members.
tags:
  - ACL 2026
  - Causal Inference
