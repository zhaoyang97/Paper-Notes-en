...
description: >-
  [ICLR 2026 (Workshop on Foundation Models for Science)][Computational Biology][Protein Engineering] EvoFlows proposes an edit-based flow matching approach that learns mutational trajectories between evolutionarily relate…
tags:
