---
title: >-
  ICLR2026 LLM (Other) Papers · 56 Notes
description: >-
  56 ICLR2026 papers in the LLM (Other) area, covering LLM, Diffusion Models, Reasoning, Agents, Layout & Composition, Alignment/RLHF and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "LLM (Other)"
  - "AI paper notes"
...
item_list:
  ...
  - u: "attend_to_the_active_structure-aware_dynamic_attention_in_llms_for_compositional/"
    t: "Attend to the Active: Structure-Aware Dynamic Attention in LLMs for Compositional Instruction Following"
  ...
  - u: "cite_pretrain_retrieval-free_knowledge_attribution_for_large_language_models/"
    t: "Cite Pretrain: Retrieval-Free Knowledge Attribution for Large Language Models"
  ...
  - u: "constrained_decoding_of_diffusion_llms_with_context-free_grammars/"
    t: "Constrained Decoding of Diffusion LLMs with Context-Free Grammars"
  - u: "cosmos_a_hybrid_adaptive_optimizer_for_efficient_training_of_large_language_mode/"
    t: "COSMOS: A Hybrid Adaptive Optimizer for Efficient Training of Large Language Models"
  ...
  - u: "differential_fine-tuning_large_language_models_towards_better_diverse_reasoning_/"
    t: "Differential Fine-Tuning Large Language Models Towards Better Diverse Reasoning Abilities"
  - u: "discovering_novel_llm_experts_via_task-capability_coevolution/"
    t: "Discovering Novel LLM Experts via Task-Capability Coevolution"
  - u: "dont_settle_too_early_self-reflective_remasking_for_diffusion_language_models/"
    t: "Don't Settle Too Early: Self-Reflective Remasking for Diffusion Language Models"
  ...
  - u: "efficient_multi-objective_prompt_optimization_via_pure-exploration_bandits/"
    t: "Efficient Multi-objective Prompt Optimization via Pure-exploration Bandits"
  - u: "eliciting_numerical_predictive_distributions_of_llms_without_auto-regression/"
    t: "Eliciting Numerical Predictive Distributions of LLMs Without Auto-Regression"
  ...
  - u: "fact_fine-grained_across-variable_convolution_for_multivariate_time_series_forec/"
    t: "FACT: Fine-grained Across-variable Convolution for Multivariate Time Series Forecasting"
  ...
  - u: "massive_editing_for_large_language_models_based_on_dynamic_weight_generation/"
...
📌 **Same area in other venues:** [📷 CVPR2026 (2)](../../CVPR2026/llm_nlp/index.md) · [💬 ACL2026 (62)](../../ACL2026/llm_nlp/index.md) · [🧪 ICML2026 (39)](../../ICML2026/llm_nlp/index.md) · [🤖 AAAI2026 (29)](../../AAAI2026/llm_nlp/index.md) · [🧠 NeurIPS2025 (53)](../../NeurIPS2025/llm_nlp/index.md) · [📹 ICCV2025 (6)](../../ICCV2025/llm_nlp/index.md)
...
**[Attend to the Active: Structure-Aware Dynamic Attention in LLMs for Compositional Instruction Following](attend_to_the_active_structure-aware_dynamic_attention_in_llms_for_compositional.md)**
...
**[Cite Pretrain: Retrieval-Free Knowledge Attribution for Large Language Models](cite_pretrain_retrieval-free_knowledge_attribution_for_large_language_models.md)**
...
**[Constrained Decoding of Diffusion LLMs with Context-Free Grammars](constrained_decoding_of_diffusion_llms_with_context-free_grammars.md)**
...
**[COSMOS: A Hybrid Adaptive Optimizer for Efficient Training of Large Language Models](cosmos_a_hybrid_adaptive_optimizer_for_efficient_training_of_large_language_mode.md)**
...
**[Differential Fine-Tuning Large Language Models Towards Better Diverse Reasoning Abilities](differential_fine-tuning_large_language_models_towards_better_diverse_reasoning_.md)**
...
**[Discovering Novel LLM Experts via Task-Capability Coevolution](discovering_novel_llm_experts_via_task-capability_coevolution.md)**
...
**[Don't Settle Too Early: Self-Reflective Remasking for Diffusion Language Models](dont_settle_too_early_self-reflective_remasking_for_diffusion_language_models.md)**
...
**[Efficient Multi-objective Prompt Optimization via Pure-exploration Bandits](efficient_multi-objective_prompt_optimization_via_pure-exploration_bandits.md)**
...
**[Eliciting Numerical Predictive Distributions of LLMs Without Auto-Regression](eliciting_numerical_predictive_distributions_of_llms_without_auto-regression.md)**
...
**[FACT: Fine-grained Across-variable Convolution for Multivariate Time Series Forecasting](fact_fine-grained_across-variable_convolution_for_multivariate_time_series_forec.md)**
...
**[Massive Editing for Large Language Models Based on Dynamic Weight Generation](massive_editing_for_large_language_models_based_on_dynamic_weight_generation.md)**
...
**[Neologism Learning for Controllability and Self-Verbalization](neologism_learning_for_controllability_and_self-verbalization.md)**
...
**[SIPDO: Closed-Loop Prompt Optimization via Synthetic Data Feedback](sipdo_closed-loop_prompt_optimization_via_synthetic_data_feedback.md)**
...
**[SPRIG: Improving Large Language Model Performance by System Prompt Optimization](sprig_improving_large_language_model_performance_by_system_prompt_optimization.md)**
...
**[TableMaster: A Recipe to Advance Table Understanding with Language Models](tablemaster_a_recipe_to_advance_table_understanding_with_language_models.md)**
...
**[Transducing Language Models](transducing_language_models.md)**
...
**[VERIFY: A Novel Multi-Domain Dataset Grounding LTL in Contextual Natural Language via Provable Intermediate Logic](verify_a_novel_multi-domain_dataset_grounding_ltl_in_contextual_natural_language.md)**
