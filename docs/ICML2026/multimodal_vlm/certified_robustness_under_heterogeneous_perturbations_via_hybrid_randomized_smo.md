...
description: >-
  [ICML 2026][Multimodal VLM][Randomized Smoothing] This work extends randomized smoothing (RS) from "supporting only single continuous or discrete input" to the hybrid perturbation setting of "discrete tokens + continuous…
tags:
  - "ICML 2026"
  - "Multimodal VLM"
