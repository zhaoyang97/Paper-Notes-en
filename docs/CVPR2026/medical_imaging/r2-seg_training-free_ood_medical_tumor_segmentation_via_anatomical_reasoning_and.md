...
description: >-
  [CVPR 2026][Medical Imaging][Paper Note] R2-Seg is a **fully parameter-free** training-free framework that utilizes a two-step "Reason-and-Reject" approach. It first employs an LLM for anatomical reasoning to plan Regions of Interest (ROIs), then applies two-sample statistical testing (MMD² + FDR control) to filter candidates generated by a frozen foundation
tags:
  - CVPR 2026
  - Medical Imaging
date: 2026-05-08
content_hash: 2057719d96c094bc
---
