...
description: >-
  [ICML 2026][Robotics][Point Cloud Fusion] Through a pilot study, the authors find that "explicitly lifting vision to point clouds and then fusing with 2D patches" is the most effective way to inject 3D information into V…
tags:
  - "ICML 2026"
  - "Robotics"
  - "Point Cloud Fusion"
