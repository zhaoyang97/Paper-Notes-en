...
description: >-
  [NeurIPS 2025][Image Generation][posterior sampling] This paper proposes an algorithm combining diffusion models with annealed Langevin dynamics that requires only $L^4$-accurate score estimates to achieve polynomial-tim…
tags:
  - "NeurIPS 2025"
  - "Image Generation"
  - "posterior sampling"
