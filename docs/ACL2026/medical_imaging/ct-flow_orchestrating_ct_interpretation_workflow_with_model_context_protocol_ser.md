...
description: >-
  [ACL 2026][Medical Imaging][CT Interpretation] The authors recast 3D CT interpretation as an agentic task where "radiologists iteratively explore using tools." Utilizing Model Context Protocol (MCP)…
tags:
  - "ACL 2026"
  - "Medical Imaging"
  - "CT Interpretation"
