...
description: >-
  [ICML 2026][Segmentation][graph minor] SEMIR treats the voxel grid as a parent graph $G$, compresses it into a "boundary-aligned" graph minor $H$ (reducing node count from $\sim10^7$ to $\sim10^3$) via parameterized edge…
tags:
  - "ICML 2026"
  - "Segmentation"
  - "graph minor"
