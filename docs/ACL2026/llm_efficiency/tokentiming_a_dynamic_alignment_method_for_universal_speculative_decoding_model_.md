...
description: >-
  [ACL 2026][LLM Efficiency][Inference Acceleration] TokenTiming re-encodes token sequences generated by a draft model into the target tokenizer space and utilizes Dynamic Time Warping (DTW) to construct many-to-many token alignments. This enables off-the-shelf small models with different vocabularies to serve as draft models for speculative decoding, achieving up to 1.5
tags:
  - ACL 2026
  - LLM Efficiency
  - Inference Acceleration
date: 2026-05-08
content_hash: 04780a0a3206e9ef
---
