---
title: >-
  ICLR2026 VLM Reasoning Papers · 111 Notes
description: >-
  111 ICLR2026 papers in the VLM Reasoning area, covering Reasoning, Multimodal/VLM, Reinforcement Learning, LLM, Layout & Composition, Agents and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "VLM Reasoning"
  - "AI paper notes"
...
item_list:
  ...
  - u: "beyond_classification_accuracy_neural-medbench_and_the_need_for_deeper_reasoning/"
    t: "Beyond Classification Accuracy: Neural-MedBench and the Need for Deeper Reasoning Benchmarks"
  - u: "childrens_intelligence_tests_pose_challenges_for_mllms_kidgym_a_2d_grid-based_re/"
    t: "Children's Intelligence Tests Pose Challenges for MLLMs? KidGym: A 2D Grid-Based Reasoning Benchmark for MLLMs"
  ...
  - u: "compodistill_attention_distillation_for_compositional_reasoning_in_multimodal_ll/"
    t: "CompoDistill: Attention Distillation for Compositional Reasoning in Multimodal LLMs"
  - u: "compose_and_fuse_revisiting_the_foundational_bottlenecks_in_multimodal_reasoning/"
    t: "Compose and Fuse: Revisiting the Foundational Bottlenecks in Multimodal Reasoning"
  - u: "composition-grounded_data_synthesis_for_visual_reasoning/"
    t: "Composition-Grounded Data Synthesis for Visual Reasoning"
  - u: "coprs_learning_positional_prior_from_chain-of-thought_for_reasoning_segmentation/"
    t: "CoPRS: Learning Positional Prior from Chain-of-Thought for Reasoning Segmentation"
  - u: "deepeyes_incentivizing_thinking_with_images_via_reinforcement_learning/"
    t: "DeepEyes: Incentivizing \"Thinking with Images\" via Reinforcement Learning"
  ...
  - u: "efficient_multimodal_spatial_reasoning_via_dynamic_and_asymmetric_routing/"
    t: "Efficient Multimodal Spatial Reasoning via Dynamic and Asymmetric Routing"
  ...
  - u: "evaluating_cross-modal_reasoning_ability_and_problem_characteristics_with_multim/"
    t: "Evaluating Cross-Modal Reasoning Ability and Problem Characteristics with Multimodal Item Response Theory"
  - u: "expvid_a_benchmark_for_experiment_video_understanding_reasoning/"
    t: "ExpVid: A Benchmark for Experiment Video Understanding & Reasoning"
  - u: "flowgen_synthesizing_diverse_flowcharts_to_enhance_and_benchmark_mllm_reasoning/"
    t: "FlowGen: Synthesizing Diverse Flowcharts to Enhance and Benchmark MLLM Reasoning"
  - u: "fostering_video_reasoning_via_next-event_prediction/"
    t: "Fostering Video Reasoning via Next-Event Prediction"
  - u: "framethinker_learning_to_think_with_long_videos_via_multi-turn_frame_spotlightin/"
    t: "FrameThinker: Learning to Think with Long Videos via Multi-Turn Frame Spotlighting"
...
**[Beyond Classification Accuracy: Neural-MedBench and the Need for Deeper Reasoning Benchmarks](beyond_classification_accuracy_neural-medbench_and_the_need_for_deeper_reasoning.md)**
...
**[Children's Intelligence Tests Pose Challenges for MLLMs? KidGym: A 2D Grid-Based Reasoning Benchmark for MLLMs](childrens_intelligence_tests_pose_challenges_for_mllms_kidgym_a_2d_grid-based_re.md)**
...
**[CompoDistill: Attention Distillation for Compositional Reasoning in Multimodal LLMs](compodistill_attention_distillation_for_compositional_reasoning_in_multimodal_ll.md)**
...
**[Compose and Fuse: Revisiting the Foundational Bottlenecks in Multimodal Reasoning](compose_and_fuse_revisiting_the_foundational_bottlenecks_in_multimodal_reasoning.md)**
...
**[Composition-Grounded Data Synthesis for Visual Reasoning](composition-grounded_data_synthesis_for_visual_reasoning.md)**
...
**[CoPRS: Learning Positional Prior from Chain-of-Thought for Reasoning Segmentation](coprs_learning_positional_prior_from_chain-of-thought_for_reasoning_segmentation.md)**
...
**[DeepEyes: Incentivizing "Thinking with Images" via Reinforcement Learning](deepeyes_incentivizing_thinking_with_images_via_reinforcement_learning.md)**
...
**[Efficient Multimodal Spatial Reasoning via Dynamic and Asymmetric Routing](efficient_multimodal_spatial_reasoning_via_dynamic_and_asymmetric_routing.md)**
...
**[Evaluating Cross-Modal Reasoning Ability and Problem Characteristics with Multimodal Item Response Theory](evaluating_cross-modal_reasoning_ability_and_problem_characteristics_with_multim.md)**
...
**[ExpVid: A Benchmark for Experiment Video Understanding & Reasoning](expvid_a_benchmark_for_experiment_video_understanding_reasoning.md)**
...
**[FlowGen: Synthesizing Diverse Flowcharts to Enhance and Benchmark MLLM Reasoning](flowgen_synthesizing_diverse_flowcharts_to_enhance_and_benchmark_mllm_reasoning.md)**
...
**[Fostering Video Reasoning via Next-Event Prediction](fostering_video_reasoning_via_next-event_prediction.md)**
...
**[FrameThinker: Learning to Think with Long Videos via Multi-Turn Frame Spotlighting](framethinker_learning_to_think_with_long_videos_via_multi-turn_frame_spotlightin.md)**
...
**[Game-RL: Synthesizing Multimodal Verifiable Game Data to Boost VLMs' General Reasoning](game-rl_synthesizing_multimodal_verifiable_game_data_to_boost_vlms_general_reaso.md)**
...
**[JointAVBench: A Benchmark for Joint Audio-Visual Reasoning Evaluation](jointavbench_a_benchmark_for_joint_audio-visual_reasoning_evaluation.md)**
...
**[JUDO: A Juxtaposed Domain-Oriented Multimodal Reasoner for Industrial Anomaly QA](judo_a_juxtaposed_domain-oriented_multimodal_reasoner_for_industrial_anomaly_qa.md)**
...
**[Latent Visual Reasoning](latent_visual_reasoning.md)**
...
**[LENS: Multi-level Evaluation of Multimodal Reasoning with Large Language Models](lens_multi-level_evaluation_of_multimodal_reasoning_with_large_language_models.md)**
...
**[LLMs as Rules Oracles: Exploring Real-World Multimodal Reasoning in Tabletop Strategy Game Environments](llms_as_rules_oracles_exploring_real-world_multimodal_reasoning_in_tabletop_stra.md)**
...
**[Math Blind: Failures in Diagram Understanding Undermine Reasoning in MLLMs](math_blind_failures_in_diagram_understanding_undermine_reasoning_in_mllms.md)**
...
**[MathNet: A Global Multimodal Benchmark for Mathematical Reasoning and Retrieval](mathnet_a_global_multimodal_benchmark_for_mathematical_reasoning_and_retrieval.md)**
...
**[Medical Thinking with Multiple Images](medical_thinking_with_multiple_images.md)**
...
**[MedVR: Annotation-Free Medical Visual Reasoning via Agentic Reinforcement Learning](medvr_annotation-free_medical_visual_reasoning_via_agentic_reinforcement_learnin.md)**
...
**[MetaSpatial: Reinforcing 3D Spatial Reasoning in VLMs for the Metaverse](metaspatial_reinforcing_3d_spatial_reasoning_in_vlms_for_the_metaverse.md)**
...
**[MIMIC-Bench: Exploring the User-Like Thinking and Mimicking Capabilities of Multimodal Large Language Models](mimic-bench_exploring_the_user-like_thinking_and_mimicking_capabilities_of_multi.md)**
...
**[MindCube: Spatial Mental Modeling from Limited Views](mindcube_spatial_mental_modeling_from_limited_views.md)**
...
**[Mini-o3: Scaling Up Reasoning Patterns and Interaction Turns for Visual Search](mini-o3_scaling_up_reasoning_patterns_and_interaction_turns_for_visual_search.md)**
...
**[Mixture-of-Visual-Thoughts: Exploring Context-Adaptive Reasoning Mode Selection for General Visual Reasoning](mixture-of-visual-thoughts_exploring_context-adaptive_reasoning_mode_selection_f.md)**
...
**[MM-HELIX: Boosting Multimodal Long-Chain Reflective Reasoning with Holistic Platform and Adaptive Hybrid Policy Optimization](mm-helix_boosting_multimodal_long-chain_reflective_reasoning_with_holistic_platf.md)**
...
**[MMR-V: What's Left Unsaid? A Benchmark for Multimodal Deep Reasoning in Videos](mmr-v_whats_left_unsaid_a_benchmark_for_multimodal_deep_reasoning_in_videos.md)**
...
**[More Thought, Less Accuracy? On the Dual Nature of Reasoning in Vision-Language Models](more_thought_less_accuracy_on_the_dual_nature_of_reasoning_in_vision-language_mo.md)**
...
**[NePTune: A Neuro-Pythonic Framework for Tunable Compositional Reasoning on Vision-Language](neptune_a_neuro-pythonic_framework_for_tunable_compositional_reasoning_on_vision.md)**
...
**[No Labels, No Problem: Training Visual Reasoners with Multimodal Verifiers](no_labels_no_problem_training_visual_reasoners_with_multimodal_verifiers.md)**
...
**[Not Search, But Scan: Benchmarking MLLMs on Scan-Oriented Academic Paper Reasoning](not_search_but_scan_benchmarking_mllms_on_scan-oriented_academic_paper_reasoning.md)**
...
**[OCR-Reasoning Benchmark: Unveiling the True Capabilities of MLLMs in Complex Text-Rich Image Reasoning](ocr-reasoning_benchmark_unveiling_the_true_capabilities_of_mllms_in_complex_text.md)**
...
**[Perception-Aware Policy Optimization for Multimodal Reasoning](perception-aware_policy_optimization_for_multimodal_reasoning.md)**
...
**[Perception-R1: Advancing Multimodal Reasoning Capabilities of MLLMs via Visual Perception Reward](perception-r1_advancing_multimodal_reasoning_capabilities_of_mllms_via_visual_pe.md)**
...
**[Play to Generalize: Learning to Reason Through Game Play](play_to_generalize_learning_to_reason_through_game_play.md)**
...
**[ProxyThinker: Test-Time Guidance Through Small Visual Reasoners](proxythinker_test-time_guidance_through_small_visual_reasoners.md)**
...
**[Pursuing Minimal Sufficiency in Spatial Reasoning](pursuing_minimal_sufficiency_in_spatial_reasoning.md)**
...
**[PuzzleWorld: A Benchmark for Multimodal, Open-Ended Reasoning in Puzzlehunts](puzzleworld_a_benchmark_for_multimodal_open-ended_reasoning_in_puzzlehunts.md)**
...
**[Reasoning in Space via Grounding in the World](reasoning_in_space_via_grounding_in_the_world.md)**
...
**[ReVisual-R1: Advancing Multimodal Reasoning from Optimized Cold Start to Staged Reinforcement Learning](revisual-r1_advancing_multimodal_reasoning_from_optimized_cold_start_to_staged_r.md)**
...
**[ReWatch-R1: Boosting Complex Video Reasoning in Large Vision-Language Models through Agentic Data Synthesis](rewatch-r1_boosting_complex_video_reasoning_in_large_vision-language_models_thro.md)**
...
**[Spatial Reasoning with Vision-Language Models in Ego-Centric Multi-View Scenes](spatial_reasoning_with_vision-language_models_in_ego-centric_multi-view_scenes.md)**
...
**[SpatialLadder: Building Spatial Reasoning Capabilities for Vision-Language Models via Progressive Training](spatialladder_progressive_training_for_spatial_reasoning_in_vision-language_mode.md)**
...
**[Test-Time Matching: Unlocking Compositional Reasoning in Multimodal Models](test-time_matching_unlocking_compositional_reasoning_in_multimodal_models.md)**
...
**[ThinkMorph: Emergent Properties in Multimodal Interleaved Chain-of-Thought Reasoning](thinkmorph_emergent_properties_in_multimodal_interleaved_chain-of-thought_reason.md)**
...
**[Thyme: Think Beyond Images](thyme_think_beyond_images.md)**
...
**[TimeSearch-R: Adaptive Temporal Search for Long-Form Video Understanding via Self-Verification Reinforcement Learning](timesearch-r_adaptive_temporal_search_for_long-form_video_understanding_via_self.md)**
...
**[Transductive Visual Programming: Evolving Tool Libraries from Experience for Spatial Reasoning](transductive_visual_programming_evolving_tool_libraries_from_experience_for_spat.md)**
...
**[Unfolding Spatial Cognition: Evaluating Multimodal Models on Visual Simulations](unfolding_spatial_cognition_evaluating_multimodal_models_on_visual_simulations.md)**
...
**[Unleashing Perception-Time Scaling to Multimodal Reasoning Models](unleashing_perception-time_scaling_to_multimodal_reasoning_models.md)**
...
**[Unlocking the Essence of Beauty: Advanced Aesthetic Reasoning with Relative-Absolute Policy Optimization](unlocking_the_essence_of_beauty_advanced_aesthetic_reasoning_with_relative-absol.md)**
...
**[VGR: Visual Grounded Reasoning](vgr_visual_grounded_reasoning.md)**
...
**[Vid-LLM: A Compact Video-based 3D Multimodal LLM with Reconstruction–Reasoning Synergy](vid-llm_a_compact_video-based_3d_multimodal_llm_with_reconstructionreasoning_syn.md)**
...
**[Vision-SR1: Self-Rewarding Vision-Language Model via Reasoning Decomposition and Multi-Reward Policy Optimization](vision-sr1_self-rewarding_vision-language_model_via_reasoning_decomposition_and_.md)**
...
**[VisionReasoner: Unified Reasoning-Integrated Visual Perception via Reinforcement Learning](visionreasoner_unified_reasoning-integrated_visual_perception_via_reinforcement_.md)**
...
**[VisualPRM400K: An Effective Dataset for Training Multimodal Process Reward Models](visualprm400k_an_effective_dataset_for_training_multimodal_process_reward_models.md)**
...
**[VisuLogic: A Benchmark for Evaluating Visual Reasoning Capabilities of Multimodal Large Models](visulogic_a_benchmark_for_evaluating_visual_reasoning_in_multi-modal_large_langu.md)**
...
**[VisuRiddles: Fine-Grained Perception is a Primary Bottleneck for Multimodal Large Language Models in Abstract Visual Reasoning](visuriddles_fine-grained_perception_is_a_primary_bottleneck_for_multimodal_large.md)**
...
**[We-Math 2.0: A Versatile MathBook System for Incentivizing Visual Mathematical Reasoning](we-math_20_a_versatile_mathbook_system_for_incentivizing_visual_mathematical_rea.md)**
