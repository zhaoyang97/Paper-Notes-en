...
- [\[ACL 2026\] eTracer: Towards Traceable Text Generation via Claim-Level Grounding](../../ACL2026/information_retrieval/etracer_towards_traceable_text_generation_via_claim-level_grounding.md)
