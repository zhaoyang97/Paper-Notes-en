...
**State of the Field**: Modern AI systems increasingly integrate multiple components—LLMs, retrievers, tool calls, and classical ML models—forming compound AI systems for complex tasks. These systems are highly sensitive to component failures, as errors in one component cascade and amplify downstream.
