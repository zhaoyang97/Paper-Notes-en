...
description: >-
  [ICLR2026][Dialogue Systems][Preference Learning] DRIFT treats the abundant but implicit "user dissatisfaction" (DSAT) from real-world deployments as high-quality negative anchors. Positive samples are dynamically sampled from the current policy, and iterative training is performed using standard DPO. Without requiring human annotations, reward models, or positives generated by stronger models, it enables a 14B model to outperform GPT-4o-mini on WildBench.
tags:
  - "ICLR2026"
  - "Dialogue Systems"
  - "Preference Learning"
