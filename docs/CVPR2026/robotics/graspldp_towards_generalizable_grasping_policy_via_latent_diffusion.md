...
description: >-
  [CVPR 2026][Robotics][Robot Grasping] This paper proposes GraspLDP, which injects grasp pose priors from a pretrained grasp detector and graspness map visual cues into a latent diffusion policy framework. By leveraging V…
tags:
  - "CVPR 2026"
  - "Robotics"
  - "Robot Grasping"
