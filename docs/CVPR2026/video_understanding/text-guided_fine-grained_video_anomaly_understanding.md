...
description: >-
  [CVPR2026][Video Understanding][Video Anomaly Detection] This paper proposes the T-VAU framework, which achieves pixel-level spatiotemporal anomaly localization via an Anomaly Heatmap Decoder (AHD)…
tags:
  - "CVPR2026"
  - "Video Understanding"
