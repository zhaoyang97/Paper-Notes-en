...
description: >-
  [ICLR2026][Physics & Scientific Computing][subspace regression] This paper formalizes the subspace prediction problem in Reduced Order Modeling (ROM) as a regression task on the Grassmann manifold. It proposes dedicated…
tags:
  - "ICLR2026"
