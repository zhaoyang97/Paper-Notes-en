...
- **Root Cause**: The fundamental limitation is the decoupled treatment of geometry and kinematics, which prevents joint optimization and leads to error propagation.
- **Paper Goals**: This paper fundamentally reframes the problem by leveraging a 3D MLLM to process point clouds end-to-end, **jointly** predicting geometric segmentation and kinematic parameters. 3D MLLMs are naturally suited for this task — they handle multimodal inputs, encode large-scale 3D shape priors, and directly understand spatial relationships to output precise coordinates.
