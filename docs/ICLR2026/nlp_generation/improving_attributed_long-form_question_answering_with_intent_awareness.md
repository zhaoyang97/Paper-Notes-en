...
description: >-
  [ICLR 2026][Text Generation][Knowledge Distillation] Addressing the issues of "poor citation quality and low readability" in long-form reports generated by deep research systems, this paper proposes a tag-based dual-layer intent (paragraph intent + citation intent) writing framework. This framework enhances Large Language Models (LLMs) via direct prompting during inferen
tags:
  - ICLR 2026
  - Text Generation
  - Knowledge Distillation
date: 2026-05-08
content_hash: f0edd2e0d56024d2
---
