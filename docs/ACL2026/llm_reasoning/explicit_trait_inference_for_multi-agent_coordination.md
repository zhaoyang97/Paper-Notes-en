...
- [\[ACL 2026\] TIME: Temporally Intelligent Meta-Reasoning Engine for Context-Triggered Explicit Reasoning](time_temporally_intelligent_meta-reasoning_engine_for_context-triggered_explicit.md)
