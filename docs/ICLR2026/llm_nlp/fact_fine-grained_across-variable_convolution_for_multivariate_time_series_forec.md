...
title: >-
  [Paper Note] Untitled
description: >-
  [ICLR 2026][LLM (Other)][Paper Note] To be added after in-depth reading
tags:
  - ICLR 2026
  - LLM (Other)
date: 2026-05-08
content_hash: ea554b65e73a41ac
---
# FACT: Fine-grained Across-variable Convolution for Multivariate Time Series Forecasting

**Conference**: ICLR2026  
**OpenReview**: [https://openreview.net/forum?id=j3gNYqrHtl](https://openreview.net/forum?id=j3gNYqrHtl)
**Full Text Cache**: paper_cache/ICLR2026/or-fact_fine-grained_across-variable_convolution_for_multivariate_time_series_forec.txt
**Code**: To be confirmed  
**Area**: learning on time series and dynamical systems  
