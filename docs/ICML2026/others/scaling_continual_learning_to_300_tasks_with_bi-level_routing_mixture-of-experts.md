...
description: >-
  [ICML 2026][Class-Incremental Learning] The authors propose CaRE: inserting a **bi-level routing MoE (BR-MoE)** into each ViT block—first, a "class recognizer" selects the Top-M relevant task routers based on entropy…
tags:
  - "ICML 2026"
