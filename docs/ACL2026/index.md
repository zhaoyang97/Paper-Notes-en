...
description: >-
  1375 ACL2026 paper notes covering LLM Safety (116), Multimodal VLM (94), LLM Evaluation (92), LLM Agent (81), LLM Reasoning (81), Information Retrieval & RAG (73), Audio & Speech (67), Multilingual & Translation (62) and other 41 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ACL2026"
...
item_list:
  ...
  - u: "llm_safety/dart_mitigating_harm_drift_in_difference-aware_llms_via_distill-audit-repair_tra/"
...
[Browse all 116 LLM Safety papers →](llm_safety/)

---

## 📊 LLM Evaluation (92) { #llm_evaluation }
...
[Browse all 92 LLM Evaluation papers →](llm_evaluation/)

---

## 🦾 LLM Agent (81) { #llm_agent }
...
[Browse all 81 LLM Agent papers →](llm_agent/)
...
[Browse all 81 LLM Reasoning papers →](llm_reasoning/)
...
[Browse all 59 LLM / NLP papers →](llm_nlp/)

---

## 👥 Multi-Agent (39) { #multi_agent }
...
[Browse all 39 Multi-Agent papers →](multi_agent/)

---

## ⚖️ Alignment & RLHF (30) { #llm_alignment }
...
[Browse all 30 Alignment & RLHF papers →](llm_alignment/)

---

## 👻 Hallucination Detection (27) { #hallucination }

**[Aligning with Your Own Voice: Self-Corrected Preference Learning for Hallucination Mitigation in LVLMs](hallucination/aligning_with_your_own_voice_self-corrected_preference_learning_for_hallucinatio.md)**
...
**[Benchmarking Deflection and Hallucination in Large Vision-Language Models](hallucination/benchmarking_deflection_and_hallucination_in_large_vision-language_models.md)**
...
**[Detecting Hallucinations in SpeechLLMs at Inference Time Using Attention Maps](hallucination/detecting_hallucinations_in_speechllms_at_inference_time_using_attention_maps.md)**
...
**[Dialectic-Med: Mitigating Diagnostic Hallucinations via Counterfactual Adversarial Multi-Agent Debate](hallucination/dialectic-med_mitigating_diagnostic_hallucinations_via_counterfactual_adversaria.md)**
...
**[Distorted or Fabricated? A Survey on Hallucination in Video LLMs](hallucination/distorted_or_fabricated_a_survey_on_hallucination_in_video_llms.md)**
...
**[Enhancing Hallucination Detection via Future Context](hallucination/enhancing_hallucination_detection_via_future_context.md)**
...
**[FaithLens: Detecting and Explaining Faithfulness Hallucination](hallucination/faithlens_detecting_and_explaining_faithfulness_hallucination.md)**
...
**[FinGround: Detecting and Grounding Financial Hallucinations via Atomic Claim Verification](hallucination/finground_detecting_and_grounding_financial_hallucinations_via_atomic_claim_veri.md)**
...
**[Generating Effective CoT Traces for Mitigating Causal Hallucination](hallucination/generating_effective_cot_traces_for_mitigating_causal_hallucination.md)**
...
**[HalluAudio: A Comprehensive Benchmark for Hallucination Detection in Large Audio-Language Models](hallucination/halluaudio_a_comprehensive_benchmark_for_hallucination_detection_in_large_audio-.md)**
...
[Browse all 27 Hallucination Detection papers →](hallucination/)

---

## ⚡ LLM Efficiency (22) { #llm_efficiency }
...
[Browse all 22 LLM Efficiency papers →](llm_efficiency/)

---

## 📚 Pretraining (12) { #llm_pretraining }
...
[Browse all 12 Pretraining papers →](llm_pretraining/)

---

## ✏️ Knowledge Editing (9) { #knowledge_editing }
...
## 🔍 Information Retrieval & RAG (73) { #information_retrieval }
...
[Browse all 73 Information Retrieval & RAG papers →](information_retrieval/)

---

## 🌐 Multilingual & Translation (62) { #multilingual_mt }
...
[Browse all 62 Multilingual & Translation papers →](multilingual_mt/)

---

## 💻 Code Intelligence (52) { #code_intelligence }
...
[Browse all 52 Code Intelligence papers →](code_intelligence/)

---

## 📖 NLP Understanding (33) { #nlp_understanding }
...
[Browse all 33 NLP Understanding papers →](nlp_understanding/)

---

## 🗣️ Dialogue Systems (27) { #dialogue }
...
[Browse all 27 Dialogue Systems papers →](dialogue/)

---

## ✍️ Text Generation (17) { #nlp_generation }
...
[Browse all 17 Text Generation papers →](nlp_generation/)

---

## 🧩 Multimodal VLM (94) { #multimodal_vlm }
...
[Browse all 94 Multimodal VLM papers →](multimodal_vlm/)

---

## 🎵 Audio & Speech (67) { #audio_speech }
...
[Browse all 67 Audio & Speech papers →](audio_speech/)

---

## 🔎 AIGC Detection (16) { #aigc_detection }
...
[Browse all 16 AIGC Detection papers →](aigc_detection/)

---

## 🎨 Image Generation (5) { #image_generation }
...
## 🎬 Video Generation (4) { #video_generation }
...
## 📹 Video Understanding (16) { #video_understanding }
...
[Browse all 16 Video Understanding papers →](video_understanding/)

---

## 🧑 Human Understanding (3) { #human_understanding }
...
## 🎮 Reinforcement Learning (44) { #reinforcement_learning }
...
[Browse all 44 Reinforcement Learning papers →](reinforcement_learning/)

---

## 🎁 Recommender Systems (21) { #recommender }
...
[Browse all 21 Recommender Systems papers →](recommender/)

---

## 🤖 Robotics & Embodied AI (10) { #robotics }
...
## 🔬 Interpretability (60) { #interpretability }
...
[Browse all 60 Interpretability papers →](interpretability/)

---

## 📦 Model Compression (59) { #model_compression }
...
[Browse all 59 Model Compression papers →](model_compression/)

---

## 🕸️ Graph Learning (23) { #graph_learning }
...
[Browse all 23 Graph Learning papers →](graph_learning/)

---

## 🔗 Causal Inference (7) { #causal_inference }
...
## 🔄 Self-Supervised Learning (1) { #self_supervised }
...
## 👥 Social Computing (45) { #social_computing }
...
[Browse all 45 Social Computing papers →](social_computing/)

---

## 🏥 Medical Imaging (35) { #medical_imaging }
...
[Browse all 35 Medical Imaging papers →](medical_imaging/)

---

## 🩺 Medical NLP (14) { #medical_nlp }
...
[Browse all 14 Medical NLP papers →](medical_nlp/)

---

## 🧬 Computational Biology (5) { #computational_biology }
