---
title: >-
  NeurIPS2025 Autonomous Driving Papers · 47 Notes
description: >-
  47 NeurIPS2025 papers in the Autonomous Driving area, covering Autonomous Driving, Agents, Time-Series Forecasting, Remote Sensing, Multimodal/VLM, Self-Supervised Learning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "NeurIPS2025"
  - "Autonomous Driving"
  - "AI paper notes"
...
item_list:
  - u: "3eed_ground_everything_everywhere_in_3d/"
    t: "3EED: Ground Everything Everywhere in 3D"
  - u: "aha_predicting_what_matters_next_online_highlight_detection/"
    t: "Aha: Predicting What Matters Next — Online Highlight Detection Without Looking Ahead"
  - u: "availability-aware_sensor_fusion_via_unified_canonical_space/"
    t: "Availability-aware Sensor Fusion via Unified Canonical Space"
  - u: "bayesian_ego-graph_inference_for_networked_multi-agent_reinforcement_learning/"
    t: "BayesG: Bayesian Ego-Graph Inference for Networked Multi-Agent Reinforcement Learning"
  - u: "causality_meets_locality_provably_generalizable_and_scalable_policy_learning_for/"
    t: "Causality Meets Locality: Provably Generalizable and Scalable Policy Learning for Networked Systems"
  - u: "chronograph_a_real-world_graph-based_multivariate_time_series_dataset/"
    t: "ChronoGraph: A Real-World Graph-Based Multivariate Time Series Dataset"
  - u: "continuous_simplicial_neural_networks/"
    t: "Continuous Simplicial Neural Networks"
  - u: "cumolos-mae_a_masked_autoencoder_for_remote_sensing_data_reconstruction/"
    t: "CuMoLoS-MAE: A Masked Autoencoder for Remote Sensing Data Reconstruction"
  - u: "cymbadiff_structured_spatial_diffusion_for_sketch-based_3d_semantic_urban_scene_/"
    t: "CymbaDiff: Structured Spatial Diffusion for Sketch-based 3D Semantic Urban Scene Generation"
  - u: "dbloss_decomposition-based_loss_function_for_time_series_forecasting/"
    t: "DBLoss: Decomposition-based Loss Function for Time Series Forecasting"
  - u: "dino-foresight_looking_into_the_future_with_dino/"
    t: "DINO-Foresight: Looking into the Future with DINO"
  - u: "drivedpo_policy_learning_via_safety_dpo_for_end-to-end_autonomous_driving/"
    t: "DriveDPO: Policy Learning via Safety DPO For End-to-End Autonomous Driving"
  - u: "extremely_simple_multimodal_outlier_synthesis_for_out-of-distribution_detection_/"
    t: "Extremely Simple Multimodal Outlier Synthesis for Out-of-Distribution Detection and Segmentation"
  - u: "flow_matching-based_autonomous_driving_planning_with_advanced_interactive_behavi/"
    t: "Flow Matching-Based Autonomous Driving Planning with Advanced Interactive Behavior Modeling"
  - u: "future-aware_end-to-end_driving_bidirectional_modeling_of_trajectory_planning_an/"
    t: "Future-Aware End-to-End Driving: Bidirectional Modeling of Trajectory Planning and Scene Evolution"
  - u: "futuresightdrive_thinking_visually_with_spatiotemporal_cot_f/"
    t: "FutureSightDrive: Thinking Visually with Spatio-Temporal CoT for Autonomous Driving"
  - u: "gsalign_geometric_and_semantic_alignment_network_for_aerial-ground_person_re-ide/"
    t: "GSAlign: Geometric and Semantic Alignment Network for Aerial-Ground Person Re-Identification"
  - u: "how_different_from_the_past_spatio-temporal_time_series_forecasting_with_self-su/"
    t: "How Different from the Past? Spatio-Temporal Time Series Forecasting with Self-Supervised Deviation Learning"
  - u: "l2rsi_cross-view_lidar-based_place_recognition_for_large-scale_urban_scenes_via_/"
    t: "L2RSI: Cross-View LiDAR-Based Place Recognition for Large-Scale Urban Scenes via Remote Sensing Imagery"
  - u: "labelany3d_label_any_object_3d_in_the_wild/"
    t: "LabelAny3D: Label Any Object 3D in the Wild"
  - u: "layer-wise_modality_decomposition_for_interpretable_multimodal_sensor_fusion/"
    t: "Layer-wise Modality Decomposition for Interpretable Multimodal Sensor Fusion"
  - u: "learning_temporal_3d_semantic_scene_completion_via_optical_flow_guidance/"
    t: "FlowScene: Learning Temporal 3D Semantic Scene Completion via Optical Flow Guidance"
  - u: "leveraging_depth_and_language_for_open-vocabulary_domain-generalized_semantic_se/"
    t: "Leveraging Depth and Language for Open-Vocabulary Domain-Generalized Semantic Segmentation"
  - u: "model-based_policy_adaptation_for_closed-loop_end-to-end_autonomous_driving/"
    t: "Model-Based Policy Adaptation for Closed-Loop End-to-End Autonomous Driving"
  - u: "neurosymbolic_diffusion_models/"
    t: "Neurosymbolic Diffusion Models"
  - u: "openbox_annotate_any_bounding_boxes_in_3d/"
    t: "OpenBox: Annotate Any Bounding Boxes in 3D"
  - u: "predictive_preference_learning_from_human_interventions/"
    t: "Predictive Preference Learning from Human Interventions"
  - u: "prioritizing_perception-guided_self-supervision_a_new_paradigm_for_causal_modeli/"
    t: "Prioritizing Perception-Guided Self-Supervision: A New Paradigm for Causal Modeling in End-to-End Autonomous Driving"
  - u: "raw2drive_reinforcement_learning_with_aligned_world_models_for_end-to-end_autono/"
    t: "RAW2Drive: Reinforcement Learning with Aligned World Models for End-to-End Autonomous Driving"
  - u: "regret_lower_bounds_for_decentralized_multi-agent_stochastic_shortest_path_probl/"
    t: "Regret Lower Bounds for Decentralized Multi-Agent Stochastic Shortest Path Problems"
item_total: 47
---
...
📌 **Same area in other venues:** [📷 CVPR2026 (140)](../../CVPR2026/autonomous_driving/index.md) · [🔬 ICLR2026 (50)](../../ICLR2026/autonomous_driving/index.md) · [🧪 ICML2026 (8)](../../ICML2026/autonomous_driving/index.md) · [🤖 AAAI2026 (56)](../../AAAI2026/autonomous_driving/index.md) · [📹 ICCV2025 (91)](../../ICCV2025/autonomous_driving/index.md)

🔥 **Top topics:** Autonomous Driving ×8 · Agents ×5 · Time-Series Forecasting ×3 · Remote Sensing ×3 · Multimodal/VLM ×3
...
**[Towards Physics-Informed Spatial Intelligence with Human Priors: An Autonomous Driving Perspective](towards_physics-informed_spatial_intelligence_with_human_priors_an_autonomous_dr.md)**
...
**[TL;DR](transun_a_preemptive_paradigm_to_eradicate_retransformation_bias_intrinsically_f.md)**
