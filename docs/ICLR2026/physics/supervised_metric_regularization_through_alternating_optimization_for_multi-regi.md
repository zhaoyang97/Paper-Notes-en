...
description: >-
  [Physics & Scientific Computing] This paper proposes a Topology-Aware PINN (TAPINN) that structures the latent space via supervised metric regularization (Triplet Loss) and stabilizes training through an alternating opti…
tags:
