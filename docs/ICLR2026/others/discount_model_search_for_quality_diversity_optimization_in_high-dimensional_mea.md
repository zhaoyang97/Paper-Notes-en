...
description: >-
  [ICLR2026][Quality Diversity] This paper proposes Discount Model Search (DMS), which replaces the histogram-based discrete representation in CMA-MAE with a neural network that fits a continuous…
tags:
  - "ICLR2026"
  - "Quality Diversity"
  - "MAP-Elites"
