...
description: >-
  [ICML 2026][AI Safety][Differential Privacy] The authors provide the first **convergent hidden-state DP upper bound** for "differentially private zeroth-order optimization (DP-ZOGD)"—by designing a "directional + isotrop…
tags:
  - "ICML 2026"
  - "AI Safety"
