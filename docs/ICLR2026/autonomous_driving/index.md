---
title: >-
  ICLR2026 Autonomous Driving Papers · 50 Notes
description: >-
  50 ICLR2026 papers in the Autonomous Driving area, covering Autonomous Driving, Agents, Adversarial Robustness, Multimodal/VLM, Alignment/RLHF, Diffusion Models and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Autonomous Driving"
  - "AI paper notes"
...
item_list:
  ...
  - u: "arinbev_birds-eye_view_layout_estimation_with_conditional_autoregressive_model/"
    t: "ARINBEV: Bird's-Eye View Layout Estimation with Conditional Autoregressive Model"
  ...
  - u: "asyncbev_cross-modal_flow_alignment_in_asynchronous_3d_object_detection/"
    t: "AsyncBEV: Cross-modal Flow Alignment in Asynchronous 3D Object Detection"
  - u: "autodrive-r²_incentivizing_reasoning_and_self-reflection_capacity_for_vla_model_/"
    t: "AutoDrive-R²: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving"
  - u: "autodrivetext-p3_unified_chain_of_perceptionpredictionplanning_thought_via_reinf/"
    t: "$AutoDrive\\text{-}P^3$: Unified Chain of Perception-Prediction-Planning Thought via Reinforcement Fine-Tuning"
  ...
  - u: "birds-eye-view_informed_reasoning_driver/"
    t: "Bird's-eye-view Informed Reasoning Driver (BIRDriver)"
  ...
  - u: "decompgail_learning_realistic_traffic_behaviors_with_decomposed_multi-agent_gene/"
    t: "DecompGAIL: Learning Realistic Traffic Behaviors with Decomposed Multi-Agent Generative Adversarial Imitation Learning"
  - u: "detecting_temporal_misalignment_attacks_in_multimodal_fusion_for_autonomous_driv/"
    t: "Detecting Temporal Misalignment Attacks in Multimodal Fusion for Autonomous Driving"
  - u: "discrete_diffusion_for_reflective_vision-language-action_models_in_autonomous_dr/"
    t: "Discrete Diffusion for Reflective Vision-Language-Action Models in Autonomous Driving"
  - u: "driveagent-r1_advancing_vlm-based_autonomous_driving_with_active_perception_and_/"
    t: "DriveAgent-R1: Advancing VLM-based Autonomous Driving with Active Perception and Hybrid Thinking"
  - u: "drivemamba_task-centric_scalable_state_space_model_for_efficient_end-to-end_auto/"
    t: "DriveMamba: Task-Centric Scalable State Space Model for Efficient End-to-End Autonomous Driving"
  - u: "drivevla-w0_world_models_amplify_data_scaling_law_in_autonomous_driving/"
    t: "DriveVLA-W0: World Models Amplify Data Scaling Law in Autonomous Driving"
  ...
  - u: "envsocial-diff_a_diffusion-based_crowd_simulation_model_with_environmental_condi/"
    t: "EnvSocial-Diff: A Diffusion-Based Crowd Simulation Model with Environmental Conditioning and Individual-Group Interaction"
  - u: "flowad_ego-scene_interactive_modeling_for_autonomous_driving/"
    t: "FlowAD: Ego-Scene Interactive Modeling for Autonomous Driving"
  - u: "gaussianfusion_unified_3d_gaussian_representation_for_multi-modal_fusion_percept/"
    t: "GaussianFusion: Unified 3D Gaussian Representation for Multi-Modal Fusion Perception"
  - u: "gt-space_enhancing_heterogeneous_collaborative_perception_with_ground_truth_feat/"
    t: "GT-Space: Enhancing Heterogeneous Collaborative Perception with Ground Truth Feature Space"
  - u: "loc2_interpretable_cross-view_localization_via_depth-lifted_local_feature_matchi/"
    t: "Loc²: Interpretable Cross-View Localization via Depth-Lifted Local Feature Matching"
  - u: "low-latency_neural_lidar_compression_with_2d_context_models/"
    t: "Low-Latency Neural LiDAR Compression with 2D Context Models"
  - u: "map_as_a_prompt_learning_multi-modal_spatial-signal_foundation_models_for_cross-/"
    t: "Map as a Prompt: Learning Multi-Modal Spatial-Signal Foundation Models for Cross-scenario Wireless Localization"
  ...
  - u: "micro-macro_coupled_koopman_modeling_on_graph_for_traffic_flow_prediction/"
    t: "Micro-Macro Coupled Koopman Modeling on Graph for Traffic Flow Prediction"
  ...
  - u: "occdriver_future_occupancy_guided_dual-branch_trajectory_planner_in_autonomous_d/"
    t: "OccDriver: Future Occupancy Guided Dual-branch Trajectory Planner in Autonomous Driving"
  - u: "online_navigation_refinement_achieving_lane-level_guidance_by_associating_standa/"
    t: "Online Navigation Refinement: Achieving Lane-Level Guidance by Associating Standard-Definition and Online Perception Maps"
item_total: 50
---
...
📌 **Same area in other venues:** [📷 CVPR2026 (140)](../../CVPR2026/autonomous_driving/index.md) · [🧪 ICML2026 (8)](../../ICML2026/autonomous_driving/index.md) · [🤖 AAAI2026 (56)](../../AAAI2026/autonomous_driving/index.md) · [🧠 NeurIPS2025 (47)](../../NeurIPS2025/autonomous_driving/index.md) · [📹 ICCV2025 (91)](../../ICCV2025/autonomous_driving/index.md)
...
**[ARINBEV: Bird's-Eye View Layout Estimation with Conditional Autoregressive Model](arinbev_birds-eye_view_layout_estimation_with_conditional_autoregressive_model.md)**
...
**[AsyncBEV: Cross-modal Flow Alignment in Asynchronous 3D Object Detection](asyncbev_cross-modal_flow_alignment_in_asynchronous_3d_object_detection.md)**
...
**[AutoDrive-R²: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving](autodrive-r²_incentivizing_reasoning_and_self-reflection_capacity_for_vla_model_.md)**
...
**[$AutoDrive\text{-}P^3$: Unified Chain of Perception-Prediction-Planning Thought via Reinforcement Fine-Tuning](autodrivetext-p3_unified_chain_of_perceptionpredictionplanning_thought_via_reinf.md)**
...
**[Bird's-eye-view Informed Reasoning Driver (BIRDriver)](birds-eye-view_informed_reasoning_driver.md)**
...
**[DecompGAIL: Learning Realistic Traffic Behaviors with Decomposed Multi-Agent Generative Adversarial Imitation Learning](decompgail_learning_realistic_traffic_behaviors_with_decomposed_multi-agent_gene.md)**
...
**[Detecting Temporal Misalignment Attacks in Multimodal Fusion for Autonomous Driving](detecting_temporal_misalignment_attacks_in_multimodal_fusion_for_autonomous_driv.md)**
...
**[Discrete Diffusion for Reflective Vision-Language-Action Models in Autonomous Driving](discrete_diffusion_for_reflective_vision-language-action_models_in_autonomous_dr.md)**
...
**[DriveAgent-R1: Advancing VLM-based Autonomous Driving with Active Perception and Hybrid Thinking](driveagent-r1_advancing_vlm-based_autonomous_driving_with_active_perception_and_.md)**
...
**[DriveMamba: Task-Centric Scalable State Space Model for Efficient End-to-End Autonomous Driving](drivemamba_task-centric_scalable_state_space_model_for_efficient_end-to-end_auto.md)**
...
**[DriveVLA-W0: World Models Amplify Data Scaling Law in Autonomous Driving](drivevla-w0_world_models_amplify_data_scaling_law_in_autonomous_driving.md)**
...
**[EnvSocial-Diff: A Diffusion-Based Crowd Simulation Model with Environmental Conditioning and Individual-Group Interaction](envsocial-diff_a_diffusion-based_crowd_simulation_model_with_environmental_condi.md)**
...
**[FlowAD: Ego-Scene Interactive Modeling for Autonomous Driving](flowad_ego-scene_interactive_modeling_for_autonomous_driving.md)**
...
**[GaussianFusion: Unified 3D Gaussian Representation for Multi-Modal Fusion Perception](gaussianfusion_unified_3d_gaussian_representation_for_multi-modal_fusion_percept.md)**
...
**[GT-Space: Enhancing Heterogeneous Collaborative Perception with Ground Truth Feature Space](gt-space_enhancing_heterogeneous_collaborative_perception_with_ground_truth_feat.md)**
...
**[Loc²: Interpretable Cross-View Localization via Depth-Lifted Local Feature Matching](loc2_interpretable_cross-view_localization_via_depth-lifted_local_feature_matchi.md)**
...
**[Low-Latency Neural LiDAR Compression with 2D Context Models](low-latency_neural_lidar_compression_with_2d_context_models.md)**
...
**[Map as a Prompt: Learning Multi-Modal Spatial-Signal Foundation Models for Cross-scenario Wireless Localization](map_as_a_prompt_learning_multi-modal_spatial-signal_foundation_models_for_cross-.md)**
...
**[Micro-Macro Coupled Koopman Modeling on Graph for Traffic Flow Prediction](micro-macro_coupled_koopman_modeling_on_graph_for_traffic_flow_prediction.md)**
...
**[OccDriver: Future Occupancy Guided Dual-branch Trajectory Planner in Autonomous Driving](occdriver_future_occupancy_guided_dual-branch_trajectory_planner_in_autonomous_d.md)**
...
**[Online Navigation Refinement: Achieving Lane-Level Guidance by Associating Standard-Definition and Online Perception Maps](online_navigation_refinement_achieving_lane-level_guidance_by_associating_standa.md)**
...
**[Plan-R1: Safe and Feasible Trajectory Planning as Language Modeling](plan-r1_safe_and_feasible_trajectory_planning_as_language_modeling.md)**
...
**[PTN: Proposal-centric Transformer Network for 3D Object Detection](ptnet_a_proposal-centric_transformer_net-_work_for_3d_object_detection.md)**
...
**[RAP: 3D Rasterization Augmented End-to-End Planning](rap_3d_rasterization_augmented_end-to-end_planning.md)**
...
**[Rate-Distortion Optimized Pragmatic Communication for Collaborative Perception](rate-distortion_optimized_pragmatic_communication_for_collaborative_perception.md)**
...
**[ReCogDrive: A Reinforced Cognitive Framework for End-to-End Autonomous Driving](recogdrive_a_reinforced_cognitive_framework_for_end-to-end_autonomous_driving.md)**
...
**[Rethinking Driving World Model as Synthetic Data Generator for Perception Tasks](rethinking_driving_world_model_as_synthetic_data_generator_for_perception_tasks.md)**
...
**[S2GO: Streaming Sparse Gaussian Occupancy](s2go_streaming_sparse_gaussian_occupancy.md)**
...
**[SceneStreamer: Continuous Scenario Generation as Next Token Group Prediction](scenestreamer_continuous_scenario_generation_as_next_token_group_prediction.md)**
...
**[SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms](simuli_real-time_lidar_and_camera_simulation_with_unscented_transforms.md)**
...
**[Stability under Scrutiny: Benchmarking Representation Paradigms for Online HD Map Construction](stability_under_scrutiny_benchmarking_representation_paradigms_for_online_hd_map.md)**
...
**[To View Transform or Not to View Transform: NeRF-based Pre-training Perspective](to_view_transform_or_not_to_view_transform_nerf-based_pre-training_perspective.md)**
...
**[TrajTok: What makes for a good trajectory tokenizer in behavior generation?](trajtok_what_makes_for_a_good_trajectory_tokenizer_in_behavior_generation.md)**
...
**[UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction](unisplat_unified_spatio-temporal_fusion_via_3d_latent_scaffolds_for_dynamic_driv.md)**
...
**[VADv2: End-to-End Vectorized Autonomous Driving via Probabilistic Planning](vadv2_end-to-end_vectorized_autonomous_driving_via_probabilistic_planning.md)**
...
**[WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving](worldsplat_gaussian-centric_feed-forward_4d_scene_generation_for_autonomous_driv.md)**
