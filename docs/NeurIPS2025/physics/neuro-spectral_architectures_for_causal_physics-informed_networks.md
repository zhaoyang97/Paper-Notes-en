...
description: >-
  [NeurIPS 2025][Physics & Scientific Computing][PINN] NeuSA integrates classical spectral methods with Neural ODEs: the PDE is projected onto a spectral basis (Fourier) to obtain an ODE system…
tags:
  - "NeurIPS 2025"
