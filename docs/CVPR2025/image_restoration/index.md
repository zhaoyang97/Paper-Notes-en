---
title: >-
  CVPR2025 Image Restoration Papers · 41 Notes
description: >-
  41 CVPR2025 papers in the Image Restoration area, covering Image Restoration, Super-Resolution, Diffusion Models, Adversarial Robustness, Self-Supervised Learning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2025"
  - "Image Restoration"
  - "AI paper notes"
...
item_list:
  - u: "a_flag_decomposition_for_hierarchical_datasets/"
    t: "A Flag Decomposition for Hierarchical Datasets"
  - u: "a_physics-informed_blur_learning_framework_for_imaging_systems/"
    t: "A Physics-Informed Blur Learning Framework for Imaging Systems"
  - u: "a_regularization-guided_equivariant_approach_for_image_restoration/"
    t: "EQ-Reg: A Regularization-Guided Equivariant Approach for Image Restoration"
  - u: "adversarial_diffusion_compression_for_real-world_image_super-resolution/"
    t: "AdcSR: Adversarial Diffusion Compression for Real-World Image Super-Resolution"
  - u: "augmenting_perceptual_super-resolution_via_image_quality_predictors/"
    t: "Augmenting Perceptual Super-Resolution via Image Quality Predictors"
  - u: "classic_video_denoising_in_a_machine_learning_world_robust_fast_and_controllable/"
    t: "Classic Video Denoising in a Machine Learning World: Robust, Fast, and Controllable"
  - u: "complexity_experts_are_task-discriminative_learners_for_any_image_restoration/"
    t: "Complexity Experts are Task-Discriminative Learners for Any Image Restoration"
  - u: "darkir_robust_low-light_image_restoration/"
    t: "DarkIR: Robust Low-Light Image Restoration"
  - u: "degradation-aware_feature_perturbation_for_all-in-one_image_restoration/"
    t: "Degradation-Aware Feature Perturbation for All-in-One Image Restoration"
  - u: "detail-preserving_latent_diffusion_for_stable_shadow_removal/"
    t: "Detail-Preserving Latent Diffusion for Stable Shadow Removal"
  - u: "dnlut_ultra-efficient_color_image_denoising_via_channel-aware_lookup_tables/"
    t: "DnLUT: Ultra-Efficient Color Image Denoising via Channel-Aware Lookup Tables"
  - u: "dpir_dual_prompting_restoration_dit/"
    t: "DPIR: Dual Prompting Image Restoration with Diffusion Transformers"
  - u: "echomimicv2_towards_striking_simplified_and_semi-body_human_animation/"
    t: "EchoMimicV2: Towards Striking, Simplified, and Semi-Body Human Animation"
  - u: "efficient_diffusion_as_low_light_enhancer/"
    t: "Efficient Diffusion as Low Light Enhancer (ReDDiT)"
  - u: "efficient_visual_state_space_model_for_image_deblurring/"
    t: "Efficient Visual State Space Model for Image Deblurring"
  - u: "fire_fixed-points_of_restoration_priors_for_solving_inverse_problems/"
    t: "FiRe: Fixed-points of Restoration Priors for Solving Inverse Problems"
  - u: "generalized_recorrupted-to-recorrupted_self-supervised_learning_beyond_gaussian_/"
    t: "Generalized Recorrupted-to-Recorrupted: Self-Supervised Learning Beyond Gaussian Noise"
  - u: "gyro-based_neural_single_image_deblurring/"
    t: "Gyro-based Neural Single Image Deblurring"
  - u: "hvi_a_new_color_space_for_low-light_image_enhancement/"
    t: "HVI: A New Color Space for Low-light Image Enhancement"
  - u: "infp_audio-driven_interactive_head_generation_in_dyadic_conversations/"
    t: "INFP: Audio-Driven Interactive Head Generation in Dyadic Conversations"
  - u: "iterative_predictor-critic_code_decoding_for_real-world_image_dehazing/"
    t: "Iterative Predictor-Critic Code Decoding for Real-World Image Dehazing"
  - u: "mair_a_locality-_and_continuity-preserving_mamba_for_image_restoration/"
    t: "MaIR: A Locality- and Continuity-Preserving Mamba for Image Restoration"
  - u: "mambairv2_attentive_state_space_restoration/"
    t: "MambaIRv2: Attentive State Space Restoration"
  - u: "one-step_event-driven_high-speed_autofocus/"
    t: "One-Step Event-Driven High-Speed Autofocus"
  - u: "pidsr_complementary_polarized_image_demosaicing_and_super-resolution/"
    t: "PIDSR: Complementary Polarized Image Demosaicing and Super-Resolution"
  - u: "pixel-level_and_semantic-level_adjustable_super-resolution_a_dual-lora_approach/"
    t: "Pixel-level and Semantic-level Adjustable Super-resolution: A Dual-LoRA Approach"
  - u: "polarfree_polarization-based_reflection-free_imaging/"
    t: "PolarFree: Polarization-based Reflection-Free Imaging"
  - u: "polishing_the_sky_wide-field_and_high-dynamic_range_interferometric_image_recons/"
    t: "POLISH'ing the Sky: Wide-Field and High-Dynamic Range Interferometric Image Reconstruction with Application to Strong Lens Discovery"
  - u: "prior_does_matter_visual_navigation_via_denoising_diffusion_bridge_models/"
    t: "Prior Does Matter: Visual Navigation via Denoising Diffusion Bridge Models"
  - u: "progressive_focused_transformer_for_single_image_super-resolution/"
    t: "Progressive Focused Transformer for Single Image Super-Resolution"
item_total: 41
---
