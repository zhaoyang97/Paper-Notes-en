...
- [\[ICML 2026\] SAFAG: Generalizable Actionable Part Pose Estimation Without Symmetry Annotation](generalizable_and_actionable_parts_pose_estimation_with_symmetry_annotation-free.md)
