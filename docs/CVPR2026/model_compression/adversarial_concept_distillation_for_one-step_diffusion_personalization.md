...
description: >-
  [CVPR 2026][Model Compression][one-step diffusion model] OPAD is the first work to address personalization for one-step diffusion models (1-SDP). It achieves single-step high-quality concept generation via joint teacher–…
tags:
  - "CVPR 2026"
  - "Model Compression"
