...
description: >-
  [CVPR 2026][Time Series][EEG decoding] This paper proposes SATTC, a label-free test-time calibration head that operates directly on the similarity matrix over frozen EEG and image encoders. It combines a geometric expert…
tags:
  - "CVPR 2026"
  - "Time Series"
  - "EEG decoding"
