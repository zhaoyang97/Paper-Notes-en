---
title: >-
  NeurIPS2025 Reinforcement Learning Papers · 143 Notes
description: >-
  143 NeurIPS2025 papers in the Reinforcement Learning area, covering Reinforcement Learning, Agents, Reasoning, Adversarial Robustness, Diffusion Models, Multimodal/VLM and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "NeurIPS2025"
  ...
  - "Multimodal/VLM"
item_list:
  - u: "a_differential_and_pointwise_control_approach_to_reinforceme/"
    t: "A Differential and Pointwise Control Approach to Reinforcement Learning"
  - u: "a_generalized_bisimulation_metric_of_state_similarity_betwee/"
    t: "A Generalized Bisimulation Metric of State Similarity between Markov Decision Processes: From Theoretical Propositions to Applications"
  - u: "a_nearoptimal_scalable_and_parallelizable_framework_for_stoc/"
    t: "A Near-optimal, Scalable and Parallelizable Framework for Stochastic Bandits Robust to Adversarial Corruptions and Beyond"
  - u: "a_theory_of_multi-agent_generative_flow_networks/"
    t: "A Theory of Multi-Agent Generative Flow Networks"
  - u: "a_unifying_view_of_linear_function_approximation_in_offpolic/"
    t: "A Unifying View of Linear Function Approximation in Off-Policy RL Through Matrix Splitting and Preconditioning"
  - u: "actorfree_continuous_control_via_structurally_maximizable_qf/"
    t: "Actor-Free Continuous Control via Structurally Maximizable Q-Functions"
  - u: "adaptive_cooperative_transmission_design_for_ultra-reliable_low-latency_communic/"
    t: "Adaptive Cooperative Transmission Design for URLLC via Deep RL"
  - u: "adaptive_neighborhoodconstrained_q_learning_for_offline_rein/"
    t: "Adaptive Neighborhood-Constrained Q Learning for Offline Reinforcement Learning"
  - u: "adaptively_coordinating_with_novel_partners_via_learned_latent_strategies/"
    t: "Adaptively Coordinating with Novel Partners via Learned Latent Strategies"
  - u: "aline_joint_amortization_for_bayesian_inference_and_active_data_acquisition/"
    t: "ALINE: Joint Amortization for Bayesian Inference and Active Data Acquisition"
  - u: "approximating_shapley_explanations_in_reinforcement_learning/"
    t: "Approximating Shapley Explanations in Reinforcement Learning"
  - u: "bandit_and_delayed_feedback_in_online_structured_prediction/"
    t: "Bandit and Delayed Feedback in Online Structured Prediction"
  - u: "behavior_injection_preparing_language_models_for_reinforcement_learning/"
    t: "Behavior Injection: Preparing Language Models for Reinforcement Learning"
  - u: "blending_complementary_memory_systems_in_hybrid_quadratic-linear_transformers/"
    t: "Blending Complementary Memory Systems in Hybrid Quadratic-Linear Transformers"
  - u: "bootstrap_off-policy_with_world_model/"
    t: "Bootstrap Off-policy with World Model (BOOM)"
  - u: "boundary_to_region_supervision_for_offline_safe_rl/"
    t: "Boundary-to-Region Supervision for Offline Safe Reinforcement Learning"
  - u: "certifying_concavity_and_monotonicity_in_games_via_sum-of-squares_hierarchies/"
    t: "Certifying Concavity and Monotonicity in Games via Sum-of-Squares Hierarchies"
  - u: "certifying_stability_of_reinforcement_learning_policies_using_generalized_lyapun/"
    t: "Certifying Stability of Reinforcement Learning Policies using Generalized Lyapunov Functions"
  - u: "checklists_are_better_than_reward_models_for_aligning_langua/"
    t: "Checklists Are Better Than Reward Models For Aligning Language Models"
  - u: "comparing_uniform_price_and_discriminatory_multi-unit_auctions_through_regret_mi/"
    t: "Comparing Uniform Price and Discriminatory Multi-Unit Auctions through Regret Minimization"
  - u: "complexity_scaling_laws_for_neural_models_using_combinatorial_optimization/"
    t: "Complexity Scaling Laws for Neural Models using Combinatorial Optimization"
  - u: "computational_hardness_of_reinforcement_learning_with_partial_qπ-realizability/"
    t: "Computational Hardness of Reinforcement Learning with Partial $q^\\pi$-Realizability"
  - u: "confounding_robust_deep_reinforcement_learning_a_causal_approach/"
    t: "Confounding Robust Deep Reinforcement Learning: A Causal Approach"
  - u: "continual_knowledge_adaptation_for_reinforcement_learning/"
    t: "Continual Knowledge Adaptation for Reinforcement Learning"
  - u: "convergence_theorems_for_entropy-regularized_and_distributional_reinforcement_le/"
    t: "Convergence Theorems for Entropy-Regularized and Distributional Reinforcement Learning"
  - u: "core_constraint-aware_one-step_reinforcement_learning_for_simulation-guided_neur/"
    t: "CORE: Constraint-Aware One-Step Reinforcement Learning for Simulation-Guided Neural Network Accelerator Design"
  - u: "counteractive_rl_rethinking_core_principles_for_efficient_and_scalable_deep_rein/"
    t: "Counteractive RL: Rethinking Core Principles for Efficient and Scalable Deep Reinforcement Learning"
  - u: "dccluster-opt_benchmarking_dynamic_multi-objective_optimization_for_geo-distribu/"
    t: "DCcluster-Opt: Benchmarking Dynamic Multi-Objective Optimization for Geo-Distributed Data Center Workloads"
  - u: "decoderhybriddecoder_architecture_for_efficient_reasoning_wi/"
    t: "Decoder-Hybrid-Decoder Architecture for Efficient Reasoning with Long Generation"
  - u: "deep_rl_needs_deep_behavior_analysis_exploring_implicit_planning_by_model-free_a/"
    t: "Deep RL Needs Deep Behavior Analysis: Exploring Implicit Planning by Model-Free Agents"
item_total: 143
---
