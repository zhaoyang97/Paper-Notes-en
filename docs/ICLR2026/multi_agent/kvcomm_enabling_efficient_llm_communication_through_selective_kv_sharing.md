...
description: >-
  [ICLR 2026][Multi-Agent][LLM communication] This paper proposes KVComm, a framework that enables efficient inter-LLM communication via selective KV pair sharing. It identifies an "information concentration bias" in hidde…
tags:
  - "ICLR 2026"
  - "Multi-Agent"
  - "LLM communication"
