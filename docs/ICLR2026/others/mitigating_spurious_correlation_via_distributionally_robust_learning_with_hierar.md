...
description: >-
  [ICLR 2026][Spurious correlation] A hierarchical DRO framework is proposed to simultaneously capture inter-group (group proportion shifts) and intra-group (intra-group distributional shifts) uncertainty. By defining intr…
tags:
  - "ICLR 2026"
