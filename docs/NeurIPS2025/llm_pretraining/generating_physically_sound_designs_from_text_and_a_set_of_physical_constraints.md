...
description: >-
  [NeurIPS 2025][LLM Pretraining][topology optimization] This paper proposes TIDES, a framework that combines the visual guidance of pretrained text-image models (CLIP) with a differentiable finite-element physics simulato…
tags:
  - "NeurIPS 2025"
  - "LLM Pretraining"
