---
title: >-
  ICLR2026 Image Generation Papers · 357 Notes
description: >-
  357 ICLR2026 papers in the Image Generation area, covering Diffusion Models, Text-to-Image, Alignment/RLHF, Image Editing, Layout & Composition, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Image Generation"
  - "AI paper notes"
...
item_list:
  ...
  - u: "a_probabilistic_hard_concept_bottleneck_for_steerable_generative_models/"
    t: "A Probabilistic Hard Concept Bottleneck for Steerable Generative Models"
  - u: "ac-sampler_accelerate_and_correct_diffusion_sampling_with_metropolis-hastings_al/"
    t: "AC-Sampler: Accelerate and Correct Diffusion Sampling with Metropolis-Hastings Algorithm"
  - u: "accord_alleviating_concept_coupling_through_dependence_regularization_for_text-t/"
    t: "ACCORD: Alleviating Concept Coupling through Dependence Regularization for Text-to-Image Diffusion Personalization"
  ...
  - u: "aegis_adversarial_target-guided_retention-data-free_robust_concept_erasure_from_/"
    t: "AEGIS: Adversarial Target-Guided Retention-Data-Free Robust Concept Erasure from Diffusion Models"
  ...
  - u: "alpha-dpo_robust_preference_alignment_for_diffusion_models_via_alpha_divergence/"
    t: "$\\alpha$-DPO: Robust Preference Alignment for Diffusion Models via $\\alpha$ Divergence"
  ...
  - u: "antithetic_noise_in_diffusion_models/"
    t: "Antithetic Noise in Diffusion Models"
  - u: "any-order_flexible_length_masked_diffusion/"
    t: "Any-Order Flexible Length Masked Diffusion"
  - u: "any-step_generation_via_n-th_order_recursive_consistent_velocity_field_estimatio/"
    t: "Any-step Generation via N-th Order Recursive Consistent Velocity Field Estimation"
  ...
  - u: "attrictrl_a_generalizable_framework_for_controlling_semantic_attribute_intensity/"
    t: "AttriCtrl: A Generalizable Framework for Controlling Semantic Attribute Intensity in Diffusion Models"
  ...
  - u: "avoid_catastrophic_forgetting_with_rank-1_fisher_from_diffusion_models/"
    t: "Avoid Catastrophic Forgetting with Rank-1 Fisher from Diffusion Models"
  - u: "bar_refactor_the_basis_of_autoregressive_visual_generation/"
    t: "BAR: Refactor the Basis of Autoregressive Visual Generation"
  ...
  - u: "bringing_stability_to_diffusion_decomposing_and_reducing_variance_of_training_ma/"
    t: "Bringing Stability to Diffusion: Decomposing and Reducing Variance of Training Masked Diffusion Models"
item_total: 357
---
...
**[A Probabilistic Hard Concept Bottleneck for Steerable Generative Models](a_probabilistic_hard_concept_bottleneck_for_steerable_generative_models.md)**
...
**[AC-Sampler: Accelerate and Correct Diffusion Sampling with Metropolis-Hastings Algorithm](ac-sampler_accelerate_and_correct_diffusion_sampling_with_metropolis-hastings_al.md)**
...
**[ACCORD: Alleviating Concept Coupling through Dependence Regularization for Text-to-Image Diffusion Personalization](accord_alleviating_concept_coupling_through_dependence_regularization_for_text-t.md)**
...
**[AEGIS: Adversarial Target-Guided Retention-Data-Free Robust Concept Erasure from Diffusion Models](aegis_adversarial_target-guided_retention-data-free_robust_concept_erasure_from_.md)**
...
**[$\alpha$-DPO: Robust Preference Alignment for Diffusion Models via $\alpha$ Divergence](alpha-dpo_robust_preference_alignment_for_diffusion_models_via_alpha_divergence.md)**
...
**[Antithetic Noise in Diffusion Models](antithetic_noise_in_diffusion_models.md)**
...
**[Any-step Generation via N-th Order Recursive Consistent Velocity Field Estimation](any-step_generation_via_n-th_order_recursive_consistent_velocity_field_estimatio.md)**
...
**[AttriCtrl: A Generalizable Framework for Controlling Semantic Attribute Intensity in Diffusion Models](attrictrl_a_generalizable_framework_for_controlling_semantic_attribute_intensity.md)**
...
**[Avoid Catastrophic Forgetting with Rank-1 Fisher from Diffusion Models](avoid_catastrophic_forgetting_with_rank-1_fisher_from_diffusion_models.md)**
...
**[BAR: Refactor the Basis of Autoregressive Visual Generation](bar_refactor_the_basis_of_autoregressive_visual_generation.md)**
...
**[Bringing Stability to Diffusion: Decomposing and Reducing Variance of Training Masked Diffusion Models](bringing_stability_to_diffusion_decomposing_and_reducing_variance_of_training_ma.md)**
...
**[Carré du champ Flow Matching: Improving the Quality-Generalisation Trade-off in Generative Models via Geometry-Aware Noise](carré_du_champ_flow_matching_better_quality-generalisation_tradeoff_in_generativ.md)**
...
**[Charts Are Not Images: On the Challenges of Scientific Chart Editing](charts_are_not_images_on_the_challenges_of_scientific_chart_editing.md)**
...
**[ChronoEdit: Towards Temporal Reasoning for In-Context Image Editing and World Simulation](chronoedit_towards_temporal_reasoning_for_in-context_image_editing_and_world_sim.md)**
...
**[Co-occurring Associated REtained concepts in Diffusion Unlearning](co-occurring_associated_retained_concepts_in_diffusion_unlearning.md)**
...
**[CoCoDiff: Correspondence-Consistent Diffusion Model for Fine-grained Style Transfer](cocodiff_correspondence-consistent_diffusion_model_for_fine-grained_style_transf.md)**
...
**[CoDA: From Text-to-Image Diffusion Models to Training-Free Dataset Distillation](coda_from_text-to-image_diffusion_models_to_training-free_dataset_distillation.md)**

:   To be supplemented after further reading.

**[CoDi: Subject-Consistent and Pose-Diverse Text-to-Image Generation](codi_subject-consistent_and_pose-diverse_text-to-image_generation.md)**

:   To be supplemented after further reading.

**[CoEmoGen: Towards Semantically-Coherent and Scalable Emotional Image Content Generation](coemogen_towards_semantically-coherent_and_scalable_emotional_image_content_gene.md)**
...
**[Composition of Pretrained Diffusion Models: A Logic-Based Calculus](composition_of_pretrained_diffusion_models_a_logic-based_calculus.md)**
...
**[Compositional Visual Planning via Inference-Time Diffusion Scaling](compositional_visual_planning_via_inference-time_diffusion_scaling.md)**
...
**[Consis-GCPO: Consistency-Preserving Group Causal Preference Optimization for Vision Customization](consis-gcpo_consistency-preserving_group_causal_preference_optimization_for_visi.md)**
...
**[Consolidating Reinforcement Learning for Multimodal Discrete Diffusion Models](consolidating_reinforcement_learning_for_multimodal_discrete_diffusion_models.md)**
...
**[Constantly Improving Image Models Need Constantly Improving Benchmarks](constantly_improving_image_models_need_constantly_improving_benchmarks.md)**
...
**[ContextBench: Modifying Contexts for Targeted Latent Activation and Behaviour Elicitation](contextbench_modifying_contexts_for_targeted_latent_activation_and_behaviour_eli.md)**
...
**[ContextGen: Contextual Layout Anchoring for Identity-Consistent Multi-Instance Generation](contextgen_contextual_layout_anchoring_for_identity-consistent_multi-instance_ge.md)**
...
**[Continuously Augmented Discrete Diffusion model for Categorical Generative Modeling](continuously_augmented_discrete_diffusion_model_for_categorical_generative_model.md)**
...
**[Contrastive Diffusion Guidance for Spatial Inverse Problems](contrastive_diffusion_guidance_for_spatial_inverse_problems.md)**
...
**[CreatiDesign: A Unified Multi-Conditional Diffusion Transformer for Creative Graphic Design](creatidesign_a_unified_multi-conditional_diffusion_transformer_for_creative_grap.md)**
...
**[CroCoDiLight: Repurposing Cross-View Completion Encoders for Relighting](crocodilight_repurposing_cross-view_completion_encoders_for_relighting.md)**
...
**[Cross-ControlNet: Training-Free Fusion of Multiple Conditions for Text-to-Image Generation](cross-controlnet_training-free_fusion_of_multiple_conditions_for_text-to-image_g.md)**
...
**[D-AR: Diffusion via Autoregressive Models](d-ar_diffusion_via_autoregressive_models.md)**
...
**[Deconstructing Guidance: A Semantic Hierarchy for Precise Diffusion Model Editing](deconstructing_guidance_a_semantic_hierarchy_for_precise_diffusion_model_editing.md)**
...
**[Decoupled DMD: CFG Augmentation as the Spear, Distribution Matching as the Shield](decoupled_dmd_cfg_augmentation_as_the_spear_distribution_matching_as_the_shield.md)**
...
**[Decoupled MeanFlow: Turning Flow Models into Flow Maps for Accelerated Sampling](decoupled_meanflow_turning_flow_models_into_flow_maps_for_accelerated_sampling.md)**
...
**[Delay Flow Matching](delay_flow_matching.md)**
...
**[DeLeaker: Dynamic Inference-Time Reweighting For Semantic Leakage Mitigation in Text-to-Image Models](deleaker_dynamic_inference-time_reweighting_for_semantic_leakage_mitigation_in_t.md)**
...
**[DeRaDiff: Denoising Time Realignment of Diffusion Models](deradiff_denoising_time_realignment_of_diffusion_models.md)**
...
**[Diagnosing and Improving Diffusion Models by Estimating the Optimal Loss Value](diagnosing_and_improving_diffusion_models_by_estimating_the_optimal_loss_value.md)**
...
**[DiffSDA: Unsupervised Diffusion Sequential Disentanglement Across Modalities](diffsda_unsupervised_diffusion_sequential_disentanglement_across_modalities.md)**
...
**[DiffSparse: Accelerating Diffusion Transformers with Learned Token Sparsity](diffsparse_accelerating_diffusion_transformers_with_learned_token_sparsity.md)**
...
**[Diffusion & Adversarial Schrödinger Bridges via Iterative Proportional Markovian Fitting](diffusion_adversarial_schrödinger_bridges_via_iterative_proportional_markovian_f.md)**
...
**[Diffusion Negative Preference Optimization Made Simple](diffusion_negative_preference_optimization_made_simple.md)**
...
**[Diffusion Transformers with Representation Autoencoders](diffusion_transformers_with_representation_autoencoders.md)**
...
**[Discrete Guidance Matching: Exact Guidance for Discrete Flow Matching](discrete_guidance_matching_exact_guidance_for_discrete_flow_matching.md)**
...
**[Discrete Variational Autoencoding via Policy Search](discrete_variational_autoencoding_via_policy_search.md)**
...
**[Do We Need All the Synthetic Data? Targeted Image Augmentation via Diffusion Models](do_we_need_all_the_synthetic_data_targeted_image_augmentation_via_diffusion_mode.md)**
...
**[Dragging with Geometry: From Pixels to Geometry-Guided Image Editing](dragging_with_geometry_from_pixels_to_geometry-guided_image_editing.md)**
...
**[Dual-Path Condition Alignment for Diffusion Transformers](dual-path_condition_alignment_for_diffusion_transformers.md)**
...
**[Durian: Dual Reference Image-Guided Portrait Animation with Attribute Transfer](durian_dual_reference_image-guided_portrait_animation_with_attribute_transfer.md)**

:   To be supplemented after a thorough reading of the paper.

**[Dynamic Classifier-Free Diffusion Guidance via Online Feedback](dynamic_classifier-free_diffusion_guidance_via_online_feedback.md)**
...
**[EchoGen: Generating Visual Echoes in Any Scene via Feed-Forward Subject-Driven Auto-Regressive Model](echogen_generating_visual_echoes_in_any_scene_via_feed-forward_subject-driven_au.md)**
...
**[Edit-Based Flow Matching for Temporal Point Processes](edit-based_flow_matching_for_temporal_point_processes.md)**
...
**[EdiVal-Agent: An Object-Centric Framework for Automated, Fine-Grained Evaluation of Multi-Turn Editing](edival-agent_an_object-centric_framework_for_automated_fine-grained_evaluation_o.md)**
...
**[Efficient Approximate Posterior Sampling with Annealed Langevin Monte Carlo](efficient_approximate_posterior_sampling_with_annealed_langevin_monte_carlo.md)**
...
**[Efficient Sliced Wasserstein Distance Computation via Adaptive Bayesian Optimization](efficient_sliced_wasserstein_distance_computation_via_adaptive_bayesian_optimiza.md)**
...
**[Efficient Zero-shot Inpainting with Decoupled Diffusion Guidance](efficient_zero-shot_inpainting_with_decoupled_diffusion_guidance.md)**
...
**[Enhanced Generative Model Evaluation with Clipped Density and Coverage](enhanced_generative_model_evaluation_with_clipped_density_and_coverage.md)**
...
**[Entering the Era of Discrete Diffusion Models: A Benchmark for Schrödinger Bridges and Entropic Optimal Transport](entering_the_era_of_discrete_diffusion_models_a_benchmark_for_schrödinger_bridge.md)**
...
**[Exploring the Design Space of Transition Matching](exploring_the_design_space_of_transition_matching.md)**
...
**[FACM: Flow-Anchored Consistency Models](facm_flow-anchored_consistency_models.md)**
...
**[FARI: Robust One-Step Inversion for Watermarking in Diffusion Models](fari_robust_one-step_inversion_for_watermarking_in_diffusion_models.md)**
...
**[Flow Along the $K$-Amplitude for Generative Modeling](flow_along_the_k-amplitude_for_generative_modeling.md)**
...
**[Flow Map Learning via Non-Gradient Vector Flow](flow_map_learning_via_non-gradient_vector_flow.md)**
...
**[Flow Matching with Semidiscrete Couplings](flow_matching_with_semidiscrete_couplings.md)**
...
**[Flow Straight and Fast in Hilbert Space: Functional Rectified Flow](flow_straight_and_fast_in_hilbert_space_functional_rectified_flow.md)**
...
**[FlowAlign: Trajectory-Regularized, Inversion-Free Flow-based Image Editing](flowalign_trajectory-regularized_inversion-free_flow-based_image_editing.md)**
...
**[FLUX-Reason-6M & PRISM-Bench: A Million-Scale Text-to-Image Reasoning Dataset and Comprehensive Benchmark](flux-reason-6m_prism-bench_a_million-scale_text-to-image_reasoning_dataset_and_c.md)**
...
**[Follow-Your-Preference: Towards Preference-Aligned Image Inpainting](follow-your-preference_towards_preference-aligned_image_inpainting.md)**
...
**[Foresight Diffusion: Improving Sampling Consistency in Predictive Diffusion Models](foresight_diffusion_improving_sampling_consistency_in_predictive_diffusion_model.md)**
...
**[Forget Many, Forget Right: Scalable and Precise Concept Unlearning in Diffusion Models](forget_many_forget_right_scalable_and_precise_concept_unlearning_in_diffusion_mo.md)**
...
**[Forward-Learned Discrete Diffusion: Learning how to noise to denoise faster](forward-learned_discrete_diffusion_learning_how_to_noise_to_denoise_faster.md)**
...
**[From Broad Exploration to Stable Synthesis: Entropy-Guided Optimization for Autoregressive Image Generation](from_broad_exploration_to_stable_synthesis_entropy-guided_optimization_for_autor.md)**
...
**[GarmentGPT: Compositional Garment Pattern Generation via Discrete Latent Tokenization](garmentgpt_compositional_garment_pattern_generation_via_discrete_latent_tokeniza.md)**
...
**[GAS: Improving Discretization of Diffusion ODEs via Generalized Adversarial Solver](gas_improving_discretization_of_diffusion_odes_via_generalized_adversarial_solve.md)**
...
**[Gauge Flow Matching: Efficient Constrained Generative Modeling over General Convex Set and Beyond](gauge_flow_matching_efficient_constrained_generative_modeling_over_general_conve.md)**
...
**[GenCompositor: Generative Video Compositing with Diffusion Transformer](gencompositor_generative_video_compositing_with_diffusion_transformer.md)**
...
**[Generalised Flow Maps for Few-Step Generative Modelling on Riemannian Manifolds](generalised_flow_maps_for_few-step_generative_modelling_on_riemannian_manifolds.md)**
...
**[Generating Metamers of Human Scene Understanding](generating_metamers_of_human_scene_understanding.md)**
...
**[Generation then Reconstruction: Accelerating Masked Autoregressive Models via Two-Stage Sampling](generation_then_reconstruction_accelerating_masked_autoregressive_models_via_two.md)**
...
**[Generative Blocks World: Moving Things Around in Pictures](generative_blocks_world_moving_things_around_in_pictures.md)**
...
**[Generative Modeling from Black-Box Corruptions via Self-Consistent Stochastic Interpolants](generative_modeling_from_black-box_corruptions_via_self-consistent_stochastic_in.md)**
...
**[Geometric Image Editing via Effects-Sensitive In-Context Inpainting with Diffusion Transformers](geometric_image_editing_via_effects-sensitive_in-context_inpainting_with_diffusi.md)**
...
**[GoT-R1: Unleashing Reasoning Capability of Autoregressive Visual Generation with Reinforcement Learning](got-r1_unleashing_reasoning_capability_of_autoregressive_visual_generation_with_.md)**
...
**[Group Critical-token Policy Optimization for Autoregressive Image Generation](group_critical-token_policy_optimization_for_autoregressive_image_generation.md)**
...
**[Guidance Matters: Rethinking the Evaluation Pitfall for Text-to-Image Generation](guidance_matters_rethinking_the_evaluation_pitfall_for_text-to-image_generation.md)**
...
**[Guidance Watermarking for Diffusion Models](guidance_watermarking_for_diffusion_models.md)**
...
**[Half-order Fine-Tuning for Diffusion Model: A Recursive Likelihood Ratio Optimizer](half-order_fine-tuning_for_diffusion_model_a_recursive_likelihood_ratio_optimize.md)**
...
**[HiCache: A Plug-in Scaled-Hermite Upgrade for Taylor-Style Cache-then-Forecast Diffusion Acceleration](hicache_a_plug-in_scaled-hermite_upgrade_for_taylor-style_cache-then-forecast_di.md)**
...
**[HiGS: History-Guided Sampling for Plug-and-Play Enhancement of Diffusion Models](higs_history-guided_sampling_for_plug-and-play_enhancement_of_diffusion_models.md)**
...
**[Hyperspherical Latents Improve Continuous-Token Autoregressive Generation](hyperspherical_latents_improve_continuous-token_autoregressive_generation.md)**
...
**[I-DRUID: Layout to Image Generation via Instance-Disentangled Representation and Unpaired Data](i-druid_layout_to_image_generation_via_instance-disentangled_representation_and_.md)**
...
**[ImageDoctor: Diagnosing Text-to-Image Generation via Grounded Image Reasoning](imagedoctor_diagnosing_text-to-image_generation_via_grounded_image_reasoning.md)**
...
**[ImagenWorld: Stress-Testing Image Generation Models with Explainable Human Evaluation on Open-ended Real-World Tasks](imagenworld_stress-testing_image_generation_models_with_explainable_human_evalua.md)**
...
**[ImageRAG: Dynamic Image Retrieval for Reference-Guided Image Generation](imagerag_dynamic_image_retrieval_for_reference-guided_image_generation.md)**
...
**[Implicit Inversion turns CLIP into a Decoder](implicit_inversion_turns_clip_into_a_decoder.md)**
...
**[Improving Classifier-Free Guidance in Masked Diffusion: Low-Dim Theoretical Insights with High-Dim Impact](improving_classifier-free_guidance_in_masked_diffusion_low-dim_theoretical_insig.md)**
...
**[Improving Diffusion Models for Class-imbalanced Training Data via Capacity Manipulation](improving_diffusion_models_for_class-imbalanced_training_data_via_capacity_manip.md)**
...
**[Inference-Time Scaling of Diffusion Models Through Classical Search](inference-time_scaling_of_diffusion_models_through_classical_search.md)**
...
**[Inference-Time Scaling of Discrete Diffusion Models via Importance Weighting and Optimal Proposal Design](inference-time_scaling_of_discrete_diffusion_models_via_importance_weighting_and.md)**
...
**[Interaction Field Matching: Overcoming Limitations of Electrostatic Models](interaction_field_matching_overcoming_limitations_of_electrostatic_models.md)**
...
**[Interleaving Reasoning for Better Text-to-Image Generation](interleaving_reasoning_for_better_text-to-image_generation.md)**
...
**[Joint Distillation for Fast Likelihood Evaluation and Sampling in Flow-based Models](joint_distillation_for_fast_likelihood_evaluation_and_sampling_in_flow-based_mod.md)**
...
**[LapFlow: Laplacian Multi-scale Flow Matching for Generative Modeling](lapflow_laplacian_multi-scale_flow_matching_for_generative_modeling.md)**
...
**[Latent Denoising Makes Good Tokenizers](latent_denoising_makes_good_tokenizers.md)**
...
**[Latent Stochastic Interpolants](latent_stochastic_interpolants.md)**
...
**[Latent Wavelet Diffusion for Ultra-High-Resolution Image Synthesis](latent_wavelet_diffusion_for_ultra_high-resolution_image_synthesis.md)**
...
**[LaTo: Landmark-tokenized Diffusion Transformer for Fine-grained Human Face Editing](lato_landmark-tokenized_diffusion_transformer_for_fine-grained_human_face_editin.md)**
...
**[LayerSync: Self-aligning Intermediate Layers](layersync_self-aligning_intermediate_layers.md)**
...
**[LazyDrag: Enabling Stable Drag-Based Editing on Multi-Modal Diffusion Transformers via Explicit Correspondence](lazydrag_enabling_stable_drag-based_editing_on_multi-modal_diffusion_transformer.md)**
...
**[Learn to Guide Your Diffusion Model](learn_to_guide_your_diffusion_model.md)**
...
**[Learning an Image Editing Model without Image Editing Pairs](learning_an_image_editing_model_without_image_editing_pairs.md)**
...
**[Learning AND-OR Templates for Compositional Representation in Art and Design](learning_andor_templates_for_compositional_representation_in_art_and_design.md)**
...
**[Let Features Decide Their Own Solvers: Hybrid Feature Caching for Diffusion Transformers](let_features_decide_their_own_solvers_hybrid_feature_caching_for_diffusion_trans.md)**
...
**[LogiStory: A Logic-Aware Framework for Multi-Image Story Visualization](logistory_a_logic-aware_framework_for_multi-image_story_visualization.md)**
...
**[Long-Text-to-Image Generation via Compositional Prompt Decomposition](long-text-to-image_generation_via_compositional_prompt_decomposition.md)**
...
**[Many-for-Many: Unify the Training of Multiple Video and Image Generation and Manipulation Tasks](many-for-many_unify_the_training_of_multiple_video_and_image_generation_and_mani.md)**
...
**[Massive Activations are the Key to Local Detail Synthesis in Diffusion Transformers](massive_activations_are_the_key_to_local_detail_synthesis_in_diffusion_transform.md)**
...
**[MeanCache: From Instantaneous to Average Velocity for Accelerating Flow Matching Inference](meancache_from_instantaneous_to_average_velocity_for_accelerating_flow_matching_.md)**
...
**[Measurement Score-based Diffusion Model (MSM)](measurement_score-based_diffusion_model.md)**
...
**[MILR: Improving Multimodal Image Generation via Test-Time Latent Reasoning](milr_improving_multimodal_image_generation_via_test-time_latent_reasoning.md)**
...
**[Mirror Flow Matching with Heavy-Tailed Priors for Generative Modeling on Convex Domains](mirror_flow_matching_with_heavy-tailed_priors_for_generative_modeling_on_convex_.md)**
...
**[Mitigating Noise Shift in Denoising Generative Models with Noise Awareness Guidance](mitigating_noise_shift_in_denoising_generative_models_with_noise_awareness_guida.md)**
...
**[Mitigating Semantic Collapse in Generative Personalization with Test-Time Embedding Adjustment](mitigating_semantic_collapse_in_generative_personalization_with_test-time_embedd.md)**
...
**[MMaDA-Parallel: Multimodal Large Diffusion Language Models for Thinking-Aware Editing and Generation](mmada-parallel_multimodal_large_diffusion_language_models_for_thinking-aware_edi.md)**
...
**[MOSAIC: Multi-Subject Personalized Generation via Correspondence-Aware Alignment and Disentanglement](mosaic_multi-subject_personalized_generation_via_correspondence-aware_alignment_.md)**
...
**[Multi-Subspace Multi-Modal Modeling for Diffusion Models: Estimation, Convergence and Mixture of Experts](multi-subspace_multi-modal_modeling_for_diffusion_models_estimation_convergence_.md)**
...
**[Multiplicative Diffusion Models: Beyond Gaussian Latents](multiplicative_diffusion_models_beyond_gaussian_latents.md)**
...
**[NextStep-1: Toward Autoregressive Image Generation with Continuous Tokens at Scale](nextstep-1_toward_autoregressive_image_generation_with_continuous_tokens_at_scal.md)**
...
**[OmniPortrait: Fine-Grained Personalized Portrait Synthesis via Pivotal Optimization](omniportrait_fine-grained_personalized_portrait_synthesis_via_pivotal_optimizati.md)**
...
**[OmniText: A Training-Free Generalist for Controllable Text-Image Manipulation](omnitext_a_training-free_generalist_for_controllable_text-image_manipulation.md)**
...
**[On the Design of One-Step Diffusion via Shortcutting Flow Paths](on_the_design_of_one-step_diffusion_via_shortcutting_flow_paths.md)**
...
**[One Step Further with Monte-Carlo Sampler to Guide Diffusion Better](one_step_further_with_monte-carlo_sampler_to_guide_diffusion_better.md)**
...
**[Overshoot and Shrinkage in Classifier-Free Guidance: From Theory to Practice](overshoot_and_shrinkage_in_classifier-free_guidance_from_theory_to_practice.md)**
...
**[PairFlow: Closed-Form Source-Target Coupling for Few-Step Generation in Discrete Flow Models](pairflow_closed-form_source-target_coupling_for_few-step_generation_in_discrete_.md)**
...
**[Pareto Variational Autoencoder](pareto_variational_autoencoder.md)**
...
**[Partition Generative Modeling: Masked Modeling Without Masks](partition_generative_modeling_masked_modeling_without_masks.md)**
...
**[PCPO: Proportionate Credit Policy Optimization for Preference Alignment of Image Generation Models](pcpo_proportionate_credit_policy_optimization_for_preference_alignment_of_image_.md)**
...
**[Personalized Feature Translation for Expression Recognition: An Efficient Source-Free Domain Adaptation Method](personalized_feature_translation_for_expression_recognition_an_efficient_source-.md)**
...
**[PICABench: How Far are We from Physically Realistic Image Editing?](picabench_how_far_are_we_from_physical_realistic_image_editing.md)**
...
**[PixNerd: Pixel Neural Field Diffusion](pixnerd_pixel_neural_field_diffusion.md)**
...
**[PosterCraft: Rethinking High-Quality Aesthetic Poster Generation in a Unified Framework](postercraft_rethinking_high-quality_aesthetic_poster_generation_in_a_unified_fra.md)**
...
**[PQGAN: Product-Quantised Image Representation for High-Quality Image Synthesis](pqgan_product-quantised_image_representation_for_high-quality_image_synthesis.md)**
...
**[Preserve and Personalize: Personalized Text-to-Image Diffusion Models without Distributional Drift](preserve_and_personalize_personalized_text-to-image_diffusion_models_without_dis.md)**
...
**[Product of Experts for Visual Generation](product_of_experts_for_visual_generation.md)**
...
**[Projected Coupled Diffusion for Test-Time Constrained Joint Generation](projected_coupled_diffusion_for_test-time_constrained_joint_generation.md)**
...
**[ProReGen: Progressive Residual Generation under Attribute Correlations](proregen_progressive_residual_generation_under_attribute_correlations.md)**
...
**[Pyramidal Patchification Flow for Visual Generation](pyramid_patchification_flow_for_visual_generation.md)**
...
**[Quantization-Aware Diffusion Models for Maximum Likelihood Training](quantization-aware_diffusion_models_for_maximum_likelihood_training.md)**
...
**[Quasi-Monte Carlo Methods Enable Extremely Low-Dimensional Deep Generative Models](quasi-monte_carlo_methods_enable_extremely_low-dimensional_deep_generative_model.md)**
...
**[reAR: Rethinking Visual Autoregressive Models via Token-wise Consistency Regularization](rear_rethinking_visual_autoregressive_models_via_token-wise_consistency_regulari.md)**
...
**[Reconciling Visual Perception and Generation in Diffusion Models](reconciling_visual_perception_and_generation_in_diffusion_models.md)**
...
**[ReDDiT: Rehashing Noise for Discrete Visual Generation](reddit_rehashing_noise_for_discrete_visual_generation.md)**
...
**[ReFocusEraser: Refocusing for Small Object Removal with Robust Context-Shadow Repair](refocuseraser_refocusing_for_small_object_removal_with_robust_context-shadow_rep.md)**
...
**[RegionE: Adaptive Region-Aware Generation for Efficient Image Editing](regione_adaptive_region-aware_generation_for_efficient_image_editing.md)**
...
**[Reinforcing Diffusion Models by Direct Group Preference Optimization](reinforcing_diffusion_models_by_direct_group_preference_optimization.md)**
...
**[RePrompt: Reasoning-Augmented Reprompting for Text-to-Image Generation via Reinforcement Learning](reprompt_reasoning-augmented_reprompting_for_text-to-image_generation_via_reinfo.md)**
...
**[Rethinking Global Text Conditioning in Diffusion Transformers](rethinking_global_text_conditioning_in_diffusion_transformers.md)**
...
**[Safety-Guided Flow (SGF): A Unified Framework for Negative Guidance in Safe Generation](safety-guided_flow_sgf_a_unified_framework_for_negative_guidance_in_safe_generat.md)**
...
**[SAIL: Self-Amplified Iterative Learning for Diffusion Model Alignment with Minimal Human Feedback](sail_self-amplified_iterative_learning_for_diffusion_model_alignment_with_minima.md)**
...
**[Sample Reward Soups: Query-efficient Multi-Reward Guidance for Text-to-Image Diffusion Models](sample_reward_soups_query-efficient_multi-reward_guidance_for_text-to-image_diff.md)**
...
**[Scalable Energy-Based Models via Adversarial Training: Unifying Discrimination and Generation](scalable_energy-based_models_via_adversarial_training_unifying_discrimination_an.md)**
...
**[Scalable Training for Vector-Quantized Networks with 100% Codebook Utilization](scalable_training_for_vector-quantized_networks_with_100_codebook_utilization.md)**
...
**[Scale-wise Distillation of Diffusion Models](scale-wise_distillation_of_diffusion_models.md)**
...
**[Scaling Group Inference for Diverse and High-Quality Generation](scaling_group_inference_for_diverse_and_high-quality_generation.md)**
...
**[Scaling Laws for Diffusion Transformers](scaling_laws_for_diffusion_transformers.md)**
...
**[Score Distillation Beyond Acceleration: Generative Modeling from Corrupted Data](score_distillation_beyond_acceleration_generative_modeling_from_corrupted_data.md)**
...
**[SDErasure: Concept-Specific Trajectory Shifting for Concept Erasure via Adaptive Diffusion Classifier](sderasure_concept-specific_trajectory_shifting_for_concept_erasure_via_adaptive_.md)**
...
**[Secure Inference for Diffusion Models via Unconditional Scores](secure_inference_for_diffusion_models_via_unconditional_scores.md)**
...
**[SESaMo: Symmetry-Enforcing Stochastic Modulation for Normalizing Flows](sesamo_symmetry-enforcing_stochastic_modulation_for_normalizing_flows.md)**
...
**[Shortcut Diffusion Training with Cumulative Consistency Loss: An Optimal Control View](shortcut_diffusion_training_with_cumulative_consistency_loss_an_optimal_control_.md)**
...
**[SIGMA-GEN: Structure and Identity Guided Multi-Subject Assembly for Image Generation](sigma-gen_structure_and_identity_guided_multi-subject_assembly_for_image_generat.md)**
...
**[SketchEvo: Enhancing Sketch-Guided Image Generation with Dynamic Drawing Processes](sketchevo_leveraging_drawing_dynamics_for_enhanced_image_synthesis.md)**
...
**[SketchingReality: From Hand-Drawn Scene Sketches to Photo-Realistic Images](sketchingreality_from_freehand_scene_sketches_to_photorealistic_images.md)**
...
**[Soft-Di[M]O: Improving One-Step Discrete Image Generation with Soft Embeddings](soft-dimo_improving_one-step_discrete_image_generation_with_soft_embeddings.md)**
...
**[SoftCFG: Uncertainty-guided Stable Guidance for Visual Autoregressive Model](softcfg_uncertainty-guided_stable_guidance_for_visual_autoregressive_model.md)**
...
**[SONA: Learning Conditional, Unconditional, and Matching-Aware Discriminator](sona_learning_conditional_unconditional_and_matching-aware_discriminator.md)**
...
**[Source-Guided Flow Matching](source-guided_flow_matching.md)**
...
**[SpikeGen: Decoupling "Rod-Cone" Visual Representations with a Latent Generative Framework](spikegen_decoupled_rods_and_cones_visual_representation_processing_with_latent_g.md)**
...
**[SPRINT: Sparse-Dense Residual Fusion for Efficient Diffusion Transformers](sprint_sparse-dense_residual_fusion_for_efficient_diffusion_transformers.md)**
...
**[Stage-wise Dynamics of Classifier-Free Guidance in Diffusion Models](stage-wise_dynamics_of_classifier-free_guidance_in_diffusion_models.md)**
...
**[STORK: Accelerating Diffusion and Flow Matching Sampling by Simultaneously Solving Stiffness and Structural Dependency](stork_faster_diffusion_and_flow_matching_sampling_by_resolving_both_stiffness_an.md)**
...
**[Story-Iter: A Training-free Iterative Paradigm for Long Story Visualization](story-iter_a_training-free_iterative_paradigm_for_long_story_visualization.md)**
...
**[Strictly Constrained Generative Modeling via Split Augmented Langevin Sampling](strictly_constrained_generative_modeling_via_split_augmented_langevin_sampling.md)**
...
**[Structured Flow Autoencoders: Learning Structured Probabilistic Representations with Flow Matching](structured_flow_autoencoders_learning_structured_probabilistic_representations_w.md)**
...
**[Synthetic History: Evaluating Visual Representations of the Past in Diffusion Models](synthetic_history_evaluating_visual_representations_of_the_past_in_diffusion_mod.md)**
...
**[TempFlow-GRPO: When Timing Matters for GRPO in Flow Models](tempflow-grpo_when_timing_matters_for_grpo_in_flow_models.md)**
...
**[Terminal Velocity Matching](terminal_velocity_matching.md)**
...
**[MADFormer: Mixed Autoregressive and Diffusion Transformers for Continuous Image Generation](textitmadformer_mixed_autoregressive_and_diffusion_transformers_for_continuous_i.md)**
...
**[There is No VAE: End-to-End Pixel-Space Generative Modeling via Self-Supervised Pre-Training](there_is_no_vae_end-to-end_pixel-space_generative_modeling_via_self-supervised_p.md)**
...
**[TIPO: Text to Image with Text Pre-sampling for Prompt Optimization](tipo_text_to_image_with_text_pre-sampling_for_prompt_optimization.md)**
...
**[Towards Better Optimization for Listwise Preference in Diffusion Models](towards_better_optimization_for_listwise_preference_in_diffusion_models.md)**
...
**[Towards Sequence Modeling Alignment Between Tokenizer and Autoregressive Model](towards_sequence_modeling_alignment_between_tokenizer_and_autoregressive_model.md)**
...
**[ColorCtrl: Training-Free Text-Guided Color Editing Based on Multi-Modal Diffusion Transformer](training-free_text-guided_color_editing_with_multi-modal_diffusion_transformer.md)**
...
**[TreeGRPO: Tree-Advantage GRPO for Online RL Post-Training of Diffusion Models](treegrpo_tree-advantage_grpo_for_online_rl_post-training_of_diffusion_models.md)**
...
**[UniCalli: A Unified Diffusion Framework for Column-Level Generation and Recognition of Chinese Calligraphy](unicalli_a_unified_diffusion_framework_for_column-level_generation_and_recogniti.md)**
...
**[UniEdit-Flow: Unleashing Inversion and Editing in the Era of Flow Models](uniedit-flow_unleashing_inversion_and_editing_in_the_era_of_flow_models.md)**
...
**[RealUID: Supervising the Distillation of All Matching Models with Real Data (Without GAN)](universal_inverse_distillation_for_matching_models_with_real-data_supervision_no.md)**
...
**[Value Matching: Scalable and Gradient-Free Reward-Guided Flow Adaptation](value_matching_scalable_and_gradient-free_reward-guided_flow_adaptation.md)**
...
**[Variational Autoencoding Discrete Diffusion with Enhanced Dimensional Correlations Modeling](variational_autoencoding_discrete_diffusion_with_enhanced_dimensional_correlatio.md)**
...
**[ViPO: Visual Preference Optimization at Scale](vipo_visual_preference_optimization_at_scale.md)**
...
**[VisualPrompter: Semantic-Aware Prompt Optimization with Visual Feedback for Text-to-Image Synthesis](visualprompter_semantic-aware_prompt_optimization_with_visual_feedback_for_text-.md)**
...
**[VLM-Guided Adaptive Negative Prompting for Creative Generation](vlm-guided_adaptive_negative_prompting_for_creative_generation.md)**
...
**[VMDiff: Visual Mixing Diffusion for Limitless Cross-Object Synthesis](vmdiff_visual_mixing_diffusion_for_limitless_cross-object_synthesis.md)**
...
**[VSF: Simple, Efficient, and Effective Negative Guidance in Few-Step Image Generation Models By Value Sign Flip](vsf_simple_efficient_and_effective_negative_guidance_in_few-step_image_generatio.md)**
...
**[W-Edit: A Wavelet-based Frequency-aware Framework for Text-driven Image Editing](w-edit_a_wavelet-based_frequency-aware_framework_for_text-driven_image_editing.md)**
...
**[Weak-to-Strong Diffusion with Reflection](weak-to-strong_diffusion_with_reflection.md)**
...
**[WeTok: Powerful Discrete Tokenization for High-Fidelity Visual Reconstruction](wetok_powerful_discrete_tokenization_for_high-fidelity_visual_reconstruction.md)**
...
**[What Exactly Does Guidance Do in Masked Discrete Diffusion Models](what_exactly_does_guidance_do_in_masked_discrete_diffusion_models.md)**
...
**[What Matters for Representation Alignment: Global Information or Spatial Structure?](what_matters_for_representation_alignment_global_information_or_spatial_structur.md)**
...
**[Why Adversarially Train Diffusion Models?](why_adversarially_train_diffusion_models.md)**
...
**[WILD-Diffusion: A WDRO-inspired Training Method for Limited Data Diffusion Models](wild-diffusion_a_wdro_inspired_training_method_for_diffusion_models_under_limite.md)**
...
**[WithAnyone: Toward Controllable and ID Consistent Image Generation](withanyone_toward_controllable_and_id_consistent_image_generation.md)**
...
**[WorldEdit: Towards Open-World Image Editing with a Knowledge-Informed Benchmark](worldedit_towards_open-world_image_editing_with_a_knowledge-informed_benchmark.md)**
