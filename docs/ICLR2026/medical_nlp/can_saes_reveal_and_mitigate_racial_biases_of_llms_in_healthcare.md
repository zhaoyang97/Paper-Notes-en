...
description: >-
  [ICLR 2026][Medical NLP][Sparse Autoencoders] This paper investigates whether Sparse Autoencoders (SAEs) can reveal and mitigate racial biases in LLMs within clinical settings. SAEs successfully identify harmful race-ass…
tags:
  - "ICLR 2026"
  - "Medical NLP"
  - "Sparse Autoencoders"
