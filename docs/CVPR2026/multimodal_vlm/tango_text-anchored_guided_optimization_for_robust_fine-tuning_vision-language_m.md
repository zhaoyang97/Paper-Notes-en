...
description: >-
  [CVPR 2026][Multimodal VLM][Label noise] TANGO utilizes a set of "clean and immutable semantic anchors" generated by the CLIP text encoder as ground truth references independent of training labels. It replaces the noise-vulnerable parametric linear classification head with a non-parametric retrieval-based voting mechanism and employs anchors to validate and correct noisy samples. It achieves new SOTA results across six noisy benchmarks (e.g., 83.83% on CIFAR-100N…
tags:
  - "CVPR 2026"
  - "Multimodal VLM"
  - "Label noise"
