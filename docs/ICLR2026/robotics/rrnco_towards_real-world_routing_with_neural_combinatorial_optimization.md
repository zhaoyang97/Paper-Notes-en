...
description: >-
  [ICLR 2026][Robotics][Neural Combinatorial Optimization] This paper proposes the RRNCO architecture, which introduces two key innovations — Adaptive Node Embedding (ANE) and Neural Adaptive Bias (NAB) — to jointly model…
tags:
  - "ICLR 2026"
  - "Robotics"
