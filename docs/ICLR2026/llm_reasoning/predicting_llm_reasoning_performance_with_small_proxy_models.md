...
description: >-
  [ICLR 2026][LLM Reasoning][small proxy models] This paper proposes rBridge, a method that combines NLL evaluation on frontier-model reasoning traces with token-level task alignment weights…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "small proxy models"
