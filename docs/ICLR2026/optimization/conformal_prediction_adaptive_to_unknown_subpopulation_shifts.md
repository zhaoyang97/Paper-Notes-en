...
description: >-
  [ICLR 2026][Optimization][conformal prediction] To address the failure of standard conformal prediction under subpopulation shift, this paper proposes three adaptive algorithms: weighting calibration data via a learned d…
tags:
  - "ICLR 2026"
  - "Optimization"
