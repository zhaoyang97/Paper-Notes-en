---
title: >-
  ACL2026 Accepted Papers List · 1364 Notes
description: >-
  1364 ACL2026 paper notes covering LLM Safety (115), Multimodal VLM (94), LLM Evaluation (91), LLM Reasoning (80), LLM Agent (78), Information Retrieval & RAG (73), Audio & Speech (68), Multilingual & Translation (62) and other 40 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ACL2026"
...
item_list:
  ...
  - u: "llm_safety/de-anonymization_at_scale_via_tournament-style_attribution/"
...
[Browse all 115 LLM Safety papers →](llm_safety/)

---

## 📊 LLM Evaluation (91) { #llm_evaluation }
...
[Browse all 91 LLM Evaluation papers →](llm_evaluation/)

---

## 💡 LLM Reasoning (80) { #llm_reasoning }
...
[Browse all 80 LLM Reasoning papers →](llm_reasoning/)

---

## 🦾 LLM Agent (78) { #llm_agent }
...
[Browse all 78 LLM Agent papers →](llm_agent/)
...
[Browse all 58 LLM / NLP papers →](llm_nlp/)
...
## ⚖️ Alignment & RLHF (31) { #llm_alignment }
...
[Browse all 31 Alignment & RLHF papers →](llm_alignment/)
...
## 💻 Code Intelligence (51) { #code_intelligence }
...
[Browse all 51 Code Intelligence papers →](code_intelligence/)
...
## 🗣️ Dialogue Systems (26) { #dialogue }
...
[Browse all 26 Dialogue Systems papers →](dialogue/)
...
[Browse all 68 Audio & Speech papers →](audio_speech/)
...
**[Anonpsy: A Graph-Based Framework for Structure-Preserving De-identification of Psychiatric Narratives](medical_nlp/anonpsy_a_graph-based_framework_for_structure-preserving_de-identification_of_ps.md)**
...
**[Beyond Prompt: Fine-grained Simulation of Cognitively Impaired Standardized Patients via Stochastic Steering](medical_nlp/beyond_prompt_fine-grained_simulation_of_cognitively_impaired_standardized_patie.md)**
...
**[Beyond the Leaderboard: Rethinking Medical Benchmarks for Large Language Models](medical_nlp/beyond_the_leaderboard_rethinking_medical_benchmarks_for_large_language_models.md)**
...
**[Can Continual Pre-training Bridge the Performance Gap between General-purpose and Specialized Language Models in the Medical Domain?](medical_nlp/can_continual_pre-training_bridge_the_performance_gap_between_general-purpose_an.md)**
...
**[CT-FineBench: A Diagnostic Fidelity Benchmark for Fine-Grained Evaluation of CT Report Generation](medical_nlp/ct-finebench_a_diagnostic_fidelity_benchmark_for_fine-grained_evaluation_of_ct_r.md)**
...
**[CT-Flow: Orchestrating CT Interpretation Workflow with Model Context Protocol Servers](medical_nlp/ct-flow_orchestrating_ct_interpretation_workflow_with_model_context_protocol_ser.md)**
...
[Browse all 47 Medical NLP papers →](medical_nlp/)

---

## 👥 Social Computing (43) { #social_computing }
...
[Browse all 43 Social Computing papers →](social_computing/)
