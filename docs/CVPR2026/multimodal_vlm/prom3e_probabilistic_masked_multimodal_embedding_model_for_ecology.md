...
description: >-
  [CVPR 2026][Multimodal VLM][Any-to-any generation] ProM3E utilizes an "align-then-fuse" two-stage framework to train a Masked Variational Autoencoder (MVAE) within the embedding space. By inferring Gaussian distribution representations of missing modalities from a small subset of visible modalities, it supports any-to-any modality generation, modality inversion retrieval, and uncertainty analysis regarding "which modalities to fuse." It comprehensively outperforms TaxaBind on…
tags:
  - "CVPR 2026"
  - "Multimodal VLM"
  ...
  - "Modality inversion retrieval"
  - "Ecology multimodality"
date: 2026-05-08
content_hash: 317439b839ae0eb5
---
