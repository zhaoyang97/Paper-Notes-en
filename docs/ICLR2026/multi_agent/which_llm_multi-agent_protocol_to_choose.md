...
description: >-
  [ICLR 2026][Multi-Agent][Multi-Agent Protocol] This paper introduces ProtocolBench and ProtocolRouter, presenting the first systematic comparison of multi-agent communication protocols (A2A, ACP, ANP, Agora…
tags:
  - "ICLR 2026"
  - "Multi-Agent"
