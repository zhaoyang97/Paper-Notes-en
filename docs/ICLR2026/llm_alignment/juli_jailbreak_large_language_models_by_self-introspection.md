...
description: >-
  [ICLR 2026][LLM Alignment][jailbreak] This paper reveals that top-k token log probabilities returned by aligned LLM APIs still contain harmful knowledge leakage…
tags:
  - "ICLR 2026"
  - "LLM Alignment"
  - "jailbreak"
