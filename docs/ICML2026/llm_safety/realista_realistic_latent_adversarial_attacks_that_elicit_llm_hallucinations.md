...
description: >-
  [ICML 2026][LLM Safety][Hallucination induction] REALISTA constructs an "input-dependent dictionary of editing directions" in the LLM latent space to transform adversarial prompt optimization into a continuous problem un…
tags:
  - "ICML 2026"
  - "LLM Safety"
