...
description: >-
  [CVPR 2026][Autonomous Driving][multi-modal 3D detection] To address the modality imbalance problem in dual-branch multi-modal 3D detectors under domain shift, this paper proposes the CCF framework…
tags:
  - "CVPR 2026"
  - "Autonomous Driving"
