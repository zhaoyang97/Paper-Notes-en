...
description: >-
  [ACL2026][Medical Imaging][Clinical NLP] This paper addresses early HIV suspicion identification in Spanish clinical notes by proposing a dual-validation selective triage framework. It utilizes MCP to handle aleatoric un…
tags:
  - "ACL2026"
  - "Medical Imaging"
  - "Clinical NLP"
...
- [\[AAAI 2026\] Intervention Efficiency and Perturbation Validation Framework: Capacity-Aware and Robust Clinical Model Selection under the Rashomon Effect](../../AAAI2026/medical_imaging/intervention_efficiency_and_perturbation_validation_framework_capacity-aware_and.md)
