...
description: >-
  [ACL 2026][LLM Efficiency][Narrative Generation] PLOTTER shifts narrative planning from text representation to graph structure (event graph + character graph)…
tags:
  - "ACL 2026"
  - "LLM Efficiency"
