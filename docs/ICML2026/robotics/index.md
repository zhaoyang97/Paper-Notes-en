---
title: >-
  ICML2026 Robotics & Embodied AI Papers · 45 Notes
description: >-
  45 ICML2026 papers in the Robotics & Embodied AI area, covering Multimodal/VLM, Robotics, Diffusion Models, Navigation, Agents, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
...
**[Embodied Task Planning via Graph-Informed Action Generation with Large Language Models](embodied_task_planning_via_graph-informed_action_generation_with_large_language_.md)**
...
**[DiBO: Offline Black-box Optimization with Diffusion Language Models (DNA + Robot Morphology)](training_diffusion_language_models_for_black-box_optimization.md)**
