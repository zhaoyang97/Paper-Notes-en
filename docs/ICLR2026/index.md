...
description: >-
  1527 ICLR2026 paper notes covering Image Generation (149), Reinforcement Learning (139), Model Compression (90), Multimodal VLM (86), 3D Vision (63), LLM Reasoning (63), Interpretability (55), LLM Evaluation (53) and other 47 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
[Browse all 63 LLM Reasoning papers →](llm_reasoning/)

---

## 📊 LLM Evaluation (53) { #llm_evaluation }
...
[Browse all 53 LLM Evaluation papers →](llm_evaluation/)

---

## 🔒 LLM Safety (51) { #llm_safety }
...
[Browse all 51 LLM Safety papers →](llm_safety/)

---

## ⚖️ Alignment & RLHF (42) { #llm_alignment }
...
[Browse all 42 Alignment & RLHF papers →](llm_alignment/)
...
[Browse all 37 LLM / NLP papers →](llm_nlp/)

---

## 📚 Pretraining (26) { #llm_pretraining }
...
[Browse all 26 Pretraining papers →](llm_pretraining/)

---

## ⚡ LLM Efficiency (19) { #llm_efficiency }
...
[Browse all 19 LLM Efficiency papers →](llm_efficiency/)
...
## 🔍 Information Retrieval & RAG (32) { #information_retrieval }
...
[Browse all 32 Information Retrieval & RAG papers →](information_retrieval/)

---

## 💻 Code Intelligence (20) { #code_intelligence }
...
[Browse all 20 Code Intelligence papers →](code_intelligence/)
...
## ✍️ Text Generation (3) { #nlp_generation }
...
## 🎨 Image Generation (149) { #image_generation }
...
[Browse all 149 Image Generation papers →](image_generation/)

---

## 🧩 Multimodal VLM (86) { #multimodal_vlm }
...
[Browse all 86 Multimodal VLM papers →](multimodal_vlm/)

---

## 🎵 Audio & Speech (32) { #audio_speech }
...
[Browse all 32 Audio & Speech papers →](audio_speech/)

---

## 🎬 Video Generation (18) { #video_generation }
...
[Browse all 18 Video Generation papers →](video_generation/)
...
[Browse all 63 3D Vision papers →](3d_vision/)

---

## 📹 Video Understanding (21) { #video_understanding }
...
[Browse all 21 Video Understanding papers →](video_understanding/)

---

## 🖼️ Image Restoration (14) { #image_restoration }
...
[Browse all 14 Image Restoration papers →](image_restoration/)
...
## 🎯 Object Detection (9) { #object_detection }
...
## 🧑 Human Understanding (7) { #human_understanding }
...
## 🛰️ Remote Sensing (6) { #remote_sensing }
...
## 🎮 Reinforcement Learning (139) { #reinforcement_learning }
...
[Browse all 139 Reinforcement Learning papers →](reinforcement_learning/)

---

## 🤖 Robotics & Embodied AI (47) { #robotics }
...
[Browse all 47 Robotics & Embodied AI papers →](robotics/)

---

## 🚗 Autonomous Driving (18) { #autonomous_driving }
...
[Browse all 18 Autonomous Driving papers →](autonomous_driving/)

---

## 🎁 Recommender Systems (10) { #recommender }
...
## 📦 Model Compression (90) { #model_compression }
...
[Browse all 90 Model Compression papers →](model_compression/)

---

## 🔬 Interpretability (55) { #interpretability }
...
[Browse all 55 Interpretability papers →](interpretability/)
...
[Browse all 36 Time Series papers →](time_series/)

---

## 🕸️ Graph Learning (21) { #graph_learning }
...
[Browse all 21 Graph Learning papers →](graph_learning/)

---

## 🔗 Causal Inference (16) { #causal_inference }
...
[Browse all 16 Causal Inference papers →](causal_inference/)

---

## 🔄 Self-Supervised Learning (14) { #self_supervised }
...
[Browse all 14 Self-Supervised Learning papers →](self_supervised/)

---

## 📐 Learning Theory (4) { #learning_theory }
...
## 🏥 Medical Imaging (48) { #medical_imaging }
...
[Browse all 48 Medical Imaging papers →](medical_imaging/)
...
## 🧬 Computational Biology (24) { #computational_biology }
...
[Browse all 24 Computational Biology papers →](computational_biology/)

---

## ⚛️ Physics & Scientific Computing (12) { #physics }
...
[Browse all 12 Physics & Scientific Computing papers →](physics/)

---

## 👥 Social Computing (10) { #social_computing }
...
[Browse all 62 Others papers →](others/)
