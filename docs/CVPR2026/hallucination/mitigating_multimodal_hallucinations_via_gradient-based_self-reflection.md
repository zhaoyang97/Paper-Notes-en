...
description: >-
  [CVPR2026][Hallucination Detection][Multimodal hallucination] This paper proposes GACD (Gradient-based Influence-Aware Constrained Decoding), which employs first-order Taylor gradient estimation to quantify each token's…
tags:
  - "CVPR2026"
