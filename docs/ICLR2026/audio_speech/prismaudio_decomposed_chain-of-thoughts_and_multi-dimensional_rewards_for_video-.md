...
description: >-
  [ICLR 2026][Audio & Speech][Video-to-Audio] This work is the first to integrate decomposed Chain-of-Thought reasoning with multi-dimensional reinforcement learning (RL) for video-to-audio (V2A) generation. It addresses t…
tags:
  - "ICLR 2026"
  - "Audio & Speech"
  - "Video-to-Audio"
