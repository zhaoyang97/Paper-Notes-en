...
description: >-
  [ICML 2026][Domain Incremental Learning] Inspired by the physical intuition of Helmholtz free energy, each domain's prompt parameters are trained to form an "energy curve compressed to boundary $\Theta$ and aligned to mi…
tags:
  - "ICML 2026"
