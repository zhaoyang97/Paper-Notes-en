...
description: >-
  [ACL 2026][LLM Safety][AVES-DPO] The AVES-DPO framework is proposed: utilizing consistency-based multi-model verification (YOLO/GroundingDINO/Qwen3-VL) to detect fine-grained hallucinations in an LVLM's own responses acr…
tags:
  - "ACL 2026"
  - "LLM Safety"
  - "AVES-DPO"
