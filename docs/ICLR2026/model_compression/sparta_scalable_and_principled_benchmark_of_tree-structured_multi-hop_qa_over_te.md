...
description: >-
  [ICLR 2026][Model Compression][Multi-hop Reasoning] This paper presents SPARTA, an end-to-end framework for automatically constructing large-scale table-text multi-hop QA benchmarks. By leveraging a reference fact databa…
tags:
  - "ICLR 2026"
  - "Model Compression"
  - "Multi-hop Reasoning"
