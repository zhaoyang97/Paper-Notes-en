...
description: >-
  [ICLR 2026][Hallucination Detection][noise injection] Injecting uniform noise into MLP activations of intermediate LLM layers to approximate the Bayesian posterior…
tags:
  - "ICLR 2026"
