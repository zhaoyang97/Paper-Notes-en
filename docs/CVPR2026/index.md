...
description: >-
  1643 CVPR2026 paper notes covering 3D Vision (239), Image Generation (220), Multimodal VLM (210), Medical Imaging (99), Autonomous Driving (90), Segmentation (83), Video Understanding (83), Video Generation (66) and other 43 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2026"
...
[Browse all 15 LLM Agent papers →](llm_agent/)

---

## 💡 LLM Reasoning (8) { #llm_reasoning }
...
## ⚖️ Alignment & RLHF (2) { #llm_alignment }
...
## 🎨 Image Generation (220) { #image_generation }
...
**[[Paper Insight] Agentic Retoucher for Text-To-Image Generation](image_generation/agentic_retoucher_for_texttoimage_generation.md)**
...
[Browse all 220 Image Generation papers →](image_generation/)

---

## 🧩 Multimodal VLM (210) { #multimodal_vlm }
...
[Browse all 210 Multimodal VLM papers →](multimodal_vlm/)

---

## 🎬 Video Generation (66) { #video_generation }
...
**[Composing Concepts from Images and Videos via Concept-prompt Binding](video_generation/composing_concepts_from_images_and_videos_via_concept-prompt_binding.md)**
...
[Browse all 66 Video Generation papers →](video_generation/)

---

## 🎵 Audio & Speech (14) { #audio_speech }
...
[Browse all 14 Audio & Speech papers →](audio_speech/)
...
[Browse all 239 3D Vision papers →](3d_vision/)
...
## 📹 Video Understanding (83) { #video_understanding }
...
[Browse all 83 Video Understanding papers →](video_understanding/)

---

## 🧑 Human Understanding (63) { #human_understanding }
...
[Browse all 63 Human Understanding papers →](human_understanding/)
...
[Browse all 55 Object Detection papers →](object_detection/)

---

## 🖼️ Image Restoration (41) { #image_restoration }
...
[Browse all 41 Image Restoration papers →](image_restoration/)

---

## 🛰️ Remote Sensing (16) { #remote_sensing }
...
[Browse all 16 Remote Sensing papers →](remote_sensing/)

---

## 🚗 Autonomous Driving (90) { #autonomous_driving }
...
[Browse all 90 Autonomous Driving papers →](autonomous_driving/)

---

## 🤖 Robotics & Embodied AI (42) { #robotics }
...
[Browse all 42 Robotics & Embodied AI papers →](robotics/)

---

## 🎮 Reinforcement Learning (11) { #reinforcement_learning }
...
[Browse all 11 Reinforcement Learning papers →](reinforcement_learning/)

---

## 📦 Model Compression (54) { #model_compression }
...
[Browse all 54 Model Compression papers →](model_compression/)

---

## 🔄 Self-Supervised Learning (34) { #self_supervised }
...
**[Free-Grained Hierarchical Visual Recognition](self_supervised/free-grained_hierarchical_visual_recognition.md)**
...
[Browse all 34 Self-Supervised Learning papers →](self_supervised/)

---

## 🔬 Interpretability (25) { #interpretability }
...
[Browse all 25 Interpretability papers →](interpretability/)

---

## 📐 Optimization & Theory (17) { #optimization }
...
[Browse all 17 Optimization & Theory papers →](optimization/)
...
## 🏥 Medical Imaging (99) { #medical_imaging }
...
[Browse all 99 Medical Imaging papers →](medical_imaging/)
...
**[Enhancing Out-of-Distribution Detection with Extended Logit Normalization](ai_safety/enhancing_out-of-distribution_detection_with_extended_logit_normalization.md)**
...
## 🧬 Computational Biology (11) { #computational_biology }
...
[Browse all 11 Computational Biology papers →](computational_biology/)

---

## ⚛️ Physics & Scientific Computing (7) { #physics }
...
[Browse all 22 Others papers →](others/)
