---
title: >-
  ICLR2026 Causal Inference Papers · 64 Notes
description: >-
  64 ICLR2026 papers in the Causal Inference area, covering Adversarial Robustness, LLM, Time-Series Forecasting, Reasoning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Causal Inference"
  - "AI paper notes"
...
item_list:
  ...
  - u: "causal_score_conditioning_for_multi-resolution_latent_systems/"
    t: "Causal Score Conditioning for Multi-Resolution Latent Systems"
  - u: "causal_structure_learning_in_hawkes_processes_with_complex_latent_confounder_net/"
    t: "Causal Structure Learning in Hawkes Processes with Complex Latent Confounder Networks"
  ...
  - u: "conditional_independent_component_analysis_for_estimating_causal_structure_with_/"
    t: "Conditional Independent Component Analysis for Estimating Causal Structure with Latent Variables"
  - u: "conformalized_survival_counterfactuals_prediction_for_general_right-censored_dat/"
  ...
  - u: "debiased_front-door_learners_for_heterogeneous_effects/"
    t: "Debiased Front-Door Learners for Heterogeneous Effects"
  - u: "designing_time_series_experiments_in_ab_testing_with_transformer_reinforcement_l/"
    t: "Designing Time Series Experiments in A/B Testing with Transformer Reinforcement Learning"
  ...
  - u: "efficient_and_sharp_off-policy_learning_under_unobserved_confounding/"
    t: "Efficient and Sharp Off-Policy Learning under Unobserved Confounding"
  ...
  - u: "exploratory_causal_inference_in_saence/"
    t: "Exploratory Causal Inference in SAEnce"
  ...
  - u: "foundation_models_for_causal_inference_via_prior-data_fitted_networks/"
...
**[Causal Score Conditioning for Multi-Resolution Latent Systems](causal_score_conditioning_for_multi-resolution_latent_systems.md)**
...
**[Causal Structure Learning in Hawkes Processes with Complex Latent Confounder Networks](causal_structure_learning_in_hawkes_processes_with_complex_latent_confounder_net.md)**
...
**[Conditional Independent Component Analysis for Estimating Causal Structure with Latent Variables](conditional_independent_component_analysis_for_estimating_causal_structure_with_.md)**
...
**[Conformalized Survival Counterfactuals Prediction for General Right-Censored Data](conformalized_survival_counterfactuals_prediction_for_general_right-censored_dat.md)**
...
**[Debiased Front-Door Learners for Heterogeneous Effects](debiased_front-door_learners_for_heterogeneous_effects.md)**
...
**[Designing Time Series Experiments in A/B Testing with Transformer Reinforcement Learning](designing_time_series_experiments_in_ab_testing_with_transformer_reinforcement_l.md)**
...
**[Efficient and Sharp Off-Policy Learning under Unobserved Confounding](efficient_and_sharp_off-policy_learning_under_unobserved_confounding.md)**
...
**[Exploratory Causal Inference in SAEnce](exploratory_causal_inference_in_saence.md)**
...
**[Foundation Models for Causal Inference via Prior-Data Fitted Networks](foundation_models_for_causal_inference_via_prior-data_fitted_networks.md)**
...
**[Frequency-Domain Better than Time-Domain for Causal Structure Recovery in Dynamical Systems on Networks](frequency-domain_better_than_time-domain_for_causal_structure_recovery_in_dynami.md)**
...
**[GDR-learners: Orthogonal Learning of Generative Models for Potential Outcomes](gdr-learners_orthogonal_learning_of_generative_models_for_potential_outcomes.md)**
...
**[Good Allocations from Bad Estimates](good_allocations_from_bad_estimates.md)**
...
**[Ice Cream Doesn't Cause Drowning: Benchmarking LLMs Against Statistical Pitfalls in Causal Inference](ice_cream_doesnt_cause_drowning_benchmarking_llms_against_statistical_pitfalls_i.md)**
...
**[IGC-Net for Conditional Average Potential Outcome Estimation Over Time](igc-net_for_conditional_average_potential_outcome_estimation_over_time.md)**
...
**[Learning Dynamic Causal Graphs Under Parametric Uncertainty via Polynomial Chaos Expansions](learning_dynamic_causal_graphs_under_parametric_uncertainty_via_polynomial_chaos.md)**
...
**[Learning Exposure Mapping Functions for Inferring Heterogeneous Peer Effects](learning_exposure_mapping_functions_for_inferring_heterogeneous_peer_effects.md)**
...
**[LLMs Struggle to Balance Reasoning and World Knowledge in Causal Narrative Understanding](llms_struggle_to_balance_reasoning_and_world_knowledge_in_causal_narrative_under.md)**
...
**[Matching without Group Barrier for Heterogeneous Treatment Effect Estimation](matching_without_group_barrier_for_heterogeneous_treatment_effect_estimation.md)**
...
**[Meta-Router: Bridging Gold-standard and Preference-based Evaluations in LLM Routing](meta-router_bridging_gold-standard_and_preference-based_evaluations_in_llm_routi.md)**
...
**[Modeling Interference for Treatment Effect Estimation in Network Dynamic Environment](modeling_interference_for_treatment_effect_estimation_in_network_dynamic_environ.md)**
...
**[Multiverse Mechanica: A Testbed for Learning Game Mechanics via Counterfactual Worlds](multiverse_mechanica_a_testbed_for_learning_game_mechanics_via_counterfactual_wo.md)**
...
**[NextQuill: Causal Preference Modeling for Enhancing LLM Personalization](nextquill_causal_preference_modeling_for_enhancing_llm_personalization.md)**
...
**[On Measuring Influence in Avoiding Undesired Future](on_measuring_influence_in_avoiding_undesired_future.md)**
...
**[Overlap-Weighted Orthogonal Meta-Learner for Treatment Effect Estimation over Time](overlap-weighted_orthogonal_meta-learner_for_treatment_effect_estimation_over_ti.md)**
...
**[Privacy-Protected Causal Survival Analysis Under Distribution Shift](privacy-protected_causal_survival_analysis_under_distribution_shift.md)**
...
**[Query-Specific Causal Graph Pruning under Tiered Knowledge](query-specific_causal_graph_pruning_under_tiered_knowledge.md)**
...
**[Stochastic Neural Networks for Causal Inference with Missing Confounders](stochastic_neural_networks_for_causal_inference_with_missing_confounders.md)**
...
**[Topological Causal Effects](topological_causal_effects.md)**
