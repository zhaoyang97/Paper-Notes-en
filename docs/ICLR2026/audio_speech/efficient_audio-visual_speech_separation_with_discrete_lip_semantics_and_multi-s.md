...
description: >-
  [ICLR 2026][Audio & Speech][audio-visual speech separation] This paper proposes Dolphin, a model that maps lip movements to discrete semantic tokens via a dual-path lightweight video encoder (DP-LipCoder)…
tags:
  - "ICLR 2026"
  - "Audio & Speech"
