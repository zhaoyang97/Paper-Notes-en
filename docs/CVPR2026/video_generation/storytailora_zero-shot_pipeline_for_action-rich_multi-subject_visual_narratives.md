...
description: >-
  [CVPR 2026][Video Generation][Visual Storytelling] Proposes StoryTailor, a zero-shot visual narrative generation pipeline that uses Gaussian-Centered Attention (GCA) to mitigate subject overlap and background leakage…
tags:
  - "CVPR 2026"
  - "Video Generation"
  - "Visual Storytelling"
