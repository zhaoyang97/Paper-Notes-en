...
description: >-
  [CVPR 2026][AI Safety][unified multimodal model] UniGame proposes the first self-adversarial post-training framework for unified multimodal models (UMMs). By attaching a lightweight perturber at the shared visual token i…
tags:
  - "CVPR 2026"
  - "AI Safety"
