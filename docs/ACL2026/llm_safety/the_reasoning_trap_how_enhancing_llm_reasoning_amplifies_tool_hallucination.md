...
description: >-
  [ACL 2026][LLM Safety][Tool Hallucination] Systematically reveals the "Reasoning Trap" paradox: enhancing LLM reasoning capabilities (whether via RL, distillation…
tags:
  - "ACL 2026"
  - "LLM Safety"
  - "Tool Hallucination"
