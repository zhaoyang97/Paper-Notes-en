---
title: >-
  ICCV2025 Video Understanding Papers · 56 Notes
description: >-
  56 ICCV2025 papers in the Video Understanding area, covering Object Tracking, LLM, Human Pose, Model Compression, Few-/Zero-Shot Learning, Compression and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICCV2025"
  - "Video Understanding"
  - "AI paper notes"
  ...
  - "Compression"
item_list:
  - u: "4d_bench_benchmarking_multimodal_llms_for_4d_object_understanding/"
    t: "4D-Bench: Benchmarking Multi-modal Large Language Models for 4D Object Understanding"
  - u: "4dbench_benchmarking_multimodal_large_language_models_for_4d/"
    t: "4D-Bench: Benchmarking Multi-modal Large Language Models for 4D Object Understanding"
  - u: "adaptive_hyper-graph_convolution_network_for_skeleton-based_human_action_recogni/"
    t: "Adaptive Hyper-Graph Convolution Network for Skeleton-Based Human Action Recognition"
  - u: "adaptive_hyper_graph_convolution_network_skeleton_action_recognition/"
    t: "Adaptive Hyper-Graph Convolution Network for Skeleton-based Human Action Recognition with Virtual Connections"
  - u: "aim_adaptive_inference_multimodal_llms_token_merging_pruning/"
    t: "AIM: Adaptive Inference of Multi-Modal LLMs via Token Merging and Pruning"
  - u: "aim_adaptive_inference_of_multi-modal_llms_via_token_merging_and_pruning/"
    t: "AIM: Adaptive Inference of Multi-Modal LLMs via Token Merging and Pruning"
  - u: "aligning_effective_tokens_with_video_anomaly_in_large_language_models/"
    t: "Aligning Effective Tokens with Video Anomaly in Large Language Models"
  - u: "alltracker_efficient_dense_point_tracking_at_high_resolution/"
    t: "AllTracker: Efficient Dense Point Tracking at High Resolution"
  - u: "an_empirical_study_of_autoregressive_pre-training_from_videos/"
    t: "An Empirical Study of Autoregressive Pre-training from Videos"
  - u: "attention_to_trajectory_trajectory-aware_open-vocabulary_tracking/"
    t: "Attention to Trajectory: Trajectory-Aware Open-Vocabulary Tracking"
  - u: "beyond_label_semantics_language-guided_action_anatomy_for_few-shot_action_recogn/"
    t: "Beyond Label Semantics: Language-Guided Action Anatomy for Few-shot Action Recognition"
  - u: "beyond_the_frame_generating_360deg_panoramic_videos_from_perspective_videos/"
    t: "Beyond the Frame: Generating 360° Panoramic Videos from Perspective Videos"
  - u: "blinktrack_feature_tracking_over_80_fps_via_events_and_images/"
    t: "BlinkTrack: Feature Tracking over 80 FPS via Events and Images"
  - u: "breaking_the_encoder_barrier_for_seamless_video-language_understanding/"
    t: "Breaking the Encoder Barrier for Seamless Video-Language Understanding"
  - u: "despite_exploring_contrastive_deep_skeleton-pointcloud-imu-text_embeddings_for_a/"
    t: "DeSPITE: Exploring Contrastive Deep Skeleton-PointCloud-IMU-Text Embeddings for Action Recognition"
  - u: "distime_distribution-based_time_representation_for_video_large_language_models/"
    t: "DisTime: Distribution-based Time Representation for Video Large Language Models"
  - u: "dynimg_key_frames_with_visual_prompts_are_good_representation_for_multi-modal_vi/"
    t: "DynImg: Key Frames with Visual Prompts are Good Representation for Multi-Modal Video Understanding"
  - u: "egoadapt_adaptive_multisensory_distillation_and_policy_learning_for_efficient_eg/"
    t: "EgoAdapt: Adaptive Multisensory Distillation and Policy Learning for Efficient Egocentric Perception"
  - u: "egoppg_heart_rate_estimation_from_eye-tracking_cameras_in_egocentric_systems_to_/"
    t: "egoPPG: Heart Rate Estimation from Eye-Tracking Cameras in Egocentric Systems to Benefit Downstream Vision Tasks"
  - u: "emotive_event-guided_trajectory_modeling_for_3d_motion_estimation/"
    t: "EMoTive: Event-Guided Trajectory Modeling for 3D Motion Estimation"
  - u: "factorized_learning_for_temporally_grounded_video-language_models/"
    t: "Factorized Learning for Temporally Grounded Video-Language Models"
  - u: "fine-grained_spatiotemporal_grounding_on_egocentric_videos/"
    t: "Fine-grained Spatiotemporal Grounding on Egocentric Videos"
  - u: "flow4agent_long-form_video_understanding_via_motion_prior_from_optical_flow/"
    t: "Flow4Agent: Long-form Video Understanding via Motion Prior from Optical Flow"
  - u: "flowseek_optical_flow_made_easier_with_depth_foundation_models_and_motion_bases/"
    t: "FlowSeek: Optical Flow Made Easier with Depth Foundation Models and Motion Bases"
  - u: "frequency-semantic_enhanced_variational_autoencoder_for_zero-shot_skeleton-based/"
    t: "Frequency-Semantic Enhanced Variational Autoencoder for Zero-Shot Skeleton-based Action Recognition"
  - u: "general_compression_framework_for_efficient_transformer_object_tracking/"
    t: "General Compression Framework for Efficient Transformer Object Tracking"
  - u: "hermes_temporal-coherent_long-form_understanding_with_episodes_and_semantics/"
    t: "HERMES: temporal-coHERent long-forM understanding with Episodes and Semantics"
  - u: "hierarchical_event_memory_for_accurate_and_low-latency_online_video_temporal_gro/"
    t: "Hierarchical Event Memory for Accurate and Low-latency Online Video Temporal Grounding"
  - u: "learning_to_generalize_without_bias_for_open-vocabulary_action_recognition/"
    t: "Learning to Generalize Without Bias for Open-Vocabulary Action Recognition"
  - u: "memfof_high-resolution_training_for_memory-efficient_multi-frame_optical_flow_es/"
    t: "MEMFOF: High-Resolution Training for Memory-Efficient Multi-Frame Optical Flow Estimation"
item_total: 56
---
...
**📹 ICCV2025** · **56** paper notes

📌 **Same area in other venues:** [📷 CVPR2026 (178)](../../CVPR2026/video_understanding/index.md) · [🧪 ICML2026 (17)](../../ICML2026/video_understanding/index.md) · [🔬 ICLR2026 (10)](../../ICLR2026/video_understanding/index.md) · [🤖 AAAI2026 (27)](../../AAAI2026/video_understanding/index.md) · [🧠 NeurIPS2025 (39)](../../NeurIPS2025/video_understanding/index.md)

🔥 **Top topics:** Object Tracking ×9 · LLM ×5 · Human Pose ×5 · Model Compression ×3 · Few-/Zero-Shot Learning ×3
