...
description: >-
  [ICLR 2026][Video Generation][Subject-to-Video] BindWeave replaces conventional shallow fusion mechanisms with a Multimodal Large Language Model (MLLM) to parse complex multi-subject textual instructions…
tags:
  - "ICLR 2026"
  - "Video Generation"
  - "Subject-to-Video"
