...
**State of the Field**: VLMs such as Qwen2.5-VL, Gemini, and LLaMA-3 have achieved strong performance on tasks including document parsing, key information extraction, and document VQA. Nevertheless, inference over high-resolution document images remains computationally expensive. A single A4 scanned document at 300 DPI measures 2481×3507 pixels, producing a large number of visual tokens after ViT patch splitting, all of which are fed into the LLM decoder and cause severe computational redundancy.
