...
description: >-
  [ICLR 2026][Multi-Agent][multi-agent systems] This paper proposes SelfOrg, a framework that dynamically constructs directed acyclic communication graphs (DAGs) based on semantic similarity of agent responses and Shapley…
tags:
  - "ICLR 2026"
  - "Multi-Agent"
  - "multi-agent systems"
