...
description: >-
  [ICML 2026][LLM Reasoning][dense reasoning] It is observed that stronger models use fewer CoT steps but have higher information density per step (Dense Reasoning). DenseSteer uses GPT-5.1 to rewrite the sparse solutions generated by the small language model (SLM) itself into "information-dense" in-distribution positive samples. These form contrastive pairs with
tags:
  - ICML 2026
  - LLM Reasoning
  - dense reasoning
