---
title: >-
  NeurIPS2025 3D Vision Papers · 112 Notes
description: >-
  112 NeurIPS2025 papers in the 3D Vision area, covering 3D Gaussian Splatting, Diffusion Models, Dynamic Scenes, Novel View Synthesis, 3D Reconstruction, Point Cloud and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "NeurIPS2025"
  - "3D Vision"
  - "AI paper notes"
...
item_list:
  ...
  - u: "fin3r_fine-tuning_feed-forward_3d_reconstruction_models_via_monocular_knowledge_/"
    t: "Fin3R: Fine-tuning Feed-forward 3D Reconstruction Models via Monocular Knowledge Distillation"
  ...
  - u: "from_pixels_to_views_learning_angular-aware_and_physics-consistent_representatio/"
    t: "From Pixels to Views: Learning Angular-Aware and Physics-Consistent Representations for Light Field Microscopy"
  - u: "from_programs_to_poses_factored_real-world_scene_generation_via_learned_program_/"
    t: "From Programs to Poses: Factored Real-World Scene Generation via Learned Program Libraries"
item_total: 112
---
...
📌 **Same area in other venues:** [🧪 ICML2026 (27)](../../ICML2026/3d_vision/index.md) · [💬 ACL2026 (1)](../../ACL2026/3d_vision/index.md) · [📷 CVPR2026 (230)](../../CVPR2026/3d_vision/index.md) · [🔬 ICLR2026 (63)](../../ICLR2026/3d_vision/index.md) · [🤖 AAAI2026 (76)](../../AAAI2026/3d_vision/index.md) · [📹 ICCV2025 (264)](../../ICCV2025/3d_vision/index.md)
...
**[From Pixels to Views: Learning Angular-Aware and Physics-Consistent Representations for Light Field Microscopy](from_pixels_to_views_learning_angular-aware_and_physics-consistent_representatio.md)**
...
**[LinPrim: Linear Primitives for Differentiable Volumetric Rendering](linprim_linear_primitives_for_differentiable_volumetric_rendering.md)**
...
**[Reconstructing the Local Density Field with Combined Convolutional and Point Cloud Architecture](reconstructing_the_local_density_field_with_combined_convolutional_and_point_clo.md)**
...
**[VisualSync: Multi-Camera Synchronization via Cross-View Object Motion](visual_sync_multi-camera_synchronization_via_cross-view_object_motion.md)**
...
**[Walking the Schrödinger Bridge: A Direct Trajectory for Text-to-3D Generation](walking_the_schrödinger_bridge_a_direct_trajectory_for_text-to-3d_generation.md)**
