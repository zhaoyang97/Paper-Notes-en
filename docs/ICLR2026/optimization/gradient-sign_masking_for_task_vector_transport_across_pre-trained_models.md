...
description: >-
  [ICLR 2026][Optimization][task vector] This paper proposes GradFix, a method that constructs a binary mask from gradient signs computed on a minimal number of samples from the target pre-trained model…
tags:
  - "ICLR 2026"
  - "Optimization"
  - "task vector"
