...
description: >-
  [ACL 2026][LLM Safety][TDA] TOHA treats the LLM attention matrix as a weighted graph and utilizes Manifold Topology Divergence from Topological Data Analysis (TDA) to measure the "topological novelty of the response subg…
tags:
  - "ACL 2026"
  - "LLM Safety"
  - "TDA"
...
**Area**: Information Retrieval / RAG / Hallucination Detection  
