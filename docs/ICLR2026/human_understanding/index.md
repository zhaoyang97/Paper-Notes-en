---
title: >-
  ICLR2026 Human Understanding Papers · 45 Notes
description: >-
  45 ICLR2026 papers in the Human Understanding area, covering Human Pose, Multimodal/VLM, Diffusion Models, LLM and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Human Understanding"
  - "AI paper notes"
...
item_list:
  ...
  - u: "banz-fs_banzsl_fingerspelling_dataset/"
    t: "BANZ-FS: BANZSL Fingerspelling Dataset"
  ...
  - u: "curvature-guided_task_synergy_for_skeleton_based_temporal_action_segmentation/"
    t: "Curvature-Guided Task Synergy for Skeleton based Temporal Action Segmentation"
  - u: "densemarks_learning_canonical_embeddings_for_human_heads_images_via_point_tracks/"
    t: "DenseMarks: Learning Canonical Embeddings for Head Images via Point Trajectories"
  - u: "disentangled_hierarchical_vae_for_3d_human-human_interaction_generation/"
    t: "Disentangled Hierarchical VAE for 3D Human-Human Interaction Generation"
  - u: "easytune_efficient_step-aware_fine-tuning_for_diffusion-based_motion_generation/"
    t: "EasyTune: Efficient Step-Aware Fine-Tuning for Diffusion-Based Motion Generation"
  - u: "edgecape_edge_weight_prediction_for_category-agnostic_pose_estimation/"
    t: "EdgeCAPE: Edge Weight Prediction for Category-Agnostic Pose Estimation"
  - u: "embridge_enhancing_gesture_generalization_from_emg_signals_through_cross-modal_r/"
    t: "EMBridge: Enhancing Gesture Generalization from EMG Signals Through Cross-modal Representation Learning"
  - u: "emoprefer_can_large_language_models_understand_human_emotion_preferences/"
    t: "EmoPrefer: Can Large Language Models Understand Human Emotion Preferences?"
  ...
  - u: "from_pixels_to_semantics_unified_facial_action_representation_learning_for_micro/"
    t: "From Pixels to Semantics: Unified Facial Action Representation Learning for Micro-Expression Analysis"
  - u: "from_sparse_to_dense_spatio-temporal_fusion_for_multi-view_3d_human_pose_estimat/"
  ...
  - u: "humof_human_motion_forecasting_in_interactive_social_scenes/"
    t: "HUMOF: Human Motion Forecasting in Interactive Social Scenes"
  - u: "inclusivevidpose_bridging_the_pose_estimation_gap_for_individuals_with_limb_defi/"
    t: "InclusiveVidPose: Bridging the Pose Estimation Gap for Individuals with Limb Deficiencies in Videos"
  - u: "infbagel_human-object-scene_interaction_generation_with_dynamic_perception_and_i/"
    t: "InfBaGel: Human-Object-Scene Interaction Generation with Dynamic Perception and Iterative Refinement"
  - u: "instilling_an_active_mind_in_avatars_via_cognitive_simulation/"
    t: "Instilling an Active Mind in Avatars via Cognitive Simulation"
  - u: "interaction-aware_representation_modeling_with_co-occurrence_consistency_for_ego/"
    t: "Interaction-aware Representation Modeling With Co-Occurrence Consistency for Egocentric Hand-Object Parsing"
  ...
  - u: "kinemadiff_towards_diffusion_for_coherent_and_physically_plausible_human_motion_/"
    t: "KinemaDiff: Towards Diffusion for Coherent and Physically Plausible Human Motion Prediction"
  - u: "link_learning_instance-level_knowledge_from_vision-language_models_for_human-obj/"
    t: "LINK: Learning Instance-level Knowledge from Vision-Language Models for Human-Object Interaction Detection"
  - u: "motion-aligned_word_embeddings_for_text-to-motion_generation/"
    t: "Motion-Aligned Word Embeddings for Text-to-Motion Generation"
  - u: "motion-r1_enhancing_motion_generation_with_decomposed_chain-of-thought_and_rl_bi/"
    t: "Motion-R1: Enhancing Motion Generation with Decomposed Chain-of-Thought and RL Binding"
  - u: "motiongpt3_human_motion_as_a_second_modality/"
    t: "MotionGPT3: Human Motion as a Second Modality"
...
**[BANZ-FS: BANZSL Fingerspelling Dataset](banz-fs_banzsl_fingerspelling_dataset.md)**
...
**[Curvature-Guided Task Synergy for Skeleton based Temporal Action Segmentation](curvature-guided_task_synergy_for_skeleton_based_temporal_action_segmentation.md)**
...
**[DenseMarks: Learning Canonical Embeddings for Head Images via Point Trajectories](densemarks_learning_canonical_embeddings_for_human_heads_images_via_point_tracks.md)**
...
**[Disentangled Hierarchical VAE for 3D Human-Human Interaction Generation](disentangled_hierarchical_vae_for_3d_human-human_interaction_generation.md)**
...
**[EasyTune: Efficient Step-Aware Fine-Tuning for Diffusion-Based Motion Generation](easytune_efficient_step-aware_fine-tuning_for_diffusion-based_motion_generation.md)**
...
**[EdgeCAPE: Edge Weight Prediction for Category-Agnostic Pose Estimation](edgecape_edge_weight_prediction_for_category-agnostic_pose_estimation.md)**
...
**[EMBridge: Enhancing Gesture Generalization from EMG Signals Through Cross-modal Representation Learning](embridge_enhancing_gesture_generalization_from_emg_signals_through_cross-modal_r.md)**
...
**[EmoPrefer: Can Large Language Models Understand Human Emotion Preferences?](emoprefer_can_large_language_models_understand_human_emotion_preferences.md)**
...
**[From Pixels to Semantics: Unified Facial Action Representation Learning for Micro-Expression Analysis](from_pixels_to_semantics_unified_facial_action_representation_learning_for_micro.md)**
...
**[From Sparse to Dense: Spatio-Temporal Fusion for Multi-View 3D Human Pose Estimation with DenseWarper](from_sparse_to_dense_spatio-temporal_fusion_for_multi-view_3d_human_pose_estimat.md)**
...
**[HUMOF: Human Motion Forecasting in Interactive Social Scenes](humof_human_motion_forecasting_in_interactive_social_scenes.md)**
...
**[InclusiveVidPose: Bridging the Pose Estimation Gap for Individuals with Limb Deficiencies in Videos](inclusivevidpose_bridging_the_pose_estimation_gap_for_individuals_with_limb_defi.md)**
...
**[InfBaGel: Human-Object-Scene Interaction Generation with Dynamic Perception and Iterative Refinement](infbagel_human-object-scene_interaction_generation_with_dynamic_perception_and_i.md)**
...
**[Instilling an Active Mind in Avatars via Cognitive Simulation](instilling_an_active_mind_in_avatars_via_cognitive_simulation.md)**
...
**[Interaction-aware Representation Modeling With Co-Occurrence Consistency for Egocentric Hand-Object Parsing](interaction-aware_representation_modeling_with_co-occurrence_consistency_for_ego.md)**
...
**[KinemaDiff: Towards Diffusion for Coherent and Physically Plausible Human Motion Prediction](kinemadiff_towards_diffusion_for_coherent_and_physically_plausible_human_motion_.md)**
...
**[LINK: Learning Instance-level Knowledge from Vision-Language Models for Human-Object Interaction Detection](link_learning_instance-level_knowledge_from_vision-language_models_for_human-obj.md)**
...
**[Motion-Aligned Word Embeddings for Text-to-Motion Generation](motion-aligned_word_embeddings_for_text-to-motion_generation.md)**
...
**[Motion-R1: Enhancing Motion Generation with Decomposed Chain-of-Thought and RL Binding](motion-r1_enhancing_motion_generation_with_decomposed_chain-of-thought_and_rl_bi.md)**
...
**[MotionGPT3: Human Motion as a Second Modality](motiongpt3_human_motion_as_a_second_modality.md)**
...
**[Pose-RFT: Aligning MLLMs for 3D Pose Generation via Hybrid Action Reinforcement Fine-Tuning](pose-rft_aligning_mllms_for_3d_pose_generation_via_hybrid_action_reinforcement_f.md)**
...
**[Pose Prior Learner: Unsupervised Categorical Prior Learning for Pose Estimation](pose_prior_learner_unsupervised_categorical_prior_learning_for_pose_estimation.md)**
...
**[PulpMotion: Framing-Aware Multimodal Camera and Human Motion Generation](pulp_motion_framing-aware_multimodal_camera_and_human_motion_generation.md)**
...
**[ReactDance: Hierarchical Representation for High-Fidelity and Coherent Long-Form Reactive Dance Generation](reactdance_hierarchical_representation_for_high-fidelity_and_coherent_long-form_.md)**
...
**[Sapiens2: High-Resolution Foundation Models for Human-Centric Vision](sapiens2.md)**
...
**[SesaHand: Enhancing 3D Hand Reconstruction via Controllable Generation with Semantic and Structural Alignment](sesahand_enhancing_3d_hand_reconstruction_via_controllable_generation_with_seman.md)**
...
**[TriC-Motion: Tri-domain Causal Modeling for Text-to-Action Generation](tric-motion_tri-domain_causal_modeling_grounded_text-to-motion_generation.md)**
...
**[Zero-Shot Human Pose Estimation Using Diffusion-Based Inverse Solvers](zero-shot_human_pose_estimation_using_diffusion-based_inverse_solvers.md)**
