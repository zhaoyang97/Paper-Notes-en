...
description: >-
  [ICML2026 Spotlight][Information Retrieval & RAG][tournament graphs] Ours proposes BlitzRank, a zero-shot reranking framework based on tournament graphs. By accumulating $\binom{k}{2}$ preference pairs generated by each $k$-wise comparison into a global preference graph and utilizing transitive closure to infer additional ranking relations, it achieves Pareto optimality across 14 benchmarks and 5 LLM oracles—reducing token consumption by 25–40% while matching or exceeding the…
tags:
  - "ICML2026 Spotlight"
