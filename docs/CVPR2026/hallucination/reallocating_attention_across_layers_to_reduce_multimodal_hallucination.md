...
description: >-
  [CVPR 2026][Hallucination Detection][multimodal hallucination] A lightweight, training-free plugin method is proposed to mitigate hallucination in Multimodal Large Reasoning Models (MLRMs) by identifying perceptual and r…
tags:
  - "CVPR 2026"
