...
description: >-
  [ICML 2026][Image Generation][AIGI detection] This paper addresses the issue of "catastrophic forgetting of transferable priors when fine-tuning CLIP for AI-generated image detection" by proposing DGS-Net: the gradient o…
tags:
  - "ICML 2026"
  - "Image Generation"
  - "AIGI detection"
