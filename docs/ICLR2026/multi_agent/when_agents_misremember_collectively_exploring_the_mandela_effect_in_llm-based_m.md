...
description: >-
  [ICLR 2026][Multi-Agent][Mandela effect] This paper presents the first systematic study of the Mandela effect (collective false memory) in LLM-based multi-agent systems. It introduces the ManBench benchmark (4…
tags:
  - "ICLR 2026"
  - "Multi-Agent"
  - "Mandela effect"
