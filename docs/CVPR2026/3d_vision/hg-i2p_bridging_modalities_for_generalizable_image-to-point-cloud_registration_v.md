...
1. **State of the Field**: Image-to-point-cloud (I2P) registration aims to establish correspondences between 2D pixels and 3D points, serving as a cornerstone for visual localization, navigation, and 3D reconstruction. Recent learning-based methods have advanced the field by improving backbone networks, matching strategies, and loss functions; for example, MATR adopts coarse-to-fine matching, while CoFiI2P introduces patch-level matching.
