...
description: >-
  [ICLR 2026][Alignment & RLHF][reward over-optimization] The authors theoretically prove that reward over-optimization primarily stems from reward model misspecification in the high-reward tail regions. They propose a rubric-based reward modeling method: utilizing off-policy data (excellent responses generated by strong models) to construct scoring rubrics and refining them
tags:
  - ICLR 2026
  - Alignment & RLHF
