...
description: >-
  [ICLR 2026][Interpretability][multi-task learning] This paper proposes the Domain Expansion framework, which restructures the latent space into mutually orthogonal subspaces via Orthogonal Pooling…
tags:
  - "ICLR 2026"
  - "Interpretability"
  - "multi-task learning"
