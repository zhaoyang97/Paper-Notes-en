...
description: >-
  [ACL 2026][Graph Learning][Relation Extraction] Systematic comparison across six RE datasets reveals that when average graph edges exceed ~18, a 124M-parameter graph parser consistently and significantly outperforms 7B-70B LLMs, with F1 gaps reaching 13.2 points.
tags:
  - ACL 2026
  - Graph Learning
  - Relation Extraction
