...
description: >-
  [ICLR 2026][LLM Reasoning][GRPO] This paper proposes the Scaf-GRPO framework, which injects hierarchical in-prompt hints (Knowledge → Planning → Solution) to overcome the "learning cliff" (zero-reward) problem in GRPO tr…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "GRPO"
