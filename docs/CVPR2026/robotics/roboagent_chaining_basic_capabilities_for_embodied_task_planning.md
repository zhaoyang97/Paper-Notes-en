...
description: >-
  [CVPR 2026][Robotics][Embodied Task Planning] This paper proposes RoboAgent, a capability-driven embodied task planning framework that employs a single VLM to simultaneously serve as a scheduler and five basic capabiliti…
tags:
  - "CVPR 2026"
  - "Robotics"
