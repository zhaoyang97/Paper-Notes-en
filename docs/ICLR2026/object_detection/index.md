---
title: >-
  ICLR2026 Object Detection Papers · 31 Notes
description: >-
  31 ICLR2026 papers in the Object Detection area, covering Object Detection, Anomaly Detection, Time-Series Forecasting, Few-/Zero-Shot Learning, Diffusion Models and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Object Detection"
  - "AI paper notes"
  ...
  - "Diffusion Models"
item_list:
  - u: "apt_towards_universal_scene_graph_generation_via_plug-in_adaptive_prompt_tuning/"
    t: "APT: Towards Universal Scene Graph Generation via Plug-in Adaptive Prompt Tuning"
  ...
  - u: "deco-detr_decoupled_cognition_detr_for_efficient_open-vocabulary_object_detectio/"
    t: "DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection"
  - u: "detr-vip_detection_transformer_with_robust_discriminative_visual_prompts/"
    t: "DETR-ViP: Detection Transformer with Robust Discriminative Visual Prompts"
  - u: "diffudetr_rethinking_detection_transformers_with_denoising_diffusion_process/"
    t: "DiffuDETR: Rethinking Detection Transformers with Denoising Diffusion Process"
  - u: "dual_distillation_for_few-shot_anomaly_detection/"
    t: "Dual Distillation for Few-Shot Anomaly Detection"
  - u: "enhancing_vision_transformers_for_object_detection_via_context-aware_token_selec/"
    t: "Enhancing Vision Transformers for Object Detection via Context-Aware Token Selection and Packing"
  - u: "fantastic_tractor-dogs_and_how_not_to_find_them_with_open-vocabulary_detectors/"
    t: "Fantastic Tractor-Dogs and How Not to Find Them With Open-Vocabulary Detectors"
  ...
  - u: "interference-isolated_elastic_weight_consolidation_and_knowledge_calibration_for/"
    t: "Interference-Isolated Elastic Weight Consolidation and Knowledge Calibration for Incremental Object Detection"
  - u: "long-context_generalization_with_sparse_attention/"
    t: "Long-Context Generalization with Sparse Attention"
  - u: "od3_optimization-free_dataset_distillation_for_object_detection/"
    t: "OD3: Optimization-Free Dataset Distillation for Object Detection"
  - u: "ovid_open-vocabulary_intrusion_detection/"
    t: "OVID: Open-Vocabulary Intrusion Detection"
  ...
  - u: "pgrf-net_a_prototype-guided_relational_fusion_network_for_diagnostic_multivariat/"
    t: "PGRF-Net: A Prototype-Guided Relational Fusion Network for Diagnostic Multivariate Time-Series Anomaly Detection"
  - u: "point2rbox-v3_self-bootstrapping_from_point_annotations_via_integrated_pseudo-la/"
    t: "Point2RBox-v3: Self-Bootstrapping from Point Annotations via Integrated Pseudo-Label Refinement and Utilization"
  - u: "retain_and_adapt_auto-balanced_model_editing_for_open-vocabulary_object_detectio/"
  ...
  - u: "towards_reliable_detection_of_empty_space_conditional_marked_point_processes_for/"
    t: "Towards Reliable Detection of Empty Space: Conditional Marked Point Processes for Object Detection"
...
📌 **Same area in other venues:** [📷 CVPR2026 (97)](../../CVPR2026/object_detection/index.md) · [🧪 ICML2026 (6)](../../ICML2026/object_detection/index.md) · [🤖 AAAI2026 (29)](../../AAAI2026/object_detection/index.md) · [🧠 NeurIPS2025 (27)](../../NeurIPS2025/object_detection/index.md) · [📹 ICCV2025 (28)](../../ICCV2025/object_detection/index.md)
...
**[DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection](deco-detr_decoupled_cognition_detr_for_efficient_open-vocabulary_object_detectio.md)**
...
**[DETR-ViP: Detection Transformer with Robust Discriminative Visual Prompts](detr-vip_detection_transformer_with_robust_discriminative_visual_prompts.md)**
...
**[DiffuDETR: Rethinking Detection Transformers with Denoising Diffusion Process](diffudetr_rethinking_detection_transformers_with_denoising_diffusion_process.md)**
...
**[Enhancing Vision Transformers for Object Detection via Context-Aware Token Selection and Packing](enhancing_vision_transformers_for_object_detection_via_context-aware_token_selec.md)**
...
**[Fantastic Tractor-Dogs and How Not to Find Them With Open-Vocabulary Detectors](fantastic_tractor-dogs_and_how_not_to_find_them_with_open-vocabulary_detectors.md)**
...
**[Interference-Isolated Elastic Weight Consolidation and Knowledge Calibration for Incremental Object Detection](interference-isolated_elastic_weight_consolidation_and_knowledge_calibration_for.md)**
...
**[OD3: Optimization-Free Dataset Distillation for Object Detection](od3_optimization-free_dataset_distillation_for_object_detection.md)**
...
**[OVID: Open-Vocabulary Intrusion Detection](ovid_open-vocabulary_intrusion_detection.md)**
...
**[PGRF-Net: A Prototype-Guided Relational Fusion Network for Diagnostic Multivariate Time-Series Anomaly Detection](pgrf-net_a_prototype-guided_relational_fusion_network_for_diagnostic_multivariat.md)**

:   To be supplemented after in-depth paper reading.

**[Point2RBox-v3: Self-Bootstrapping from Point Annotations via Integrated Pseudo-Label Refinement and Utilization](point2rbox-v3_self-bootstrapping_from_point_annotations_via_integrated_pseudo-la.md)**
...
**[Retain and Adapt: Auto-Balanced Model Editing for Open-Vocabulary Object Detection under Domain Shifts](retain_and_adapt_auto-balanced_model_editing_for_open-vocabulary_object_detectio.md)**
...
**[Towards Reliable Detection of Empty Space: Conditional Marked Point Processes for Object Detection](towards_reliable_detection_of_empty_space_conditional_marked_point_processes_for.md)**
...
**[Unbiased Object Detection Beyond Frequency with Visually Prompted Image Synthesis](unbiased_object_detection_beyond_frequency_with_visually_prompted_image_synthesi.md)**
