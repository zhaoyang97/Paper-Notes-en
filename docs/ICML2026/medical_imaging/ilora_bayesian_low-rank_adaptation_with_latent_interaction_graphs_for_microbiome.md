...
description: >-
  [ICML 2026][Medical Imaging][LoRA] iLoRA employs a Bayesian approach to infer a sparse microbial interaction graph from each microbiome sample (Poisson edges → Laplace sparsification → GNN embedding). This graph then gen…
tags:
  - "ICML 2026"
  - "Medical Imaging"
  - "LoRA"
