...
description: >-
  [ICLR 2026][LLM Reasoning][uncertainty-aware planning] This paper proposes PCE (Planner-Composer-Evaluator), a framework that explicitly extracts and organizes implicit environmental assumptions from LLM reasoning chains…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
