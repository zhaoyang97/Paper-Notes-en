...
description: >-
  [CVPR2026][LLM Safety][machine unlearning] This paper proposes RAZOR, a ratio-aware multi-layer/multi-head selective editing framework that enables efficient and precise targeted unlearning in Transformer-based vision mo…
tags:
  - "CVPR2026"
  - "LLM Safety"
  - "machine unlearning"
