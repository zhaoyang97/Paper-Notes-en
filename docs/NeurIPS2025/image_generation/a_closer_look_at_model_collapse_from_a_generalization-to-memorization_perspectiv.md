...
**Root Cause**: Training set size remains constant across iterations, yet generation quality and diversity degrade rapidly—indicating that collapse is not driven solely by sample count but by the decay of data **informativeness** (entropy).
