...
description: >-
  [CVPR 2026][Self-Supervised Learning][Procedural pre-training] Before a ViT officially processes images, a lightweight masked-token pre-training (warm-up) is conducted using **purely symbolic sequences without any visual content** (e.g., "balanced parentheses") generated by formal grammars. This forces the model to internalize universal computational mechanisms such as stack-based hierarchy and long-range dependencies. When followed by standard image training…
tags:
  - "CVPR 2026"
