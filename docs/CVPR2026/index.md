...
[Browse all 230 3D Vision papers →](3d_vision/)

---

## 🧩 Multimodal VLM (223) { #multimodal_vlm }
...
[Browse all 223 Multimodal VLM papers →](multimodal_vlm/)

---

## 🎨 Image Generation (210) { #image_generation }
...
[Browse all 210 Image Generation papers →](image_generation/)

---

## 🏥 Medical Imaging (102) { #medical_imaging }
...
[Browse all 102 Medical Imaging papers →](medical_imaging/)

---

## 🚗 Autonomous Driving (89) { #autonomous_driving }
...
[Browse all 89 Autonomous Driving papers →](autonomous_driving/)

---

## ✂️ Segmentation (83) { #segmentation }
...
[Browse all 83 Segmentation papers →](segmentation/)

---

## 📹 Video Understanding (78) { #video_understanding }
...
[Browse all 78 Video Understanding papers →](video_understanding/)

---

## 🧑 Human Understanding (56) { #human_understanding }
...
[Browse all 56 Human Understanding papers →](human_understanding/)

---

## 🎬 Video Generation (56) { #video_generation }
...
[Browse all 56 Video Generation papers →](video_generation/)

---

## 📦 Model Compression (53) { #model_compression }
...
[Browse all 53 Model Compression papers →](model_compression/)

---

## 🎯 Object Detection (40) { #object_detection }
...
[Browse all 40 Object Detection papers →](object_detection/)

---

## 🖼️ Image Restoration (39) { #image_restoration }
...
[Browse all 39 Image Restoration papers →](image_restoration/)

---

## 🤖 Robotics & Embodied AI (34) { #robotics }
...
[Browse all 34 Robotics & Embodied AI papers →](robotics/)

---

## 🔄 Self-Supervised Learning (30) { #self_supervised }
...
[Browse all 30 Self-Supervised Learning papers →](self_supervised/)

---

## 🔬 Interpretability (28) { #interpretability }
...
[Browse all 28 Interpretability papers →](interpretability/)

---

## 📊 LLM Evaluation (25) { #llm_evaluation }
...
[Browse all 25 LLM Evaluation papers →](llm_evaluation/)

---

## 🛡️ AI Safety (22) { #ai_safety }
...
[Browse all 22 AI Safety papers →](ai_safety/)

---

## 🔒 LLM Safety (22) { #llm_safety }
...
[Browse all 22 LLM Safety papers →](llm_safety/)

---

## 👻 Hallucination Detection (18) { #hallucination }
...
[Browse all 18 Hallucination Detection papers →](hallucination/)

---

## 🎮 Reinforcement Learning (18) { #reinforcement_learning }
...
[Browse all 18 Reinforcement Learning papers →](reinforcement_learning/)

---

## 🎵 Audio & Speech (15) { #audio_speech }
...
[Browse all 15 Audio & Speech papers →](audio_speech/)

---

## 🛰️ Remote Sensing (15) { #remote_sensing }
...
[Browse all 15 Remote Sensing papers →](remote_sensing/)

---

## 🦾 LLM Agent (14) { #llm_agent }
...
[Browse all 14 LLM Agent papers →](llm_agent/)

---

## 💡 LLM Reasoning (10) { #llm_reasoning }
...
## ⚖️ Alignment & RLHF (9) { #llm_alignment }
...
## 📐 Optimization & Theory (8) { #optimization }
...
## ⚛️ Physics & Scientific Computing (5) { #physics }
...
## 📡 Signal & Communications (5) { #signal_comm }
...
## 👥 Social Computing (5) { #social_computing }
...
## ⚡ LLM Efficiency (4) { #llm_efficiency }
...
## 🔗 Causal Inference (2) { #causal_inference }
...
## 💻 Code Intelligence (2) { #code_intelligence }
...
## 🌐 Multilingual & Translation (2) { #multilingual_mt }
...
## 🔎 AIGC Detection (1) { #aigc_detection }
...
[Browse all 42 Others papers →](others/)
