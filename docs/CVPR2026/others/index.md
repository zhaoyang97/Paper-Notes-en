---
title: >-
  CVPR2026 Others Papers · 105 Notes
description: >-
  105 CVPR2026 papers in the Others area, covering Few-/Zero-Shot Learning, Adversarial Robustness, Federated Learning, Diffusion Models, Alignment/RLHF, Face & Gaze and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2026"
  - "Others"
  - "AI paper notes"
...
item_list:
  ...
  - u: "basis-oriented_low-rank_transfer_for_few-shot_and_test-time_adaptation/"
    t: "Basis-Oriented Low-rank Transfer for Few-Shot and Test-Time Adaptation"
  ...
  - u: "brepvgae_variational_graph_autoencoder_with_unified_latent_representation_for_b-/"
    t: "BrepVGAE: Variational Graph Autoencoder with Unified Latent Representation for B-rep"
  - u: "bridging_domain_expertise_and_generalization_for_performance_estimation/"
    t: "Bridging Domain Expertise and Generalization for Performance Estimation"
  - u: "chirp_dataset_towards_long-term_individual-level_behavioral_monitoring_of_bird_p/"
    t: "CHIRP dataset: towards long-term, individual-level, behavioral monitoring of bird populations in the wild"
  - u: "clair_obscur_an_illumination-aware_method_for_real-world_image_vectorization/"
    t: "Clair Obscur: an Illumination-Aware Method for Real-World Image Vectorization"
  - u: "coded-e2lf_coded_aperture_light_field_imaging_from_events/"
    t: "Coded-E2LF: Coded Aperture Light Field Imaging from Events"
  - u: "computer_vision_with_a_superpixelation_camera/"
    t: "Computer Vision with a Superpixelation Camera"
  - u: "confusion-aware_spectral_regularizer_for_long-tailed_recognition/"
    t: "Confusion-Aware Spectral Regularizer for Long-Tailed Recognition"
  - u: "consensus_vs_controversy_mapping_the_decision_space_where_architectures_diverge/"
    t: "Consensus vs. Controversy: Mapping the Decision Space Where Architectures Diverge"
  - u: "convolutional_neural_networks_driven_by_content_similarity/"
    t: "Convolutional Neural Networks Driven by Content Similarity"
  - u: "coupling_liquid_time-constant_encoders_with_modern_hopfield_memory/"
    t: "Coupling Liquid Time-Constant Encoders with Modern Hopfield Memory"
  ...
  - u: "data-centric_meta-learning_for_robust_few-shot_generalization/"
    t: "Data-Centric Meta-Learning for Robust Few-Shot Generalization"
  - u: "debiased_sample_selection_for_learning_with_noisy_labels/"
    t: "Debiased Sample Selection for Learning with Noisy Labels"
  ...
  - u: "df2-vb_dual-level_fuzzy_fusion_with_view-specific_boosting_for_multi-view_multi-/"
    t: "DF²-VB: Dual-level Fuzzy Fusion with View-specific Boosting for Multi-view Multi-label Classification"
...
📌 **Same area in other venues:** [🔬 ICLR2026 (116)](../../ICLR2026/others/index.md) · [💬 ACL2026 (4)](../../ACL2026/others/index.md) · [🧪 ICML2026 (70)](../../ICML2026/others/index.md) · [🤖 AAAI2026 (117)](../../AAAI2026/others/index.md) · [🧠 NeurIPS2025 (121)](../../NeurIPS2025/others/index.md) · [📹 ICCV2025 (33)](../../ICCV2025/others/index.md)

🔥 **Top topics:** Few-/Zero-Shot Learning ×8 · Adversarial Robustness ×5 · Federated Learning ×3 · Diffusion Models ×2 · Alignment/RLHF ×2
...
**[Basis-Oriented Low-rank Transfer for Few-Shot and Test-Time Adaptation](basis-oriented_low-rank_transfer_for_few-shot_and_test-time_adaptation.md)**
...
**[DP-FedAdamW: An Efficient Optimizer for Differentially Private Federated Large Models](dp-fedadamw_an_efficient_optimizer_for_differentially_private_federated_large_mo.md)**
...
**[FedSDR: Federated Graph Learning with Structural Noise Detection and Reconstruction](fedsdr_federated_graph_learning_with_structural_noise_detection_and_reconstructi.md)**
...
**[FedSST: Rethinking Fair Federated Graph Learning under Structural Shift](fedsst_rethinking_fair_federated_graph_learning_under_structural_shift.md)**
...
**[FlashVSR: Towards Real-time Diffusion-Based Streaming Video Super Resolution](flashvsr_towards_real-time_diffusion-based_streaming_video_super_resolution.md)**
...
**[FoleyDesigner: Immersive Stereo Foley Generation with Precise Spatio-Temporal Alignment for Film Clips](foleydesigner_immersive_stereo_foley_generation_with_precise_spatio-temporal_ali.md)**
...
**[Hearing the Room Through the Shape of the Drum: Modal-Guided Sound Recovery from Multi-Point Surface Vibrations](hearing_the_room_through_the_shape_of_the_drum_modal-guided_sound_recovery_from_.md)**
...
**[HyperNAS: Enhancing Architecture Representation for NAS Predictor via Hypernetwork](hypernas_enhancing_architecture_representation_for_nas_predictor_via_hypernetwor.md)**
...
**[Inter-Photon-Limited Videography](inter-photon-limited_videography.md)**
...
**[InTrain: Intrinsic Trainability for Zero-Cost Neural Architecture Search](intrain_intrinsic_trainability_for_zero-cost_neural_architecture_search.md)**
...
**[MMVIP: A Visible-infrared Paired Dataset for Multi-weather Marine Vision](mmvip_a_visible-infrared_paired_dataset_for_multi-weather_marine_vision.md)**
...
**[The Missing GAP: From Solving Square Jigsaw Puzzles to Handling Real World Archaeological Fragments](the_missing_gap_from_solving_square_jigsaw_puzzles_to_handling_real_world_archae.md)**
...
**[The SA-FARI Dataset: Segment Anything in Footage of Animals for Recognition and Identification](the_sa-fari_dataset_segment_anything_in_footage_of_animals_for_recognition_and_i.md)**
...
**[VideoMaMa: Mask-Guided Video Matting via Generative Prior](videomama_mask-guided_video_matting_via_generative_prior.md)**
...
**[What Is the Optimal Ranking Score Between Precision and Recall? We Can Always Find It and It Is Rarely $F_1$](what_is_the_optimal_ranking_score_between_precision_and_recall_we_can_always_fin.md)**
...
**[When AVSR Meets Video Conferencing: Dataset, Degradation, and the Hidden Mechanism Behind Performance Collapse](when_avsr_meets_video_conferencing_dataset_degradation_and_the_hidden_mechanism_.md)**
...
**[Why Not Hyperparameter-Friendly Optimisation? A Monotonic Adaptive Norm Rescaling Approach For Long-Tailed Recognition](why_not_hyperparameter-friendly_optimisation_a_monotonic_adaptive_norm_rescaling.md)**
