...
description: >-
  [ICLR 2026][Computational Biology][molecular dynamics] PVB (Pretrained Variational Bridge) unifies the training objectives of single-structure pretraining and paired-trajectory fine-tuning via an encoder-decoder architec…
tags:
  - "ICLR 2026"
