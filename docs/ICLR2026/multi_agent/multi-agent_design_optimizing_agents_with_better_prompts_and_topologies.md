...
description: >-
  [ICLR 2026][Multi-Agent][Multi-agent systems] This paper proposes Multi-Agent System Search (MASS), a framework that automatically discovers high-performance multi-agent system (MAS) designs through a three-stage interle…
tags:
  - "ICLR 2026"
  - "Multi-Agent"
  - "Multi-agent systems"
