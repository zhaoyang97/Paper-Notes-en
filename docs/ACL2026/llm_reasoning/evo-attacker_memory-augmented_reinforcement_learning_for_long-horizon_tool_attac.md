...
description: >-
  [ACL 2026][LLM Reasoning][LLM-MAS] This paper proposes Evo-Attacker, which models tool return tampering for LLM multi-agent systems (LLM-MAS) as a long-horizon reinforcement learning problem with dynamic attack memory. It optimizes retrieval, reflection, and modification decisions using Attack-Flow GRPO, significantly reducing system success rates acros
tags:
  - ACL 2026
  - LLM Reasoning
  - LLM-MAS
