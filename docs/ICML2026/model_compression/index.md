---
title: >-
  ICML2026 Model Compression Papers · 117 Notes
description: >-
  117 ICML2026 papers in the Model Compression area, covering Model Compression, LLM, Compression, Reasoning, Diffusion Models, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "Model Compression"
  - "AI paper notes"
...
**[LC-QAT: Data-Efficient 2-Bit QAT for LLMs via Linear-Constrained Vector Quantization](lc-qat_data-efficient_2-bit_qat_for_llms_via_linear-constrained_vector_quantizat.md)**
...
**[T3S: Training Trajectory-Aware Token Selection, Breaking the "Imitation Shock" in Reasoning Distillation](training-trajectory-aware_token_selection.md)**
