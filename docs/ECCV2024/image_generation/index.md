---
title: >-
  ECCV2024 Image Generation Papers · 117 Notes
description: >-
  117 ECCV2024 papers in the Image Generation area, covering Diffusion Models, Text-to-Image, Super-Resolution, Image Editing, Personalized Generation, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ECCV2024"
  - "Image Generation"
  - "AI paper notes"
...
item_list:
  ...
  - u: "a_closer_look_at_gan_priors_exploiting_intermediate_features/"
    t: "A Closer Look at GAN Priors: Exploiting Intermediate Features for Enhanced Model Inversion Attacks"
  - u: "a_diffusion_model_for_simulation_ready_coronary_anatomy_with/"
    t: "A Diffusion Model for Simulation Ready Coronary Anatomy with Morpho-skeletal Control"
  - u: "a_highquality_robust_diffusion_framework_for_corrupted_datas/"
    t: "A High-Quality Robust Diffusion Framework for Corrupted Dataset"
  - u: "accdiffusion_an_accurate_method_for_higher-resolution_image_generation/"
    t: "AccDiffusion: An Accurate Method for Higher-Resolution Image Generation"
  - u: "adadiffsr_adaptive_region-aware_dynamic_acceleration_diffusion_model_for_real-wo/"
    t: "AdaDiffSR: Adaptive Region-Aware Dynamic Acceleration Diffusion Model for Real-World Image Super-Resolution"
  - u: "adagen_learning_adaptive_policy_for_image_synthesis/"
    t: "AdaGen: Learning Adaptive Policy for Image Synthesis"
  - u: "adanat_exploring_adaptive_policy_for_token-based_image_generation/"
    t: "AdaNAT: Exploring Adaptive Policy for Token-Based Image Generation"
  - u: "afreeca_annotation-free_counting_for_all/"
  ...
  - u: "bridging_the_gap_studio-like_avatar_creation_from_a_monocular_phone_capture/"
    t: "Bridging the Gap: Studio-Like Avatar Creation from a Monocular Phone Capture"
  - u: "byteedit_boost_comply_and_accelerate_generative_image_editing/"
    t: "ByteEdit: Boost, Comply and Accelerate Generative Image Editing"
  - u: "challenging_forgets_unveiling_the_worst-case_forget_sets_in_machine_unlearning/"
    t: "Challenging Forgets: Unveiling the Worst-Case Forget Sets in Machine Unlearning"
  - u: "coin_control-inpainting_diffusion_prior_for_human_and_camera_motion_estimation/"
    t: "COIN: Control-Inpainting Diffusion Prior for Human and Camera Motion Estimation"
  - u: "collaborative_control_for_geometry-conditioned_pbr_image_generation/"
    t: "Collaborative Control for Geometry-Conditioned PBR Image Generation"
  - u: "colorpeel_color_prompt_learning_with_diffusion_models_via_color_and_shape_disent/"
    t: "ColorPeel: Color Prompt Learning with Diffusion Models via Color and Shape Disentanglement"
  - u: "controlling_the_world_by_sleight_of_hand/"
    t: "Controlling the World by Sleight of Hand"
  - u: "dcdm_diffusion-conditioned-diffusion_model_for_scene_text_image_super-resolution/"
    t: "DCDM: Diffusion-Conditioned-Diffusion Model for Scene Text Image Super-Resolution"
  - u: "diff-tracker_text-to-image_diffusion_models_are_unsupervised_trackers/"
    t: "Diff-Tracker: Text-to-Image Diffusion Models are Unsupervised Trackers"
  - u: "diffit_diffusion_vision_transformers_for_image_generation/"
    t: "DiffiT: Diffusion Vision Transformers for Image Generation"
  - u: "diffusion-based_image-to-image_translation_by_noise_correction_via_prompt_interp/"
    t: "Diffusion-based Image-to-Image Translation by Noise Correction via Prompt Interpolation"
  - u: "diffusion-driven_data_replay_a_novel_approach_to_combat_forgetting_in_federated_/"
    t: "Diffusion-Driven Data Replay: A Novel Approach to Combat Forgetting in Federated Class Continual Learning"
  - u: "distilling_diffusion_models_into_conditional_gans/"
...
**[Distilling Diffusion Models into Conditional GANs](distilling_diffusion_models_into_conditional_gans.md)**
...
**[EBDM: Exemplar-guided Image Translation with Brownian-bridge Diffusion Models](ebdm_exemplar-guided_image_translation_with_brownian-bridge_diffusion_models.md)**
...
**[Enhancing Perceptual Quality in Video Super-Resolution through Temporally-Consistent Detail Synthesis using Diffusion Models](enhancing_perceptual_quality_in_video_super-resolution_through_temporally-consis.md)**
...
**[Eta Inversion: Designing an Optimal Eta Function for Diffusion-based Real Image Editing](eta_inversion_designing_an_optimal_eta_function_for_diffusion-based_real_image_e.md)**
...
**[Getting it Right: Improving Spatial Consistency in Text-to-Image Models](getting_it_right_improving_spatial_consistency_in_text-to-image_models.md)**
...
**[IRGen: Generative Modeling for Image Retrieval](irgen_generative_modeling_for_image_retrieval.md)**
...
**[Linearly Controllable GAN: Unsupervised Feature Categorization and Decomposition for Image Generation and Manipulation](linearly_controllable_gan_unsupervised_feature_categorization_and_decomposition_.md)**
...
**[Probabilistic Weather Forecasting with Deterministic Guidance-Based Diffusion Model](probabilistic_weather_forecasting_with_deterministic_guidance-based_diffusion_mo.md)**
...
**[RegionDrag: Fast Region-Based Image Editing with Diffusion Models](regiondrag_fast_region-based_image_editing_with_diffusion_models.md)**
...
**[Shedding More Light on Robust Classifiers under the lens of Energy-based Models](shedding_more_light_on_robust_classifiers_under_the_lens_of_energy-based_models.md)**
...
**[Stable Preference: Redefining Training Paradigm of Human Preference Model for Text-to-Image Synthesis](stable_preference_redefining_training_paradigm_of_human_preference_model_for_tex.md)**
