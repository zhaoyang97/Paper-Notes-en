...
description: >-
  [ACL 2026][LLM Agent][Tool amplification] This paper proposes a novel "tool amplification" paradigm (distinct from conventional tool orchestration) and introduces the ChemAmp framework…
tags:
  - "ACL 2026"
  - "LLM Agent"
  - "Tool amplification"
