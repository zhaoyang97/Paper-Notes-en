...
description: >-
  [ICLR 2026][Text Generation][uncertainty estimation] Starting from the proper scoring rules framework, this paper proves that the negative log-likelihood of the highest-probability output sequence (MSP) is a theoreticall…
tags:
  - "ICLR 2026"
  - "Text Generation"
