---
title: >-
  ICLR2026 Code Intelligence Papers · 59 Notes
description: >-
  59 ICLR2026 papers in the Code Intelligence area, covering LLM, Code Intelligence, Reinforcement Learning, Agents, Reasoning, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Code Intelligence"
  - "AI paper notes"
...
item_list:
  ...
  - u: "agnostics_learning_to_synthesize_code_in_any_programming_language_with_a_univers/"
    t: "Agnostics: Learning to Synthesize Code in Any Programming Language with a Universal Reinforcement Learning Environment"
  ...
  - u: "critique-coder_enhancing_coder_models_by_critique_reinforcement_learning/"
    t: "Critique-Coder: Enhancing Coder Models by Critique Reinforcement Learning"
  - u: "crosspl_systematic_evaluation_of_large_language_models_for_cross_programming_lan/"
    t: "CrossPL: Systematic Evaluation of Large Language Models for Cross Programming Language Interoperating Code Generation"
  - u: "devops-gym_benchmarking_ai_agents_in_software_devops_cycle/"
    t: "DevOps-Gym: Benchmarking AI Agents in Software DevOps Cycle"
  ...
  - u: "evolving_graph_structured_programs_for_circuit_generation_with_large_language_mo/"
    t: "Evolving Graph Structured Programs for Circuit Generation with Large Language Models"
  - u: "fhe-coder_benchmarking_secure_agentic_code_generation_for_fully_homomorphic_encr/"
    t: "FHE-Coder: Benchmarking Secure Agentic Code Generation for Fully Homomorphic Encryption"
  - u: "from_assistant_to_independent_developer_are_gpts_ready_for_software_development/"
    t: "From Assistant to Independent Developer — Are GPTs Ready for Software Development?"
  - u: "from_large_to_small_transferring_cuda_optimization_expertise_via_reasoning_graph/"
    t: "From Large to Small: Transferring CUDA Optimization Expertise via Reasoning Graph"
  - u: "gistify_codebase-level_understanding_via_runtime_execution/"
    t: "Gistify: Codebase-Level Understanding via Runtime Execution"
  - u: "gradient-based_program_synthesis_with_neurally_interpreted_languages/"
    t: "Gradient-Based Program Synthesis with Neurally Interpreted Languages"
  - u: "hardtestgen_a_high-quality_rl_verifier_generation_pipeline_for_llm_algorithmic_c/"
    t: "HARDTESTGEN: A High-Quality RL Verifier Generation Pipeline for LLM Algorithmic Coding"
...
**[Agnostics: Learning to Synthesize Code in Any Programming Language with a Universal Reinforcement Learning Environment](agnostics_learning_to_synthesize_code_in_any_programming_language_with_a_univers.md)**
...
**[Code2Bench: Scaling Source and Rigor for Dynamic Benchmark Construction](code2bench_scaling_source_and_rigor_for_dynamic_benchmark_construction.md)**
...
**[Critique-Coder: Enhancing Coder Models by Critique Reinforcement Learning](critique-coder_enhancing_coder_models_by_critique_reinforcement_learning.md)**
...
**[CrossPL: Systematic Evaluation of Large Language Models for Cross Programming Language Interoperating Code Generation](crosspl_systematic_evaluation_of_large_language_models_for_cross_programming_lan.md)**
...
**[DevOps-Gym: Benchmarking AI Agents in Software DevOps Cycle](devops-gym_benchmarking_ai_agents_in_software_devops_cycle.md)**
...
**[Evolving Graph Structured Programs for Circuit Generation with Large Language Models](evolving_graph_structured_programs_for_circuit_generation_with_large_language_mo.md)**
...
**[FHE-Coder: Benchmarking Secure Agentic Code Generation for Fully Homomorphic Encryption](fhe-coder_benchmarking_secure_agentic_code_generation_for_fully_homomorphic_encr.md)**
...
**[From Assistant to Independent Developer — Are GPTs Ready for Software Development?](from_assistant_to_independent_developer_are_gpts_ready_for_software_development.md)**
...
**[From Large to Small: Transferring CUDA Optimization Expertise via Reasoning Graph](from_large_to_small_transferring_cuda_optimization_expertise_via_reasoning_graph.md)**
...
**[Gistify: Codebase-Level Understanding via Runtime Execution](gistify_codebase-level_understanding_via_runtime_execution.md)**
...
**[Gradient-Based Program Synthesis with Neurally Interpreted Languages](gradient-based_program_synthesis_with_neurally_interpreted_languages.md)**
...
**[HARDTESTGEN: A High-Quality RL Verifier Generation Pipeline for LLM Algorithmic Coding](hardtestgen_a_high-quality_rl_verifier_generation_pipeline_for_llm_algorithmic_c.md)**
...
**[LearNAT: Learning NL2SQL with AST-guided Task Decomposition for Large Language Models](learnat_learning_nl2sql_with_ast-guided_task_decomposition_for_large_language_mo.md)**
...
**[LLM-Guided Evolutionary Program Synthesis for Quasi-Monte Carlo Design](llm-guided_evolutionary_program_synthesis_for_quasi-monte_carlo_design.md)**
...
**[Local Success Does Not Compose: Benchmarking Large Language Models for Compositional Formal Verification](local_success_does_not_compose_benchmarking_large_language_models_for_compositio.md)**
...
**[Multi-LCB: Extending LiveCodeBench to Multiple Programming Languages](multi-lcb_extending_livecodebench_to_multiple_programming_languages.md)**
...
**[Process-Level Trajectory Evaluation for Environment Configuration in Software Engineering Agents](process-level_trajectory_evaluation_for_environment_configuration_in_software_en.md)**
...
**[QLCoder: A Query Synthesizer For Static Analysis of Security Vulnerabilities](qlcoder_a_query_synthesizer_for_static_analysis_of_security_vulnerabilities.md)**
...
**[RECODE-H: A Benchmark for Research Code Development with Interactive Human Feedback](recode-h_a_benchmark_for_research_code_development_with_interactive_human_feedba.md)**
...
**[RefineStat: Efficient Exploration for Probabilistic Program Synthesis](refinestat_efficient_exploration_for_probabilistic_program_synthesis.md)**
...
**[RESCUE: Retrieval Augmented Secure Code Generation](rescue_retrieval_augmented_secure_code_generation.md)**
...
**[SWE-RM: Execution-Free Feedback for Software Engineering Agents](swe-rm_execution-free_feedback_for_software_engineering_agents.md)**
...
**[SweRank: Software Issue Localization via Code Ranking](swerank_software_issue_localization_with_code_ranking.md)**
...
**[The Matthew Effect of AI Programming Assistants: A Hidden Bias in Software Evolution](the_matthew_effect_of_ai_programming_assistants_a_hidden_bias_in_software_evolut.md)**
...
**[VeriEquivBench: An Equivalence Score for Ground-Truth-Free Evaluation of Formally Verifiable Code](veriequivbench_an_equivalence_score_for_ground-truth-free_evaluation_of_formally.md)**
...
**[VERINA: Benchmarking Verifiable Code Generation](verina_benchmarking_verifiable_code_generation.md)**
...
**[VisCoder2: Building Multi-Language Visualization Coding Agents](viscoder2_building_multi-language_visualization_coding_agents.md)**
...
**[WebGen-Agent: Enhancing Interactive Website Generation with Multi-Level Feedback and Step-Level Reinforcement Learning](webgen-agent_enhancing_interactive_website_generation_with_multi-level_feedback_.md)**
