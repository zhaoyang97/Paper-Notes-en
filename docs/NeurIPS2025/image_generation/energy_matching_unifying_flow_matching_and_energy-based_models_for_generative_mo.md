...
description: >-
  [NeurIPS 2025][Image Generation][Energy-Based Models] This paper proposes Energy Matching, which unifies flow matching and energy-based models via a single time-independent scalar potential field: far from the data manif…
tags:
  - "NeurIPS 2025"
  - "Image Generation"
  - "Energy-Based Models"
