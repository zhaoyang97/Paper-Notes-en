...
description: >-
  [ICLR 2026][Model Compression][Preference Optimization] This paper proposes MetaAPO, a framework that employs a lightweight meta-learner (a two-layer MLP) to dynamically estimate the alignment gap between offline and onl…
tags:
  - "ICLR 2026"
  - "Model Compression"
