...
description: >-
  1364 ACL2026 paper notes covering LLM Safety (115), LLM Evaluation (92), LLM Reasoning (81), Multimodal VLM (79), LLM Agent (78), Information Retrieval & RAG (70), Audio & Speech (68), Interpretability (61) and other 38 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ACL2026"
...
[Browse all 59 LLM (Other) papers →](llm_nlp/)
...
## 🌐 Multilingual & Translation (61) { #multilingual_mt }
...
[Browse all 61 Multilingual & Translation papers →](multilingual_mt/)

---

## 🔍 Information Retrieval & RAG (70) { #information_retrieval }
...
[Browse all 70 Information Retrieval & RAG papers →](information_retrieval/)

---

## 💻 Code Intelligence (49) { #code_intelligence }
...
[Browse all 49 Code Intelligence papers →](code_intelligence/)
...
## 🧩 Multimodal VLM (79) { #multimodal_vlm }
...
[Browse all 79 Multimodal VLM papers →](multimodal_vlm/)
...
[Browse all 31 VLM Reasoning papers →](vlm_reasoning/)
...
## 🔬 Interpretability (61) { #interpretability }
...
[Browse all 61 Interpretability papers →](interpretability/)
