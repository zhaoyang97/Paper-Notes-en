...
description: >-
  [CVPR 2026][3D Vision][sparse-camera 4D reconstruction] This paper proposes SparseCam4D, the first method to achieve sparse-camera (2–3 views) 4D reconstruction on standard multi-camera dynamic scene benchmarks. The core…
tags:
  - "CVPR 2026"
  - "3D Vision"
