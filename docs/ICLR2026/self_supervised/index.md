---
title: >-
  ICLR2026 Self-Supervised Learning Papers · 81 Notes
description: >-
  81 ICLR2026 papers in the Self-Supervised Learning area, covering Self-Supervised Learning, Alignment/RLHF, Continual Learning, Adversarial Robustness, Multimodal/VLM, Time-Series Forecasting and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
item_list:
  - u: "a_bayesian_nonparametric_framework_for_learning_disentangled_representations/"
    t: "A Bayesian Nonparametric Framework for Learning Disentangled Representations"
  ...
  - u: "cola_co-calibrated_logit_adjustment_for_long-tailed_semi-supervised_learning/"
    t: "CoLA: Co-Calibrated Logit Adjustment for Long-Tailed Semi-Supervised Learning"
  - u: "contrastive_predictive_coding_done_right_for_mutual_information_estimation/"
  ...
  - u: "diverse_dictionary_learning/"
    t: "Diverse Dictionary Learning"
  - u: "dual_perspectives_on_non-contrastive_self-supervised_learning/"
    t: "Dual Perspectives on Non-Contrastive Self-Supervised Learning"
  - u: "equivariant_splitting_self-supervised_learning_from_incomplete_data/"
    t: "Equivariant Splitting: Self-supervised learning from incomplete data"
  ...
  - u: "fedopenmatch_towards_semi-supervised_federated_learning_in_open-set_environments/"
...
**[CoLA: Co-Calibrated Logit Adjustment for Long-Tailed Semi-Supervised Learning](cola_co-calibrated_logit_adjustment_for_long-tailed_semi-supervised_learning.md)**
...
**[Contrastive Predictive Coding Done Right for Mutual Information Estimation](contrastive_predictive_coding_done_right_for_mutual_information_estimation.md)**
...
**[CSRv2: Unlocking Ultra-Sparse Embeddings](csrv2_unlocking_ultra-sparse_embeddings.md)**
...
**[Disentangled representation learning through unsupervised symmetry group discovery](disentangled_representation_learning_through_unsupervised_symmetry_group_discove.md)**
...
**[Diverse Dictionary Learning](diverse_dictionary_learning.md)**
...
**[Dual Perspectives on Non-Contrastive Self-Supervised Learning](dual_perspectives_on_non-contrastive_self-supervised_learning.md)**
...
**[Equivariant Splitting: Self-supervised learning from incomplete data](equivariant_splitting_self-supervised_learning_from_incomplete_data.md)**
...
**[FedOpenMatch: Towards Semi-Supervised Federated Learning in Open-Set Environments](fedopenmatch_towards_semi-supervised_federated_learning_in_open-set_environments.md)**
...
**[GUIDE: Gated Uncertainty-Informed Disentangled Experts for Long-tailed Recognition](guide_gated_uncertainty-informed_disentangled_experts_for_long-tailed_recognitio.md)**
...
**[Learning Dynamics of Logits Debiasing for Long-Tailed Semi-Supervised Learning](learning_dynamics_of_logits_debiasing_for_long-tailed_semi-supervised_learning.md)**
...
**[MaskCO: Masked Generation Drives Effective Representation Learning and Exploiting for Combinatorial Optimization](maskco_masked_generation_drives_effective_representation_learning_and_exploiting.md)**
...
**[Mechanistic Independence: A Principle for Identifiable Disentangled Representations](mechanistic_independence_a_principle_for_identifiable_disentangled_representatio.md)**
...
**[Midway Network: Learning Representations for Recognition and Motion from Latent Dynamics](midway_network_learning_representations_for_recognition_and_motion_from_latent_d.md)**
...
**[Mini-cluster Guided Long-tailed Deep Clustering](mini-cluster_guided_long-tailed_deep_clustering.md)**
...
**[Multimodality as Supervision: Self-Supervised Specialization to the Test Environment via Multimodality](multimodality_as_supervision_self-supervised_specialization_to_the_test_environm.md)**
...
**[NEO — No-Optimization Test-Time Adaptation through Latent Re-Centering](neo_no-optimization_test-time_adaptation_through_latent_re-centering.md)**
...
**[On the Alignment Between Supervised and Self-Supervised Contrastive Learning](on_the_alignment_between_supervised_and_self-supervised_contrastive_learning.md)**
...
**[One-Shot Exemplars for Class Grounding in Self-Supervised Learning](one-shot_exemplars_for_class_grounding_in_self-supervised_learning.md)**
...
**[OrthoRF: Exploring Orthogonality in Object-Centric Representations](orthorf_exploring_orthogonality_in_object-centric_representations.md)**
...
**[Part-level Semantic-guided Contrastive Learning for Fine-grained Visual Classification](part-level_semantic-guided_contrastive_learning_for_fine-grained_visual_classifi.md)**
...
**[PAS: Estimating the Target Accuracy Before Domain Adaptation](pas_estimating_the_target_accuracy_before_domain_adaptation.md)**
...
**[Plug-and-Play Compositionality for Boosting Continual Learning with Foundation Models](plug-and-play_compositionality_for_boosting_continual_learning_with_foundation_m.md)**
...
**[PredNext: Explicit Cross-View Temporal Prediction for Unsupervised Learning in Spiking Neural Networks](prednext_explicit_cross-view_temporal_prediction_for_unsupervised_learning_in_sp.md)**
...
**[PRISM: Progressive Robust Learning for Open-World Continual Category Discovery](prism_progressive_robust_learning_for_open-world_continual_category_discovery.md)**
...
**[PromptHub: Enhancing Multi-Prompt Visual In-Context Learning with Locality-Aware Fusion, Concentration and Alignment](prompthub_enhancing_multi-prompt_visual_in-context_learning_with_locality-aware_.md)**
...
**[Relationship Alignment for View-aware Multi-view Clustering](relationship_alignment_for_view-aware_multi-view_clustering.md)**
...
**[Representation Alignment for Diffusion Transformers without External Components](representation_alignment_for_diffusion_transformers_without_external_components.md)**
...
**[Rethinking JEPA: Compute-Efficient Video Self-Supervised Learning with Frozen Teachers](rethinking_jepa_computeefficient_video_self-supervised_learning_with_frozen_teac.md)**
...
**[Rethinking Unsupervised Cross-Modal Flow Estimation: Learning from Decoupled Optimization and Consistency Constraint](rethinking_unsupervised_cross-modal_flow_estimation_learning_from_decoupled_opti.md)**
...
**[SnaPhArd Contrast Learning](snaphard_contrast_learning.md)**
...
**[Spatial Structure and Selective Text Jointly Facilitate Image Clustering](spatial_structure_and_selective_text_jointly_facilitate_image_clustering.md)**
...
**[Spatially Informed Autoencoders for Interpretable Visual Representation Learning](spatially_informed_autoencoders_for_interpretable_visual_representation_learning.md)**
...
**[TrainRef: Curating Data with Label Distributions and Minimal Reference Samples for Accurate Prediction and Reliable Confidence](trainref_curating_data_with_label_distribution_and_minimal_reference_for_accurat.md)**
...
**[Two-Way is Better Than One: Bidirectional Alignment with Cycle Consistency for Exemplar-Free Class-Incremental Learning](two-way_is_better_than_one_bidirectional_alignment_with_cycle_consistency_for_ex.md)**
...
**[XIL: Cross-Expanding Incremental Learning](xil_cross-expanding_incremental_learning.md)**
...
**[ZeroSiam: An Efficient Asymmetry for Test-Time Entropy Optimization without Collapse](zerosiam_an_efficient_asymmetry_for_test-time_entropy_optimization_without_colla.md)**
