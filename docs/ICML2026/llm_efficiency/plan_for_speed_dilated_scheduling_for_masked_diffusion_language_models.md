...
description: >-
  [ICML 2026][LLM Efficiency][Masked Diffusion] This work proposes the Dilated Unmasking Scheduler (DUS): by using a "dilated, equidistant" predefined unmasking order that does not rely on model confidence…
tags:
  - "ICML 2026"
  - "LLM Efficiency"
  - "Masked Diffusion"
