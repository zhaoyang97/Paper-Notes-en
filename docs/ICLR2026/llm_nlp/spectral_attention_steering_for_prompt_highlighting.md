...
description: >-
  [ICLR 2026][LLM/NLP][attention steering] This paper proposes SEKA/AdaSEKA, which learns a "relevance subspace" via spectral decomposition of key embeddings and directly edits key vectors prior to attention computation to…
tags:
  - "ICLR 2026"
  - "LLM/NLP"
  - "attention steering"
