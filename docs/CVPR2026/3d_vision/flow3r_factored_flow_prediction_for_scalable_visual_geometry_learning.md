...
description: >-
  [CVPR2026][3D Vision][visual geometry] This paper proposes a **Factored Flow Prediction** module that predicts optical flow from the geometric latent of a source view and the pose latent of a target view…
tags:
  - "CVPR2026"
  - "3D Vision"
  - "visual geometry"
