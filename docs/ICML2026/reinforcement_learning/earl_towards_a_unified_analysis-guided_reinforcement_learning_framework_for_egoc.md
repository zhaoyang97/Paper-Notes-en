...
description: >-
  [ICML 2026][Reinforcement Learning][Ego-IRG] EARL employs a "coarse analysis–fine response" two-stage MLLM framework to unify egocentric interaction understanding tasks (description + QA + pixel mask) into a single pipel…
tags:
  - "ICML 2026"
