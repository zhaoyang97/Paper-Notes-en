...
description: >-
  [ACL 2026][Time Series][Time Leakage] This paper presents a systematic audit of Google and DuckDuckGo date filters, revealing that search engine date filtering fails severely in retrospective forecasting evaluations — 71% (Google) and 81% (DuckDuckGo) of questions have at least one result containing significant post-cutoff information leakage, inflating forecasting Brier scores from 0.24 down to 0.10.
tags:
  - ACL 2026
  - Time Series
  - Time Leakage
