...
description: >-
  [CVPR 2026][Image Generation][Visual Text Rendering] GlyphPrinter constructs a region-level glyph preference dataset (GlyphCorrector) and proposes Region-Grouped DPO (R-GDPO) to significantly improve glyph accuracy in vi…
tags:
  - "CVPR 2026"
  - "Image Generation"
