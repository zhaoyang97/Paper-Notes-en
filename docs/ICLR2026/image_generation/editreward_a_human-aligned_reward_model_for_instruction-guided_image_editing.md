...
**Starting Point**: Construct a large-scale, high-quality, multi-dimensional expert-annotated preference dataset and train a reward model specifically tailored to instruction-guided image editing.
