...
description: >-
  [ICLR 2026][LLM Safety][LLM unlearning] This paper reveals that LLM unlearning methods such as GA and NPO suffer from a *squeezing effect*—reducing the probability of a target response causes probability mass to redistri…
tags:
  - "ICLR 2026"
  - "LLM Safety"
  - "LLM unlearning"
