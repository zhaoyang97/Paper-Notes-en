...
description: >-
  [CVPR 2026][Object Detection][Few-shot anomaly detection] SubspaceAD demonstrates that fitting a single PCA model on features from a strong visual foundation model (DINOv2-G) is sufficient to outperform all few-shot anom…
tags:
  - "CVPR 2026"
  - "Object Detection"
