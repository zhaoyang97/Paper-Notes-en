...
description: >-
  [ICLR 2026][Reasoning][latent reasoning] KaVa compresses the KV-cache generated by a teacher model through explicit Chain-of-Thought (CoT) using redundancy-importance eviction, then distills it directly into the student's continuous implicit reasoning trajectory. By introducing "step-by-step KV alignment" as a new supervision signal, it provides internal step-wise supervision that has long been missing in implicit reasoning, achieving CoT-level accuracy with implicit reasonin…
tags:
  - "ICLR 2026"
  - "Reasoning"
  - "latent reasoning"
