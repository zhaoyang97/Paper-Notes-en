...
description: >-
  [ACL2026][Medical Imaging][clinical empathy] This paper proposes the Empathy Applicability Framework (EAF) to determine whether it is "appropriate" to express emotional reactions or interpretative understanding in single…
tags:
  - "ACL2026"
  - "Medical Imaging"
  - "clinical empathy"
...
- [\[NeurIPS 2025\] The Biased Oracle: Assessing LLMs' Understandability and Empathy in Medical Diagnoses](../../NeurIPS2025/medical_imaging/the_biased_oracle_assessing_llms_understandability_and_empathy_in_medical_diagno.md)
