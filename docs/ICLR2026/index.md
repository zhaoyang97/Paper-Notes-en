...
description: >-
  1527 ICLR2026 paper notes covering Image Generation (137), Reinforcement Learning (126), Model Compression (100), Multimodal VLM (85), LLM Reasoning (82), 3D Vision (61), Interpretability (60), LLM Safety (52) and other 49 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
[Browse all 40 LLM Agent papers →](llm_agent/)
...
[Browse all 36 LLM / NLP papers →](llm_nlp/)
...
## 🎨 Image Generation (137) { #image_generation }
...
[Browse all 137 Image Generation papers →](image_generation/)
...
[Browse all 61 3D Vision papers →](3d_vision/)
...
## 🏥 Medical Imaging (21) { #medical_imaging }
...
[Browse all 21 Medical Imaging papers →](medical_imaging/)

---

## ⚛️ Physics & Scientific Computing (16) { #physics }
...
[Browse all 16 Physics & Scientific Computing papers →](physics/)
...
[Browse all 73 Others papers →](others/)
