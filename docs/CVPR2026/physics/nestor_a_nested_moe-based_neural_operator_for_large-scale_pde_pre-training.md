...
description: >-
  [CVPR 2026][Physics & Scientific Computing][Neural Operator] NESTOR, a nested MoE-based neural operator, is proposed to capture global features across different PDE types via image-level MoE and local spatial correlation…
tags:
  - "CVPR 2026"
