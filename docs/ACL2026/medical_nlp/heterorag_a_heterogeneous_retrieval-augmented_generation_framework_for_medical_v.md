...
description: >-
  [ACL 2026][Medical NLP][Heterogeneous RAG] HeteroRAG constructs the MedAtlas knowledge base with 2.7 million image-text pairs and five types of corpora. It decomposes medical multimodal RAG into three components—ModCLIPs…
tags:
  - "ACL 2026"
  - "Medical NLP"
  - "Heterogeneous RAG"
