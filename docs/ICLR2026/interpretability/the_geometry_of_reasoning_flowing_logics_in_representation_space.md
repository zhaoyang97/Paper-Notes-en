...
**State of the Field**: Large language models (LLMs) exhibit remarkable capabilities across diverse reasoning tasks, yet the nature of their internal "reasoning" remains poorly understood. Mainstream interpretability research focuses on attention analysis, probing classifiers, and mechanistic interpretation (circuit analysis), but these approaches largely address local components rather than the global geometric structure of the reasoning process.
