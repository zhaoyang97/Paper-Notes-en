---
title: >-
  ICCV2025 Video Generation Papers · 49 Notes
description: >-
  49 ICCV2025 papers in the Video Generation area, covering Video Generation, Diffusion Models, Adversarial Robustness, Personalized Generation, Face & Gaze, Dynamic Scenes and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICCV2025"
  - "Video Generation"
  - "AI paper notes"
  ...
  - "Dynamic Scenes"
item_list:
  - u: "adversarial_distribution_matching_for_diffusion_distillation_towards_efficient_i/"
    t: "Adversarial Distribution Matching for Diffusion Distillation Towards Efficient Image and Video Synthesis"
  - u: "adversarial_distribution_matching_for_diffusion_distillation_towards_efficient_image_and_video_synthesis/"
    t: "Adversarial Distribution Matching for Diffusion Distillation Towards Efficient Image and Video Synthesis"
  - u: "aligning_moments_in_time_using_video_queries/"
    t: "Aligning Moments in Time using Video Queries"
  - u: "badvideo_stealthy_backdoor_attack_against_text-to-video_generation/"
    t: "BadVideo: Stealthy Backdoor Attack against Text-to-Video Generation"
  - u: "causal-entity_reflected_egocentric_traffic_accident_video_synthesis/"
    t: "Causal-Entity Reflected Egocentric Traffic Accident Video Synthesis"
  - u: "d3_training-free_ai-generated_video_detection_using_second-order_features/"
    t: "D3: Training-Free AI-Generated Video Detection Using Second-Order Features"
  - u: "dacon_dino_for_anime_paint_bucket_colorization_with_any_number_of_reference_imag/"
    t: "DACoN: DINO for Anime Paint Bucket Colorization with Any Number of Reference Images"
  - u: "decouple_and_track_benchmarking_and_improving_video_diffusion_transformers_for_m/"
    t: "Decouple and Track: Benchmarking and Improving Video Diffusion Transformers for Motion Transfer"
  - u: "dh-facevid-1k_a_large-scale_high-quality_dataset_for_face_video_generation/"
    t: "DH-FaceVid-1K: A Large-Scale High-Quality Dataset for Face Video Generation"
  - u: "disentangled_world_models_learning_to_transfer_semantic_knowledge_from_distracti/"
    t: "Disentangled World Models: Learning to Transfer Semantic Knowledge from Distracting Videos for Reinforcement Learning"
  - u: "dive_taming_dino_for_subject-driven_video_editing/"
    t: "DIVE: Taming DINO for Subject-Driven Video Editing"
  - u: "dollar_fewstep_video_generation_via_distillation_and_latent/"
    t: "DOLLAR: Few-Step Video Generation via Distillation and Latent Reward Optimization"
  - u: "dreamrelation_relation-centric_video_customization/"
    t: "DreamRelation: Relation-Centric Video Customization"
  - u: "dual-expert_consistency_model_for_efficient_and_high-quality_video_generation/"
    t: "Dual-Expert Consistency Model for Efficient and High-Quality Video Generation"
  - u: "dualreal_adaptive_joint_training_for_lossless_identity-motion_fusion_in_video_cu/"
    t: "DualReal: Adaptive Joint Training for Lossless Identity-Motion Fusion in Video Customization"
  - u: "efficientmt_efficient_temporal_adaptation_for_motion_transfer_in_text-to-video_d/"
    t: "EfficientMT: Efficient Temporal Adaptation for Motion Transfer in Text-to-Video Diffusion Models"
  - u: "etva_evaluation_of_text-to-video_alignment_via_fine-grained_question_generation_/"
    t: "ETVA: Evaluation of Text-to-Video Alignment via Fine-Grained Question Generation and Answering"
  - u: "free-form_motion_control_controlling_the_6d_poses_of_camera_and_objects_in_video/"
    t: "Free-Form Motion Control: Controlling the 6D Poses of Camera and Objects in Video Generation"
  - u: "fuxi-rtm_a_physics-guided_prediction_framework_with_radiative_transfer_modeling/"
    t: "FuXi-RTM: A Physics-Guided Prediction Framework with Radiative Transfer Modeling"
  - u: "fvgen_accelerating_novel-view_synthesis_with_adversarial_video_diffusion_distill/"
    t: "FVGen: Accelerating Novel-View Synthesis with Adversarial Video Diffusion Distillation"
  - u: "generating_fast_and_slow_scalable_parallel_video_generation_with_video_interface/"
  ...
  - u: "magicdrive-v2_high-resolution_long_video_generation_for_autonomous_driving_with_/"
    t: "MagicDrive-V2: High-Resolution Long Video Generation for Autonomous Driving with Adaptive Control"
  - u: "magicmirror_id-preserved_video_generation_in_video_diffusion_transformers/"
    t: "MagicMirror: ID-Preserved Video Generation in Video Diffusion Transformers"
  - u: "motionagent_fine-grained_controllable_video_generation_via_motion_field_agent/"
    t: "MotionAgent: Fine-grained Controllable Video Generation via Motion Field Agent"
  - u: "motionshot_adaptive_motion_transfer_across_arbitrary_objects_for_text-to-video_g/"
    t: "MotionShot: Adaptive Motion Transfer across Arbitrary Objects for Text-to-Video Generation"
  - u: "multi-identity_human_image_animation_with_structural_video_diffusion/"
