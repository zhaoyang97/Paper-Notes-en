...
description: >-
  [CVPR 2026][Multimodal VLM][Visual Reasoning] This paper proposes the DeepSketcher suite — comprising a 31k high-quality interleaved image-text CoT dataset built via code rendering and a self-contained Embedding Editor m…
tags:
  - "CVPR 2026"
  - "Multimodal VLM"
  - "Visual Reasoning"
