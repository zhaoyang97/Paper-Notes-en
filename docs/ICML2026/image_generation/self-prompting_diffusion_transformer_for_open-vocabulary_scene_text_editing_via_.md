...
description: >-
  [ICML 2026][Image Generation][MM-DiT] Ours proposes a self-prompting scene text editing method based on FLUX-Fill (MM-DiT). It directly crops style prompts from the original image and renders glyph prompts using Pillow. These prompts are concatenated channel-wise with the masked image and fed into the diffusion backbone. Following this, cooldown training i
tags:
  - ICML 2026
  - Image Generation
  - MM-DiT
date: 2026-05-08
content_hash: 42b48cf0b7cd4072
---
