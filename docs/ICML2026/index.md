...
**[Do Transformers Need Three Projections? A Systematic Study of QKV Sharing Systems](llm_efficiency/do_transformers_need_three_projections_systematic_study_of_qkv_variants.md)**
...
**[DOT-MoE: Transforming Dense LLMs into MoE with Differentiable Optimal Transport](llm_efficiency/dot-moe_differentiable_optimal_transport_for_moefication.md)**
...
**[GIST: Targeted Data Selection for Instruction Tuning with Gradient Subspace Projection](llm_alignment/gist_targeted_data_selection_for_instruction_tuning_via_coupled_optimization_geo.md)**
...
**["I've Seen How This Goes": Characterizing LLM vs. Human Writing Diversity using Progressive Conditional Surprisal](llm_nlp/ive_seen_how_this_goes_characterizing_diversity_via_progressive_conditional_surp.md)**
