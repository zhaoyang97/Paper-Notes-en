...
description: >-
  [ICLR 2026][LLM Alignment][Red-teaming] This paper systematically evaluates 4 jailbreak methods across 600+ attacker–target LLM pairs and finds that attack success rate (ASR) follows a sigmoid scaling law with respect to…
tags:
  - "ICLR 2026"
  - "LLM Alignment"
  - "Red-teaming"
