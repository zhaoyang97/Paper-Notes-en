...
description: >-
  [ICLR 2026][Image Generation][Offline Reinforcement Learning] This paper proposes Generative Trajectory Policies (GTP), which adopts a unified perspective treating diffusion models, flow matching…
tags:
  - "ICLR 2026"
  - "Image Generation"
