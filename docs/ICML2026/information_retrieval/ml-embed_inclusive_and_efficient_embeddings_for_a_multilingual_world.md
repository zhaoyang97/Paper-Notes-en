...
description: >-
  [ICML 2026][Information Retrieval & RAG][Matryoshka Representation Learning] ML-Embed extends the Matryoshka concept from one dimension (representation dimension) to **three dimensions**—embedding parameters (MEL)…
tags:
  - "ICML 2026"
