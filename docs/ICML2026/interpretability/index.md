---
title: >-
  ICML2026 Interpretability Papers · 80 Notes
description: >-
  80 ICML2026 papers in the Interpretability area, covering LLM, Alignment/RLHF, Reasoning, Layout & Composition, Self-Supervised Learning, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "Interpretability"
  - "AI paper notes"
...
**[MAAT: Knowledge-Guided Kernel Regression for Heterogeneous Partially Observed State Reconstruction](knowledge-informed_kernel_state_reconstruction_from_heterogeneous_partial_observ.md)**
...
:   This paper uses Causal Tracing to discover that "refusal" in LLMs is not a static vector of terminal tokens but a "Refusal Trajectory" spanning upstream intermediate layers and tokens. Based on this, the authors design **SALO**—a detector with <20M parameters trained only on standard alignment data. By exploiting the irreversibility of the Transformer's causal mask, SALO identifies adversarial attacks like GCG, AutoDAN, and Prefilling, increasing the detection rate for GCG/Prefilling from 0% to over 85%.
...
**[Universal 1/3 Time Scaling in Learning Peaked Distributions](universal_one-third_time_scaling_in_learning_peaked_distributions.md)**
...
**[Verified SHAP: Provable Bounds for Exact Shapley Values in Neural Networks](verified_shap_provable_bounds_for_exact_shapley_values_of_neural_networks.md)**
