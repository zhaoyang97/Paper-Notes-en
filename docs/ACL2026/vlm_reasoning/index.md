---
title: >-
  ACL2026 VLM Reasoning Papers · 32 Notes
description: >-
  32 ACL2026 papers in the VLM Reasoning area, covering Reasoning, Multimodal/VLM, LLM, Agents and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ACL2026"
  - "VLM Reasoning"
  - "AI paper notes"
...
item_list:
  ...
  - u: "errorradar_benchmarking_complex_mathematical_reasoning_of_multimodal_large_langu/"
    t: "ErrorRadar: Benchmarking Complex Mathematical Reasoning of Multimodal Large Language Models Via Error Detection"
  - u: "faithful-first_reasoning_planning_and_acting_for_multimodal_llms/"
    t: "Faithful-First Reasoning, Planning, and Acting for Multimodal LLMs"
  - u: "forest_before_trees_latent_superposition_for_efficient_visual_reasoning/"
    t: "Forest Before Trees: Latent Superposition for Efficient Visual Reasoning"
  - u: "geoarena_evaluating_open-world_geographic_reasoning_in_large_vision-language_mod/"
    t: "GeoArena: Evaluating Open-World Geographic Reasoning in Large Vision-Language Models"
  - u: "georc_a_benchmark_for_geolocation_reasoning_chains/"
    t: "GeoRC: A Benchmark for Geolocation Reasoning Chains"
  - u: "hierarchical_visual_agent_managing_contexts_in_joint_image-text_space_for_advanc/"
    t: "HierVA: Hierarchical Visual Agent — Managing Contexts in Joint Image-Text Space for Advanced Chart Reasoning"
  - u: "ireasoner_trajectory-aware_intrinsic_reasoning_supervision_for_self-evolving_lar/"
    t: "iReasoner: Trajectory-Aware Intrinsic Reasoning Supervision for Self-Evolving Large Multimodal Models"
  - u: "mmerror_a_benchmark_for_erroneous_reasoning_in_vision-language_models/"
    t: "MMErroR: A Benchmark for Erroneous Reasoning in Vision-Language Models"
  - u: "omhbench_benchmarking_balanced_and_grounded_omni-modal_multi-hop_reasoning/"
    t: "OMHBench: Benchmarking Balanced and Grounded Omni-Modal Multi-Hop Reasoning"
  - u: "omibench_benchmarking_olympiad-level_multi-image_reasoning_in_large_vision-langu/"
    t: "OMIBench: Benchmarking Olympiad-Level Multi-Image Reasoning in Large Vision-Language Models"
  - u: "position_multimodal_large_language_models_can_significantly_advance_scientific_r/"
    t: "Position: Multimodal Large Language Models Can Significantly Advance Scientific Reasoning"
  - u: "progresslm_towards_progress_reasoning_in_vision-language_models/"
    t: "PROGRESSLM: Towards Progress Reasoning in Vision-Language Models"
  - u: "scimdr_advancing_scientific_multimodal_document_reasoning/"
    t: "SciMDR: Advancing Scientific Multimodal Document Reasoning"
  - u: "shredbench_evaluating_the_semantic_reasoning_capabilities_of_multimodal_llms_in_/"
    t: "ShredBench: Evaluating the Semantic Reasoning Capabilities of Multimodal LLMs in Document Reconstruction"
  - u: "structured_and_abstractive_reasoning_on_multi-modal_relational_knowledge_images/"
    t: "Structured and Abstractive Reasoning on Multi-modal Relational Knowledge Images"
  - u: "tablevista_benchmarking_multimodal_table_reasoning_under_visual_and_structural_c/"
  ...
  - u: "thinking_like_a_botanist_challenging_multimodal_language_models_with_intent-driv/"
    t: "Thinking Like a Botanist: Challenging Multimodal Language Models with Intent-Driven Chain-of-Inquiry"
  - u: "unleashing_spatial_reasoning_in_multimodal_large_language_models_via_textual_rep/"
...
📌 **Same area in other venues:** [📷 CVPR2026 (150)](../../CVPR2026/vlm_reasoning/index.md) · [🔬 ICLR2026 (112)](../../ICLR2026/vlm_reasoning/index.md) · [🧪 ICML2026 (31)](../../ICML2026/vlm_reasoning/index.md) · [🤖 AAAI2026 (10)](../../AAAI2026/vlm_reasoning/index.md) · [🧠 NeurIPS2025 (30)](../../NeurIPS2025/vlm_reasoning/index.md) · [📹 ICCV2025 (15)](../../ICCV2025/vlm_reasoning/index.md)
