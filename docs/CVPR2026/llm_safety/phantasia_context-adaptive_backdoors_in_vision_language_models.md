...
description: >-
  [CVPR 2026][LLM Safety][Backdoor Attack] Phantasia introduces the first context-adaptive backdoor attack against VLMs. Rather than generating fixed malicious text…
tags:
  - "CVPR 2026"
  - "LLM Safety"
  - "Backdoor Attack"
