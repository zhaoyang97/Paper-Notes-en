...
- [\[NeurIPS 2025\] DualFocus: Depth from Focus with Spatio-Focal Dual Variational Constraints](dualfocus_depth_from_focus_with_spatio-focal_dual_variational_constraints.md)
