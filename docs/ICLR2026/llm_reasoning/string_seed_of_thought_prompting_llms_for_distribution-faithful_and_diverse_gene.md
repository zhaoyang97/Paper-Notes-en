...
description: >-
  [ICLR 2026][LLM Reasoning][prompting] This paper proposes String Seed of Thought (SSoT), a concise prompting method that instructs LLMs to first generate a random string and then extract randomness from it to select an a…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "prompting"
