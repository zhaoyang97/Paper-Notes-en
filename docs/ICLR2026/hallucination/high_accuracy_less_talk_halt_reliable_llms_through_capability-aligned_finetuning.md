...
description: >-
  [ICLR 2026][Hallucination Detection][Paper Note] HALT decomposes answers generated by the pre-trained model into "fact snippets" during the finetuning stage and uses a ground-truth-based evaluator to verify each snippet. It retains only the parts the model can correctly generate, replacing the rest with "Unsure from here," thereby training a reliable LLM that "only s
tags:
  - ICLR 2026
  - Hallucination Detection
date: 2026-05-08
content_hash: 7e9b83dc0ef2c3ba
---
