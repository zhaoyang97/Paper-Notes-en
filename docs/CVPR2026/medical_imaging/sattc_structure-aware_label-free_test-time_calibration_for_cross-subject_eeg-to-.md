...
description: >-
  [CVPR 2026][Medical Imaging][EEG decoding] This paper proposes SATTC, a label-free test-time calibration head that operates directly on the similarity matrix over frozen EEG and image encoders. It combines a geometric ex…
tags:
  - "CVPR 2026"
  - "Medical Imaging"
  - "EEG decoding"
