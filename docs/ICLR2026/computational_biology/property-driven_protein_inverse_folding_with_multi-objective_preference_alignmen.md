...
description: >-
  [ICLR 2026][Computational Biology][Paper Note] Ours proposes ProtAlign, a semi-online DPO framework with "elastic preference margins" to fine-tune pre-trained inverse folding models. It optimizes multiple conflicting "developability" attributes (solubility, thermal stability) while maintaining "designability" (sequence-to-structure fidelity). MoMPNN, implemented on
tags:
  - ICLR 2026
  - Computational Biology
date: 2026-05-08
content_hash: 1bc382ddd1142e8e
---
