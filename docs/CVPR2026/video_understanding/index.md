---
title: >-
  CVPR2026 Video Understanding Papers · 73 Notes
description: >-
  73 CVPR2026 papers in the Video Understanding area, covering Object Tracking, Agents, Reasoning, Compression, Adversarial Robustness, Multimodal/VLM and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2026"
  - "Video Understanding"
  - "AI paper notes"
...
item_list:
  ...
  - u: "autogaze_attend_before_attention_efficient_video/"
    t: "AutoGaze: Attend Before Attention — Efficient and Scalable Video Understanding via Autoregressive Gazing"
  ...
  - u: "drift-resilient_temporal_priors_for_visual_tracking/"
    t: "Drift-Resilient Temporal Priors for Visual Tracking"
  - u: "dual-agent_reinforcement_learning_for_adaptive_and_cost-aware_visual-inertial_od/"
    t: "Dual-Agent Reinforcement Learning for Adaptive and Cost-Aware Visual-Inertial Odometry"
  - u: "egoxtreme_a_dataset_for_robust_object_pose_estimation_in_egocentric_views_under_/"
    t: "EgoXtreme: A Dataset for Robust Object Pose Estimation in Egocentric Views under Extreme Conditions"
  - u: "enhancing_accuracy_of_uncertainty_estimation_in_appearance-based_gaze_tracking_w/"
    t: "Enhancing Accuracy of Uncertainty Estimation in Appearance-based Gaze Tracking with Probabilistic Evaluation and Calibration"
  - u: "envisioning_the_future_one_step_at_a_time/"
    t: "Envisioning the Future, One Step at a Time"
  - u: "event6d_event-based_novel_object_6d_pose_tracking/"
    t: "Event6D: Event-based Novel Object 6D Pose Tracking"
  - u: "fluxmem_adaptive_hierarchical_memory_for_streaming_video_understanding/"
    t: "FluxMem: Adaptive Hierarchical Memory for Streaming Video Understanding"
  - u: "frame2freq_spectral_adapters_for_fine-grained_video_understanding/"
    t: "Frame2Freq: Spectral Adapters for Fine-Grained Video Understanding"
  - u: "goal_force_teaching_video_models_to_accomplish_physics-conditioned_goals/"
    t: "GoalForce: Teaching Video Models to Accomplish Physics-Conditioned Goals"
  - u: "hear_what_matters_text-conditioned_selective_video-to-audio_generation/"
    t: "Hear What Matters! Text-conditioned Selective Video-to-Audio Generation"
  - u: "herbench_a_benchmark_for_multi-evidence_integration_in_video_question_answering/"
    t: "HERBench: A Benchmark for Multi-Evidence Integration in Video Question Answering"
  - u: "hieramamba_video_temporal_grounding_via_hierarchical_anchor-mamba_pooling/"
    t: "HieraMamba: Video Temporal Grounding via Hierarchical Anchor-Mamba Pooling"
  - u: "laof_robust_latent_action_learning_with_optical_flow_constraints/"
    t: "LAOF: Robust Latent Action Learning with Optical Flow Constraints"
  - u: "learning_to_assist_physics-grounded_human-human_control_via_multi-agent_reinforc/"
    t: "Learning to Assist: Physics-Grounded Human-Human Control via Multi-Agent Reinforcement Learning"
  - u: "lenswalk_agentic_video_understanding_by_planning_how_you_see_in_videos/"
    t: "LensWalk: Agentic Video Understanding by Planning How You See in Videos"
  - u: "longvideo-r1_smart_navigation_for_low-cost_long_video_understanding/"
    t: "LongVideo-R1: Smart Navigation for Low-cost Long Video Understanding"
  - u: "maskadapt_learning_flexible_motion_adaptation_via_mask-invariant_prior_for_physi/"
    t: "MaskAdapt: Learning Flexible Motion Adaptation via Mask-Invariant Prior for Physics-Based Characters"
  - u: "minerva-cultural_a_benchmark_for_cultural_and_multilingual_long_video_reasoning/"
    t: "MINERVA-Cultural: A Benchmark for Cultural and Multilingual Long Video Reasoning"
item_total: 73
---
...
🔥 **Top topics:** Object Tracking ×14 · Agents ×7 · Reasoning ×6 · Compression ×6 · Adversarial Robustness ×4
