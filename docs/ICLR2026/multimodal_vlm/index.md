---
title: >-
  ICLR2026 Multimodal VLM Papers · 211 Notes
description: >-
  211 ICLR2026 papers in the Multimodal VLM area, covering Multimodal/VLM, LLM, Alignment/RLHF, Few-/Zero-Shot Learning, Layout & Composition, Reinforcement Learning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
  - "Multimodal VLM"
  - "AI paper notes"
...
item_list:
  ...
  - u: "asciieval_benchmarking_models_visual_perception_in_text_strings_via_ascii_art/"
    t: "ASCIIEval: Benchmarking Models' Visual Perception in Text Strings via ASCII Art"
  ...
  - u: "atttok_marrying_attribute_tokens_with_generative_pre-trained_vision-language_mod/"
    t: "AttTok: Marrying Attribute Tokens with Generative Pre-trained Vision-Language Models towards Medical Image Understanding"
  - u: "basereward_a_strong_baseline_for_multimodal_reward_model/"
    t: "BaseReward: A Strong Baseline for Multimodal Reward Model"
  - u: "bee_a_high-quality_corpus_and_full-stack_suite_to_unlock_advanced_fully_open_mll/"
    t: "Bee: A High-Quality Corpus and Full-Stack Suite to Unlock Advanced Fully Open MLLMs"
  - u: "benchmarking_large_vision-language_models_on_fine-grained_image_tasks_a_comprehe/"
    t: "Benchmarking Large Vision-Language Models on Fine-Grained Image Tasks: A Comprehensive Evaluation"
  ...
  - u: "bongard-rwr_real-world_representations_of_fine-grained_concepts_in_bongard_probl/"
    t: "Bongard-RWR+: Real-World Representations of Fine-Grained Concepts in Bongard Problems"
  ...
  - u: "cad-tokenizer_towards_text-based_cad_prototyping_via_modality-specific_tokenizat/"
    t: "CAD-Tokenizer: Towards Text-Based CAD Prototyping via Modality-Specific Tokenization"
  ...
  - u: "caprl_stimulating_dense_image_caption_capabilities_via_reinforcement_learning/"
    t: "CapRL: Stimulating Dense Image Capabilities via Reinforcement Learning"
  ...
  - u: "catching_the_details_self-distilled_roi_predictors_for_fine-grained_mllm_percept/"
    t: "Catching the Details: Self-Distilled RoI Predictors for Fine-Grained MLLM Perception"
  - u: "chartgalaxy_a_dataset_for_infographic_chart_understanding_and_generation/"
    t: "ChartGalaxy: A Dataset for Infographic Chart Understanding and Generation"
  ...
  - u: "clip-fmoe_scalable_clip_via_fused_mixture-of-experts_with_enforced_specializatio/"
    t: "CLIP-FMoE: Scalable CLIP via Fused Mixture-of-Experts with Enforced Specialization"
  - u: "closing_the_modality_gap_aligns_group-wise_semantics/"
    t: "Closing the Modality Gap Aligns Group-Wise Semantics"
  - u: "cogmoe_signal-qualityguided_multimodal_moe_for_cognitive_load_prediction/"
    t: "CogMoE: Signal-Quality–Guided Multimodal MoE for Cognitive Load Prediction"
  - u: "comem_compositional_concept-graph_memory_for_visionlanguage_adaptation/"
    t: "CoMem: Compositional Concept-Graph Memory for Vision-Language Adaptation"
  - u: "constructive_distortion_improving_mllms_with_attention-guided_image_warping/"
    t: "Constructive Distortion: Improving MLLMs with Attention-Guided Image Warping"
  - u: "context_tokens_are_anchors_understanding_the_repeat_curse_in_dmllms_from_an_info/"
    t: "Context Tokens are Anchors: Understanding the Repeat Curse in dMLLMs from an Information Flow Perspective"
  - u: "contextnav_towards_agentic_multimodal_in-context_learning/"
    t: "ContextNav: Towards Agentic Multimodal In-Context Learning"
item_total: 211
---
...
**[ASCIIEval: Benchmarking Models' Visual Perception in Text Strings via ASCII Art](asciieval_benchmarking_models_visual_perception_in_text_strings_via_ascii_art.md)**
...
**[AttTok: Marrying Attribute Tokens with Generative Pre-trained Vision-Language Models towards Medical Image Understanding](atttok_marrying_attribute_tokens_with_generative_pre-trained_vision-language_mod.md)**
...
**[Bee: A High-Quality Corpus and Full-Stack Suite to Unlock Advanced Fully Open MLLMs](bee_a_high-quality_corpus_and_full-stack_suite_to_unlock_advanced_fully_open_mll.md)**
...
**[Benchmarking Large Vision-Language Models on Fine-Grained Image Tasks: A Comprehensive Evaluation](benchmarking_large_vision-language_models_on_fine-grained_image_tasks_a_comprehe.md)**
...
**[CAD-Tokenizer: Towards Text-Based CAD Prototyping via Modality-Specific Tokenization](cad-tokenizer_towards_text-based_cad_prototyping_via_modality-specific_tokenizat.md)**
...
**[CapRL: Stimulating Dense Image Capabilities via Reinforcement Learning](caprl_stimulating_dense_image_caption_capabilities_via_reinforcement_learning.md)**
...
**[Catching the Details: Self-Distilled RoI Predictors for Fine-Grained MLLM Perception](catching_the_details_self-distilled_roi_predictors_for_fine-grained_mllm_percept.md)**
...
**[ChartGalaxy: A Dataset for Infographic Chart Understanding and Generation](chartgalaxy_a_dataset_for_infographic_chart_understanding_and_generation.md)**
...
**[CLIP-FMoE: Scalable CLIP via Fused Mixture-of-Experts with Enforced Specialization](clip-fmoe_scalable_clip_via_fused_mixture-of-experts_with_enforced_specializatio.md)**
...
**[CogMoE: Signal-Quality–Guided Multimodal MoE for Cognitive Load Prediction](cogmoe_signal-qualityguided_multimodal_moe_for_cognitive_load_prediction.md)**
...
**[CoMem: Compositional Concept-Graph Memory for Vision-Language Adaptation](comem_compositional_concept-graph_memory_for_visionlanguage_adaptation.md)**
...
**[Context Tokens are Anchors: Understanding the Repeat Curse in dMLLMs from an Information Flow Perspective](context_tokens_are_anchors_understanding_the_repeat_curse_in_dmllms_from_an_info.md)**
...
**[ContextNav: Towards Agentic Multimodal In-Context Learning](contextnav_towards_agentic_multimodal_in-context_learning.md)**
...
**[DAVE: A VLM Vision Encoder for Document Understanding and Web Agents](dave_a_vlm_vision_encoder_for_document_understanding_and_web_agents.md)**
...
**[DaVinci: Reinforcing Visual-Structural Syntax in MLLMs for Generalized Scientific Diagram Parsing](davinci_reinforcing_visual-structural_syntax_in_mllms_for_generalized_scientific.md)**
...
**[DecAlign: Hierarchical Cross-Modal Alignment for Decoupled Multimodal Representation Learning](decalign_hierarchical_cross-modal_alignment_for_decoupled_multimodal_representat.md)**
...
**[Decoupling Primitive with Experts: Dynamic Feature Alignment for Compositional Zero-Shot Learning](decoupling_primitive_with_experts_dynamic_feature_alignment_for_compositional_ze.md)**
...
**[DeepEyesV2: Toward Agentic Multimodal Model](deepeyesv2_toward_agentic_multimodal_model.md)**
...
**[Delving into Spectral Clustering with Vision-Language Representations](delving_into_spectral_clustering_with_vision-language_representations.md)**
...
**[DataProphet: Demystifying Supervision Data Generalization in Multimodal LLMs](demystifying_supervision_data_generalization_in_multimodal_lms.md)**
...
**[Distributional Vision-Language Alignment by Cauchy-Schwarz Divergence](distributional_vision-language_alignment_by_cauchy-schwarz_divergence.md)**
...
**[DualToken: Towards Unifying Visual Understanding and Generation with Dual Visual Vocabularies](dualtoken_towards_unifying_visual_understanding_and_generation_with_dual_visual_.md)**
...
**[Endowing GPT-4 with a Humanoid Body: Building the Bridge Between Off-the-Shelf VLMs and the Physical World](endowing_gpt-4_with_a_humanoid_body_building_the_bridge_between_off-the-shelf_vl.md)**
...
**[Enhancing Geometric Perception in VLMs via Translator-Guided Reinforcement Learning](enhancing_geometric_perception_in_vlms_via_translator-guided_reinforcement_learn.md)**
...
**[ERGO: Efficient High-Resolution Visual Understanding for Vision-Language Models](ergo_efficient_high-resolution_visual_understanding_for_vision-language_models.md)**
...
**[EventFlash: Towards Efficient MLLMs for Event-Based Vision](eventflash_towards_efficient_mllms_for_event-based_vision.md)**
...
**[Exploring Cross-Modal Flows for Few-Shot Learning](exploring_cross-modal_flows_for_few-shot_learning.md)**
...
**[Fed-Duet: Dual Expert-Orchestrated Framework for Continual Federated Vision-Language Learning](fed-duet_dual_expert-orchestrated_framework_for_continual_federated_vision-langu.md)**
...
**[Figma2Code: Automating Multimodal Design to Code in the Wild](figma2code_automating_multimodal_design_to_code_in_the_wild.md)**
...
**[FLARE: Fully Integration of Vision-Language Representations for Deep Cross-Modal Understanding](flare_fully_integration_of_vision-language_representations_for_deep_cross-modal_.md)**
...
**[Flatness-Guided Test-Time Adaptation for Vision-Language Models](flatness_guided_test-time_adaptation_for_vision-language_models.md)**
...
**[FlowBind: Efficient Any-to-Any Generation with Bidirectional Flows](flowbind_efficient_any-to-any_generation_with_bidirectional_flows.md)**
...
**[From Pixels to Words -- Towards Native Vision-Language Primitives at Scale](from_pixels_to_words_--_towards_native_vision-language_primitives_at_scale.md)**
...
**[GeoBench: Rethinking Multimodal Geometric Problem-Solving via Hierarchical Evaluation](geobench_rethinking_multimodal_geometric_problem-solving_via_hierarchical_evalua.md)**
...
**[GPT4Scene: Understand 3D Scenes from Videos with Vision-Language Models](gpt4scene_understand_3d_scenes_from_videos_with_vision-language_models.md)**
...
**[GranViT: A Fine-Grained Vision Model For Autoregressive Multimodal Large Language Models](granvit_a_fine-grained_vision_model_for_autoregressive_multimodal_large_language.md)**
...
**[Guided Query Refinement: Multimodal Hybrid Retrieval with Test-Time Optimization](guided_query_refinement_multimodal_hybrid_retrieval_with_test-time_optimization.md)**
...
**[GuirlVG: Incentivize GUI Visual Grounding via Empirical Exploration on Reinforcement Learning](guirlvg_incentivize_gui_visual_grounding_via_empirical_exploration_on_reinforcem.md)**
...
**[HSSBench: Benchmarking Humanities and Social Sciences Ability for Multimodal Large Language Models](hssbench_benchmarking_humanities_and_social_sciences_ability_for_multimodal_larg.md)**
...
**[Human-MME: A Holistic Evaluation Benchmark for Human-Centric Multimodal Large Language Models](human-mme_a_holistic_evaluation_benchmark_for_human-centric_multimodal_large_lan.md)**
...
**[Human Uncertainty-Aware Data Selection and Automatic Labeling in Visual Question Answering](human_uncertainty-aware_data_selection_and_automatic_labeling_in_visual_question.md)**
...
**[HumanPCR: Probing MLLM Capabilities in Diverse Human-Centric Scenes](humanpcr_probing_mllm_capabilities_in_diverse_human-centric_scenes.md)**
...
**[Importance Sampling for Multi-Negative Multimodal Direct Preference Optimization](importance_sampling_for_multi-negative_multimodal_direct_preference_optimization.md)**
...
**[IndicVisionBench: Benchmarking Cultural and Multilingual Understanding in VLMs](indicvisionbench_benchmarking_cultural_and_multilingual_understanding_in_vlms.md)**
...
**[InSight-o3: Empowering Multimodal Foundation Models with Generalized Visual Search](insight-o3_empowering_multimodal_foundation_models_with_generalized_visual_searc.md)**
...
**[InternSVG: Towards Unified SVG Tasks with Multimodal Large Language Models](internsvg_towards_unified_svg_tasks_with_multimodal_large_language_models.md)**
...
**[Investigating Redundancy in Multimodal Large Language Models with Multiple Vision Encoders](investigating_redundancy_in_multimodal_large_language_models_with_multiple_visio.md)**
...
**[IWR-Bench: Can LVLMs Reconstruct Interactive Webpage from a User Interaction Video?](iwr-bench_can_lvlms_reconstruct_interactive_webpage_from_a_user_interaction_vide.md)**
...
**[Kaleidoscope: In-language Exams for Massively Multilingual Vision Evaluation](kaleidoscope_in-language_exams_for_massively_multilingual_vision_evaluation.md)**
...
**[Knowledge Exchange with Confidence: Cost-Effective LLM Integration for Reliable and Efficient Visual Question Answering](knowledge_exchange_with_confidence_cost-effective_llm_integration_for_reliable_a.md)**
...
**[Label-Free Mitigation of Spurious Correlations in VLMs using Sparse Autoencoders](label-free_mitigation_of_spurious_correlations_in_vlms_using_sparse_autoencoders.md)**
...
**[Language-Instructed Vision Embeddings for Controllable and Generalizable Perception](language-instructed_vision_embeddings_for_controllable_and_generalizable_percept.md)**
...
**[Lavida-O: Elastic Large Masked Diffusion Models for Unified Multimodal Understanding and Generation](lavida-o_elastic_large_masked_diffusion_models_for_unified_multimodal_understand.md)**
...
**[LEGATO: Large-scale End-to-end Generalizable Approach to Typeset OMR](legato_large-scale_end-to-end_generalizable_approach_to_typeset_omr.md)**
...
**[LLaVA-4D: Embedding SpatioTemporal Prompt into LMMs for 4D Scene Understanding](llava-4d_embedding_spatiotemporal_prompt_into_lmms_for_4d_scene_understanding.md)**
...
**[Long-tailed Test-Time Adaptation for Vision-Language Models](long-tailed_test-time_adaptation_for_vision-language_models.md)**
...
**[Manzano: A Simple and Scalable Unified Multimodal Model with a Hybrid Vision Tokenizer](manzano_a_simple_and_scalable_unified_multimodal_model_with_a_hybrid_vision_toke.md)**
...
**[MaskInversion: Localized Embeddings via Optimization of Explainability Maps](maskinversion_localized_embeddings_via_optimization_of_explainability_maps.md)**
...
**[Massively Multimodal Foundation Models: A Framework for Capturing Interactions with Specialized Mixture-of-Experts](massively_multimodal_foundation_models_a_framework_for_capturing_interactions_wi.md)**
...
**[MCIF: Multimodal Crosslingual Instruction-Following Benchmark from Scientific Talks](mcif_multimodal_crosslingual_instruction-following_benchmark_from_scientific_tal.md)**
...
**[Memory-Free Continual Learning with Null Space Adaptation for Zero-Shot Vision-Language Models](memory-free_continual_learning_with_null_space_adaptation_for_zero-shot_vision-l.md)**
...
**[MergeTune: Continued Fine-Tuning of Vision-Language Models](mergetune_continued_fine-tuning_of_vision-language_models.md)**
...
**[MetaCaptioner: Towards Generalist Visual Captioning with Open-source Suites](metacaptioner_towards_generalist_visual_captioning_with_open-source_suites.md)**
...
**[MIAM: Modality Imbalance-Aware Masking for Multimodal Ecological Applications](miam_modality_imbalance-aware_masking_for_multimodal_ecological_applications.md)**
...
**[MMDuet2: Enhancing Proactive Interaction of Video MLLMs with Multi-Turn Reinforcement Learning](mmduet2_enhancing_proactive_interaction_of_video_mllms_with_multi-turn_reinforce.md)**
...
**[MME-Emotion: A Holistic Evaluation Benchmark for Emotional Intelligence in Multimodal Large Language Models](mme-emotion_a_holistic_evaluation_benchmark_for_emotional_intelligence_in_multim.md)**
...
**[MME-Unify: A Comprehensive Benchmark for Unified Multimodal Understanding and Generation Models](mme-unify_a_comprehensive_benchmark_for_unified_multimodal_understanding_and_gen.md)**
...
**[MMSI-Bench: A Benchmark for Multi-Image Spatial Intelligence](mmsi-bench_a_benchmark_for_multi-image_spatial_intelligence.md)**
...
**[Modality Alignment across Trees on Heterogeneous Hyperbolic Manifolds](modality_alignment_across_trees_on_heterogeneous_hyperbolic_manifolds.md)**
...
**[MoRA: Missing Modality Low-Rank Adaptation for Visual Recognition](mora_missing_modality_low-rank_adaptation_for_visual_recognition.md)**
...
**[Mordal: Automated Pretrained Model Selection for Vision Language Models](mordal_automated_pretrained_model_selection_for_vision_language_models.md)**
...
**[MotionSight: Boosting Fine-Grained Motion Understanding in Multimodal LLMs](motionsight_boosting_fine-grained_motion_understanding_in_multimodal_llms.md)**
...
**[Multimodal Aligned Semantic Knowledge for Unpaired Image-text Matching](multimodal_aligned_semantic_knowledge_for_unpaired_image-text_matching.md)**
...
**[Multimodal Dataset Distillation via Phased Teacher Models](multimodal_dataset_distillation_via_phased_teacher_models.md)**
...
**[Multimodal Policy Internalization for Conversational Agents](multimodal_policy_internalization_for_conversational_agents.md)**
...
**[Naming to Learn: Class Incremental Learning for Vision-Language Model with Unlabeled Data](naming_to_learn_class_incremental_learning_for_vision-language_model_with_unlabe.md)**
...
**[NExT-OMNI: Towards Any-to-Any Omnimodal Foundation Models with Discrete Flow Matching](next-omni_towards_any-to-any_omnimodal_foundation_models_with_discrete_flow_matc.md)**
...
**[ODI-Bench: Can MLLMs Understand Immersive Omnidirectional Environments?](odi-bench_can_mllms_understand_immersive_omnidirectional_environments.md)**
...
**[Omni-Captioner: Data Pipeline, Models, and Benchmark for Omni Detailed Perception](omni-captioner_data_pipeline_models_and_benchmark_for_omni_detailed_perception.md)**
...
**[Omni-Weather: A Unified Multimodal Model for Weather Radar Understanding and Generation](omni-weather_a_unified_multimodal_model_for_weather_radar_understanding_and_gene.md)**
...
**[OmniVideoBench: Towards Audio-Visual Understanding Evaluation for Omni MLLMs](omnivideobench_towards_audio-visual_understanding_evaluation_for_omni_mllms.md)**
...
**[OmniVinci: Enhancing Architecture and Data for Omni-Modal Understanding LLM](omnivinci_enhancing_architecture_and_data_for_omni-modal_understanding_llm.md)**
...
**[On Discriminative vs. Generative Classifiers: Rethinking MLLMs for Action Understanding](on_discriminative_vs_generative_classifiers_rethinking_mllms_for_action_understa.md)**
...
**[One Patch Doesn't Fit All: Adaptive Patching for Native-Resolution Multimodal Large Language Models](one_patch_doesnt_fit_all_adaptive_patching_for_native-resolution_multimodal_larg.md)**
...
**[OptMerge: Unifying Multimodal LLM Capabilities and Modalities via Model Merging](optmerge_unifying_multimodal_llm_capabilities_and_modalities_via_model_merging.md)**
...
**[ORION: Decoupling and Alignment for Unified Autoregressive Understanding and Generation](orion_decoupling_and_alignment_for_unified_autoregressive_understanding_and_gene.md)**
...
**[P2P: Automated Paper-to-Poster Generation and Fine-Grained Benchmark](p2p_automated_paper-to-poster_generation_and_fine-grained_benchmark.md)**
...
**[Patch-as-Decodable-Token: Towards Unified Multi-Modal Vision Tasks in MLLMs](patch-as-decodable-token_towards_unified_multi-modal_vision_tasks_in_mllms.md)**
...
**[Pay Less Attention to Function Words for Free Robustness of Vision-Language Models](pay_less_attention_to_function_words_for_free_robustness_of_vision-language_mode.md)**
...
**[PCLR: Progressively Compressed LoRA for Multimodal Continual Instruction Tuning](pclr_progressively_compressed_lora_for_multimodal_continual_instruction_tuning.md)**
...
**[pFedMMA: Personalized Federated Fine-Tuning with Multi-Modal Adapter for Vision-Language Models](pfedmma_personalized_federated_fine-tuning_with_multi-modal_adapter_for_vision-l.md)**
...
**[PHyCLIP: $\ell_1$-Product of Hyperbolic Factors Unifies Hierarchy and Compositionality in Vision-Language Representation Learning](phyclip_ell_1-product_of_hyperbolic_factors_unifies_hierarchy_and_compositionali.md)**
...
**[PhysLLM: Harnessing Large Language Models for Cross-Modal Remote Physiological Sensing](physllm_harnessing_large_language_models_for_cross-modal_remote_physiological_se.md)**
...
**[PI-CCA: Prompt-Invariant CCA Certificates for Replay-Free Continual Multimodal Learning](pi-cca_prompt-invariant_cca_certificates_for_replay-free_continual_multimodal_le.md)**
...
**[Plug, Play, and Fortify: A Low-Cost Module for Robust Multimodal Image Understanding](plug_play_and_fortify_a_low-cost_module_for_robust_multimodal_image_understandin.md)**
...
**[Preserve and Sculpt: Manifold-Aligned Fine-tuning of Vision-Language Models for Few-Shot Learning](preserve_and_sculpt_manifold-aligned_fine-tuning_of_vision-language_models_for_f.md)**
...
**[Prompt-Robust Vision-Language Models via Meta-Finetuning](prompt-robust_vision-language_models_via_meta-finetuning.md)**
...
**[PSP: Prompt-Guided Self-Training Sampling Policy for Active Prompt Learning](psp_prompt-guided_self-training_sampling_policy_for_active_prompt_learning.md)**
...
**[QLIP: A Dynamic Quadtree Vision Prior Enhances MLLM Performance Without Retraining](qlip_a_dynamic_quadtree_vision_prior_enhances_mllm_performance_without_retrainin.md)**
...
**[RAG4DMC: Retrieval-Augmented Generation for Data-Level Modality Completion](rag4dmc_retrieval-augmented_generation_for_data-level_modality_completion.md)**
...
**[RAR: Reversing Visual Attention Re-Sinking for Unlocking Potential in Multimodal Large Language Models](rar_reversing_visual_attention_re-sinking_for_unlocking_potential_in_multimodal_.md)**
...
**[Reading Images Like Texts: Sequential Image Understanding in Vision-Language Models](reading_images_like_texts_sequential_image_understanding_in_vision-language_mode.md)**
...
**[Reconstruction Alignment Improves Unified Multimodal Models](reconstruction_alignment_improves_unified_multimodal_models.md)**
...
**[Rethinking Causal Mask Attention for Vision-Language Inference](rethinking_causal_mask_attention_for_vision-language_inference.md)**
...
**[Reversible Primitive–Composition Alignment for Continual Vision–Language Learning](reversible_primitivecomposition_alignment_for_continual_visionlanguage_learning.md)**
...
**[Revisiting Confidence Calibration for Misclassification Detection in VLMs](revisiting_confidence_calibration_for_misclassification_detection_in_vlms.md)**
...
**[Revisiting Multimodal Positional Encoding in Vision-Language Models](revisiting_multimodal_positional_encoding_in_visionlanguage_models.md)**
...
**[RL Makes MLLMs See Better Than SFT](rl_makes_mllms_see_better_than_sft.md)**
...
**[RLAP-CLIP: Continual Multimodal Learning with Prototype Adaptation and Difficulty-Aware Routing](rlap-clip_continual_multimodal_learning_with_prototype_adaptation_and_difficulty.md)**
...
**[ScaleCap: Scalable Image Captioning via Dual-Modality Debiasing](scalecap_scalable_image_captioning_via_dual-modality_debiasing.md)**
...
**[Seeing Through Deception: Uncovering Misleading Creator Intent in Multimodal News with Vision-Language Models](seeing_through_deception_uncovering_misleading_creator_intent_in_multimodal_news.md)**
...
**[Seeing What's Not There: Negation Understanding Needs More Than Training](seeing_whats_not_there_negation_understanding_needs_more_than_training.md)**
...
**[SigLIP-HD by Fine-to-Coarse Supervision](siglip-hd_by_fine-to-coarse_supervision.md)**
...
**[Simulation to Rules: A Dual-VLM Framework for Formal Visual Planning](simulation_to_rules_a_dual-vlm_framework_for_formal_visual_planning.md)**
...
**[SpaCE-10: A Comprehensive Benchmark for Multimodal Large Language Models in Compositional Spatial Intelligence](space-10_a_comprehensive_benchmark_for_multimodal_large_language_models_in_compo.md)**
...
**[SpatialViz-Bench: A Cognitive Science-Driven Benchmark for Diagnosing the Spatial Visualization Capabilities of MLLMs](spatialviz-bench_a_cognitively-grounded_benchmark_for_diagnosing_spatial_visuali.md)**
...
**[SPECS: Decoupling Multimodal Learning via Self-distilled Preference-based Cold Start](specs_decoupling_multimodal_learning_via_self-distilled_preference-based_cold_st.md)**
...
**[StreamingVLM: Real-Time Understanding for Infinite Video Streams](streamingvlm_real-time_understanding_for_infinite_video_streams.md)**
...
**[Supporting Multimodal Intermediate Fusion with Informatic Constraint and Distribution Coherence](supporting_multimodal_intermediate_fusion_with_informatic_constraint_and_distrib.md)**
...
**[TABLET: A Large-Scale Dataset for Robust Visual Table Understanding](tablet_a_large-scale_dataset_for_robust_visual_table_understanding.md)**
...
**[Talking Points: Describing and Localizing Pixels](talking_points_describing_and_localizing_pixels.md)**
...
**[Teaching VLMs to Admit Uncertainty in OCR from Lossy Visual Inputs](teaching_vlms_to_admit_uncertainty_in_ocr_from_lossy_visual_inputs.md)**
...
**[The Unseen Bias: How Norm Discrepancy in Pre-Norm MLLMs Leads to Visual Information Loss](the_unseen_bias_how_norm_discrepancy_in_pre-norm_mllms_leads_to_visual_informati.md)**
...
**[Thinking as Society: Multi-Social-Agent Self-Distillation for Multimodal Misinformation Detection](thinking_as_society_multi-social-agent_self-distillation_for_multimodal_misinfor.md)**
...
**[Thinking with Camera: A Unified Multimodal Model for Camera-Centric Understanding and Generation](thinking_with_camera_a_unified_multimodal_model_for_camera-centric_understanding.md)**
...
**[Threading Keyframe with Narratives: MLLMs as Strong Long Video Comprehenders](threading_keyframe_with_narratives_mllms_as_strong_long_video_comprehenders.md)**
...
**[Turning Internal Gap into Self-Improvement: Promoting the Generation-Understanding Unification in MLLMs](turning_internal_gap_into_self-improvement_promoting_the_generation-understandin.md)**
...
**[UniF2ace: A Unified Fine-grained Face Understanding and Generation Model](unif2ace_a_underlineunified_underlinefine-grained_underlineface_understanding_an.md)**
...
**[UniLIP: Revamping CLIP to Unify Multimodal Understanding, Generation, and Editing](unilip_adapting_clip_for_unified_multimodal_understanding_generation_and_editing.md)**
...
**[Unlocking the Power of Co-Occurrence in CLIP: A DualPrompt-Driven Method for Training-Free Zero-Shot Multi-Label Classification](unlocking_the_power_of_co-occurrence_in_clip_a_dualprompt-driven_method_for_trai.md)**
...
**[UrbanFeel: A Comprehensive Benchmark for Temporal and Perceptual Understanding of City Scenes through Human Perspective](urbanfeela_comprehensive_benchmark_for_temporal_and_perceptual_understanding_of_.md)**
...
**[VaseVQA-3D: Benchmarking 3D VLMs on Ancient Greek Pottery](vasevqa-3d_benchmarking_3d_vlms_on_ancient_greek_pottery.md)**
...
**[VideoChat-Flash: Hierarchical Compression for Long-Context Video Modeling](videochat-flash_hierarchical_compression_for_long-context_video_modeling.md)**
...
**[ViPER: Empowering the Self-Evolution of Visual Perception Abilities in Vision-Language Models](viper_empowering_the_self-evolution_of_visual_perception_abilities_in_vision-lan.md)**
...
**[VisCodex: Unified Multimodal Code Generation via Merging Vision and Coding Models](viscodex_unified_multimodal_code_generation_via_merging_vision_and_coding_models.md)**
...
**[Vision-Zero: Scalable VLM Self-Evolution via Multi-Agent Self-Play](vision-zero_scalable_vlm_self-evolution_via_multi-agent_self-play.md)**
...
**[Vision Language Models are Biased](vision_language_models_are_biased.md)**
...
**[Visual Compositional Tuning](visual_compositional_tuning.md)**
...
**[Visual Jigsaw Post-Training Improves MLLMs](visual_jigsaw_post-training_improves_mllms.md)**
...
**[Visual Self-Refine: A Pixel-Guided Paradigm for Accurate Chart Parsing](visual_self-refine_a_pixel-guided_paradigm_for_accurate_chart_parsing.md)**
...
**[VL-JEPA: Joint Embedding Predictive Architecture for Vision-language](vl-jepa_joint_embedding_predictive_architecture_for_vision-language.md)**
...
**[VLSU: Mapping the Limits of Joint Multimodal Understanding for AI Safety](vlsu_mapping_the_limits_of_joint_multimodal_understanding_for_ai_safety.md)**
...
**[WAVE: Learning Unified & Versatile Audio-Visual Embeddings with Multimodal LLM](wave_learning_unified_versatile_audio-visual_embeddings_with_multimodal_llm.md)**
...
**[WebWatcher: Breaking New Frontiers of Vision-Language Deep Research Agent](webwatcher_breaking_new_frontiers_of_vision-language_deep_research_agent.md)**
...
**[When MLLMs Meet Compression Distortion: A Coding Paradigm Tailored to MLLMs](when_mllms_meet_compression_distortion_a_coding_paradigm_tailored_to_mllms.md)**
...
**[Why Keep Your Doubts to Yourself? Trading Visual Uncertainties among Vision-Language Models](why_keep_your_doubts_to_yourself_trading_visual_uncertainties_among_vision-langu.md)**
...
**[WorldSense: Evaluating Real-World Omnimodal Understanding for Multimodal LLMs](worldsense_evaluating_real-world_omnimodal_understanding_for_multimodal_llms.md)**
...
**[XModBench: Benchmarking Cross-Modal Capabilities and Consistency in Omni-Language Models](xmodbench_benchmarking_cross-modal_capabilities_and_consistency_in_omni-language.md)**
