...
description: >-
  [ACL 2026][Medical Imaging][fMRI Language Reconstruction] This paper proposes PredFT, an end-to-end fMRI-to-Text decoding model that combines a main network (language decoding) and a side network (brain predictive coding…
tags:
  - "ACL 2026"
  - "Medical Imaging"
