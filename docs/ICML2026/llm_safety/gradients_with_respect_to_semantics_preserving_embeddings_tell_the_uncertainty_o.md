...
description: >-
  [ICML 2026][LLM Safety][Free-form Generation UQ] SemGrad is the first to bring "gradient-based" uncertainty quantification to LLM free-form generation. It uses the Semantics-Preserving Score (SPS) to identify hidden stat…
tags:
  - "ICML 2026"
  - "LLM Safety"
