...
description: >-
  [NeurIPS 2025][Multimodal VLM][VLM hallucination] This paper proposes Topic-level Preference Rewriting (TPR), which systematically optimizes the reward gap configuration in preference data through fine-grained semantic c…
tags:
  - "NeurIPS 2025"
  - "Multimodal VLM"
  - "VLM hallucination"
...
- [\[ICML 2026\] Learning from Fine-Grained Visual Discrepancies: Mitigating Multimodal Hallucinations via In-Context Visual Contrastive Optimization](../../ICML2026/multimodal_vlm/learning_from_fine-grained_visual_discrepancies_mitigating_multimodal_hallucinat.md)
