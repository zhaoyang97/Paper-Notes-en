---
title: >-
  ICLR2026 Robotics & Embodied AI Papers · 162 Notes
description: >-
  162 ICLR2026 papers in the Robotics & Embodied AI area, covering Robotics, Multimodal/VLM, Reinforcement Learning, Navigation, Agents, Diffusion Models and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
item_list:
  - u: "a_primer_on_so3_action_representations_in_deep_reinforcement_learning/"
    t: "A Primer on SO(3) Action Representations in Deep Reinforcement Learning"
  ...
  - u: "block-wise_adaptive_caching_for_accelerating_diffusion_policy/"
    t: "Block-wise Adaptive Caching for Accelerating Diffusion Policy"
  ...
  - u: "capturing_visual_environment_structure_correlates_with_control_performance/"
    t: "Capturing Visual Environment Structure Correlates with Control Performance"
  ...
  - u: "compassnav_steering_from_path_imitation_to_decision_understanding_in_navigation/"
    t: "CompassNav: Steering From Path Imitation to Decision Understanding In Navigation"
  - u: "compositional_diffusion_with_guided_search_for_long-horizon_planning/"
    t: "Compositional Diffusion with Guided Search for Long-Horizon Planning"
  - u: "conavbench_collaborative_long-horizon_vision-language_navigation_benchmark/"
    t: "CoNavBench: Collaborative Long-Horizon Vision-Language Navigation Benchmark"
  - u: "contractive_diffusion_policies/"
    t: "Contractive Diffusion Policies"
  - u: "cortical_policy_a_dual-stream_view_transformer_for_robotic_manipulation/"
    t: "Cortical Policy: A Dual-Stream View Transformer for Robotic Manipulation"
  ...
  - u: "ctrl-world_a_controllable_generative_world_model_for_robot_manipulation/"
    t: "Ctrl-World: A Controllable Generative World Model for Robot Manipulation"
...
📌 **Same area in other venues:** [📷 CVPR2026 (130)](../../CVPR2026/robotics/index.md) · [💬 ACL2026 (11)](../../ACL2026/robotics/index.md) · [🧪 ICML2026 (53)](../../ICML2026/robotics/index.md) · [🤖 AAAI2026 (30)](../../AAAI2026/robotics/index.md) · [🧠 NeurIPS2025 (73)](../../NeurIPS2025/robotics/index.md) · [📹 ICCV2025 (26)](../../ICCV2025/robotics/index.md)
...
**[Action Chunking and Exploratory Data Collection Yield Exponential Improvements in Behavior Cloning for Continuous Control](action_chunking_and_data_augmentation_yield_exponential_improvements_in_behavior.md)**
...
**[Block-wise Adaptive Caching for Accelerating Diffusion Policy](block-wise_adaptive_caching_for_accelerating_diffusion_policy.md)**
...
**[Capturing Visual Environment Structure Correlates with Control Performance](capturing_visual_environment_structure_correlates_with_control_performance.md)**
...
**[CompassNav: Steering From Path Imitation to Decision Understanding In Navigation](compassnav_steering_from_path_imitation_to_decision_understanding_in_navigation.md)**
...
**[Compositional Diffusion with Guided Search for Long-Horizon Planning](compositional_diffusion_with_guided_search_for_long-horizon_planning.md)**
...
**[CoNavBench: Collaborative Long-Horizon Vision-Language Navigation Benchmark](conavbench_collaborative_long-horizon_vision-language_navigation_benchmark.md)**
...
**[Contractive Diffusion Policies](contractive_diffusion_policies.md)**
...
**[Cortical Policy: A Dual-Stream View Transformer for Robotic Manipulation](cortical_policy_a_dual-stream_view_transformer_for_robotic_manipulation.md)**
...
**[Ctrl-World: A Controllable Generative World Model for Robot Manipulation](ctrl-world_a_controllable_generative_world_model_for_robot_manipulation.md)**
...
**[DataMIL: Selecting Data for Robot Imitation Learning with Datamodels](datamil_selecting_data_for_robot_imitation_learning_with_datamodels.md)**
...
**[DemoGrasp: Universal Dexterous Grasping from a Single Demonstration](demograsp_universal_dexterous_grasping_from_a_single_demonstration.md)**
...
**[DexNDM: Closing the Reality Gap for Dexterous In-Hand Rotation via Joint-Wise Neural Dynamics Model](dexndm_closing_the_reality_gap_for_dexterous_in-hand_rotation_via_joint-wise_neu.md)**
...
**[Difference-Aware Retrieval Policies for Imitation Learning](difference-aware_retrieval_policies_for_imitation_learning.md)**
...
**[Differentiable Simulation of Hard Contacts with Soft Gradients for Learning and Control](differentiable_simulation_of_hard_contacts_with_soft_gradients_for_learning_and_.md)**
...
**[Disentangled Robot Learning via Separate Forward and Inverse Dynamics Pretraining](disentangled_robot_learning_via_separate_forward_and_inverse_dynamics_pretrainin.md)**
...
**[Efficient Differentiable Contact Model with Long-range Influence](efficient_differentiable_contact_model_with_long-range_influence.md)**
...
**[Embodied-R1: Reinforced Embodied Reasoning for General Robotic Manipulation](embodied-r1_reinforced_embodied_reasoning_for_general_robotic_manipulation.md)**
...
**[Embodied Navigation Foundation Model](embodied_navigation_foundation_model.md)**
...
**[Emergent Dexterity via Diverse Resets and Large-Scale Reinforcement Learning](emergent_dexterity_via_diverse_resets_and_large-scale_reinforcement_learning.md)**
...
**[Empowering Multi-Robot Cooperation via Sequential World Models](empowering_multi-robot_cooperation_via_sequential_world_models.md)**
...
**[ENACT: Evaluating Embodied Cognition with World Modeling of Egocentric Interaction](enact_evaluating_embodied_cognition_with_world_modeling_of_egocentric_interactio.md)**
...
**[End-to-end Listen, Look, Speak and Act](end-to-end_listen_look_speak_and_act.md)**
...
**[EquAct: An SE(3)-Equivariant Multi-Task Transformer for 3D Robotic Manipulation](equact_an_se3-equivariant_multi-task_transformer_for_3d_robotic_manipulation.md)**
...
**[EVLP: Learning Unified Embodied Vision-Language Planner with Reinforced Supervised Fine-Tuning](evlp_learning_unified_embodied_vision-language_planner_with_reinforced_supervise.md)**
...
**[From Language to Locomotion: Retargeting-free Humanoid Control via Motion Latent Guidance](from_language_to_locomotion_retargeting-free_humanoid_control_via_motion_latent_.md)**
...
**[From Seeing to Doing: Bridging Reasoning and Decision for Robotic Manipulation](from_seeing_to_doing_bridging_reasoning_and_decision_for_robotic_manipulation.md)**
...
**[From Seeing to Experiencing: Scaling Navigation Foundation Models with Reinforcement Learning](from_seeing_to_experiencing_scaling_navigation_foundation_models_with_reinforcem.md)**
...
**[Genie Envisioner: A Unified World Foundation Platform for Robotic Manipulation](genie_envisioner_a_unified_world_foundation_platform_for_robotic_manipulation.md)**
...
**[Geometry-Aware Policy Imitation](geometry-aware_policy_imitation.md)**
...
**[Ground Slow, Move Fast: A Dual-System Foundation Model for Generalizable Vision-Language Navigation](ground_slow_move_fast_a_dual-system_foundation_model_for_generalizable_vision-la.md)**
...
**[H$^3$DP: Triply-Hierarchical Diffusion Policy for Visuomotor Learning](h3dp_triplyhierarchical_diffusion_policy_for_visuomotor_learning.md)**
...
**[HAMLET: Switch Your Vision-Language-Action Model into a History-Aware Policy](hamlet_switch_your_vision-language-action_model_into_a_history-aware_policy.md)**
...
**[Hierarchical Value-Decomposed Offline Reinforcement Learning for Whole-Body Control](hierarchical_value-decomposed_offline_reinforcement_learning_for_whole-body_cont.md)**
...
**[Hybrid Training for Vision-Language-Action Models](hybrid_training_for_vision-language-action_models.md)**
...
**[HybridVLA: Collaborative Diffusion and Autoregression in a Unified Vision-Language-Action Model](hybridvla_collaborative_diffusion_and_autoregression_in_a_unified_vision-languag.md)**
...
**[Image Quality Assessment for Embodied AI](image_quality_assessment_for_embodied_ai.md)**
...
**[Interleave-VLA: Enhancing Robot Manipulation with Image-Text Interleaved Instructions](interleave-vla_enhancing_robot_manipulation_with_image-text_interleaved_instruct.md)**
...
**[LeRobot: An Open-Source Library for End-to-End Robot Learning](lerobot_an_open-source_library_for_end-to-end_robot_learning.md)**
...
**[Memory, Benchmark & Robots: A Benchmark for Solving Complex Tasks with Reinforcement Learning](memory_benchmark_robots_a_benchmark_for_solving_complex_tasks_with_reinforcement.md)**
...
**[MetaVLA: Unified Meta Co-Training for Efficient Embodied Adaptation](metavla_unified_meta_co-training_for_efficient_embodied_adaptation.md)**
...
**[MomaGraph: State-Aware Unified Scene Graphs with Vision-Language Models for Embodied Task Planning](momagraph_state-aware_unified_scene_graphs_with_vision-language_models_for_embod.md)**
...
**[Much Ado About Noising: Dispelling the Myths of Generative Robotic Control](much_ado_about_noising_dispelling_the_myths_of_generative_robotic_control.md)**
...
**[OmniNav: A Unified Framework for Prospective Exploration and Visual-Language Navigation](omninav_a_unified_framework_for_prospective_exploration_and_visual-language_navi.md)**
...
**[On Robustness of Vision-Language-Action Model against Multi-Modal Perturbations](on_robustness_of_vision-language-action_model_against_multi-modal_perturbations.md)**
...
**[PA3FF: Part-Aware Dense 3D Feature Fields for Generalizable Articulated Object Manipulation](pa3fflearning_part-aware_dense_3d_feature_field_for_generalizable_articulated_ob.md)**
...
**[PixelVLA: Advancing Pixel-level Understanding in Vision-Language-Action Model](pixelvla_advancing_pixel-level_understanding_in_vision-language-action_model.md)**
...
**[Planning with an Embodied Learnable Memory](planning_with_an_embodied_learnable_memory.md)**
...
**[Policy Contrastive Decoding for Robotic Foundation Models](policy_contrastive_decoding_for_robotic_foundation_models.md)**
...
**[Primary-Fine Decoupling for Action Generation in Robotic Imitation](primary-fine_decoupling_for_action_generation_in_robotic_imitation.md)**
...
**[RAVEN: End-to-end Equivariant Robot Learning with RGB Cameras](raven_end-to-end_equivariant_robot_learning_with_rgb_cameras.md)**
...
**[ReCAPA: Hierarchical Predictive Correction to Mitigate Cascading Failures](recapa_hierarchical_predictive_correction_to_mitigate_cascading_failures.md)**
...
**[Remotely Detectable Robot Policy Watermarking](remotely_detectable_robot_policy_watermarking.md)**
...
**[RFS: Reinforcement Learning with Residual Flow Steering for Dexterous Manipulation](rfs_reinforcement_learning_with_residual_flow_steering_for_dexterous_manipulatio.md)**
...
**[RoboMD: Uncovering Robot Vulnerabilities through Semantic Potential Fields](robomd_uncovering_robot_vulnerabilities_through_semantic_potential_fields.md)**
...
**[Rodrigues Network for Learning Robot Actions](rodrigues_network_for_learning_robot_actions.md)**
...
**[SARM: Stage-Aware Reward Modeling for Long Horizon Robot Manipulation](sarm_stage-aware_reward_modeling_for_long_horizon_robot_manipulation.md)**
...
**[TaCo: A Benchmark for Lossless and Lossy Codecs of Heterogeneous Tactile Data](taco_a_benchmark_for_lossless_and_lossy_codecs_of_heterogeneous_tactile_data.md)**
...
**[Time Optimal Execution of Action Chunk Policies Beyond Demonstration Speed](time_optimal_execution_of_action_chunk_policies_beyond_demonstration_speed.md)**
...
**[Translating Flow to Policy via Hindsight Online Imitation](translating_flow_to_policy_via_hindsight_online_imitation.md)**
...
**[Uncertainty-Aware Gaussian Map for Vision-Language Navigation](uncertainty-aware_gaussian_map_for_vision-language_navigation.md)**
...
**[Unified Diffusion VLA: Vision-Language-Action Model via Joint Discrete Denoising Diffusion Process](unified_diffusion_vla_vision-language-action_model_via_joint_discrete_denosing_d.md)**
...
**[UniVLA: Unified Vision-Language-Action Model](unified_vision-language-action_model.md)**
...
**[VER: Vision Expert Transformer for Robot Learning via Foundation Distillation and Dynamic Routing](ver_vision_expert_transformer_for_robot_learning_via_foundation_distillation_and.md)**
...
**[Verifier-Free Test-Time Sampling for Vision-Language-Action Models](verifier-free_test-time_sampling_for_vision-language-action_models.md)**
...
**[villa-X: Enhancing Latent Action Modeling in Vision-Language-Action Models](villa-x_enhancing_latent_action_modeling_in_vision-language-action_models.md)**
...
**[ViPRA: Video Prediction for Robot Actions](vipra_video_prediction_for_robot_actions.md)**
...
**[Virtual Community: An Open World for Humans, Robots, and Society](virtual_community_an_open_world_for_humans_robots_and_society.md)**
...
**[Vision-Language-Action Instruction Tuning: From Understanding to Manipulation](vision-language-action_instruction_tuning_from_understanding_to_manipulation.md)**
...
**[VITA: Vision-to-Action Flow Matching Policy](vita_vision-to-action_flow_matching_policy.md)**
...
**[VITA: Zero-Shot Value Functions via Test-Time Adaptation of Vision–Language Models](vita_zero-shot_value_functions_via_test-time_adaptation_of_visionlanguage_models.md)**
...
**[Vlaser: Vision-Language-Action Model with Synergistic Embodied Reasoning](vlaser_vision-language-action_model_with_synergistic_embodied_reasoning.md)**
...
**[VLM4VLA: Revisiting Vision-Language-Models in Vision-Language-Action Models](vlm4vla_revisiting_vision-language-models_in_vision-language-action_models.md)**
...
**[WholeBodyVLA: Towards Unified Latent VLA for Whole-Body Loco-Manipulation Control](wholebodyvla_towards_unified_latent_vla_for_whole-body_loco-manipulation_control.md)**
...
**[WMPO: World Model-based Policy Optimization for Vision-Language-Action Models](wmpo_world_model-based_policy_optimization_for_vision-language-action_models.md)**
...
**[World-In-World: World Models in a Closed-Loop World](world-in-world_world_models_in_a_closed-loop_world.md)**
