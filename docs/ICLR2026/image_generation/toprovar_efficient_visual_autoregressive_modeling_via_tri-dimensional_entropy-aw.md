...
description: >-
  [Image Generation] ToProVAR is a framework that employs attention entropy to uniformly analyze sparsity across three dimensions — token, layer, and scale — in VAR models…
tags:
  - "Image Generation"
date: 2026-05-08
