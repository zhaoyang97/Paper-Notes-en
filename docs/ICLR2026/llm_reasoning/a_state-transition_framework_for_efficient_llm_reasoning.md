...
description: >-
  [ICLR 2026][LLM Reasoning][efficient reasoning] This paper proposes an efficient reasoning framework that models the LLM reasoning process as a state-transition process. It uses Linear Attention to compress information f…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "efficient reasoning"
