...
description: >-
  [ICML 2026][NLP Understanding][Causal fine-tuning] This paper proposes Causal Fine-Tuning (CFT): embedding an SCM-inspired decomposition of "high-level stable feature $C$ + low-level confounder-sensitive feature $\Phi$"…
tags:
  - "ICML 2026"
  - "NLP Understanding"
  - "Causal fine-tuning"
