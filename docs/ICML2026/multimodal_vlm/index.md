---
title: >-
  ICML2026 Multimodal VLM Papers · 89 Notes
description: >-
  89 ICML2026 papers in the Multimodal VLM area, covering Multimodal/VLM, Adversarial Robustness, Alignment/RLHF, LLM, Compression, Few-/Zero-Shot Learning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "Multimodal VLM"
  - "AI paper notes"
...
**[ATHA: Improving CLIP Adaptation on Source-Free Cross-Domain Few-Shot Learning by Breaking Tail Alignment](improving_clip_adaptation_by_breaking_tail_alignment_for_source-free_cross-domai.md)**
...
**[TRAP: Hijacking CoT Reasoning of VLA for Targeted Behavior Attacks via Adversarial Patches](trap_hijacking_vla_cot-reasoning_via_adversarial_patches.md)**
...
**[Universal Skeleton Understanding: Differentiable Rendering and MLLMs](universal_skeleton_understanding_via_differentiable_rendering_and_mllms.md)**
...
**[Unveiling Visual Counting Bottlenecks in Vision-Language Models](unveiling_the_visual_counting_bottleneck_in_vision-language_models.md)**
...
**[Visual Persuasion: What Influences the Decisions of Vision-Language Models?](visual_persuasion_what_influences_decisions_of_vision-language_models.md)**
