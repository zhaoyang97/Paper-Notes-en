...
description: >-
  [CVPR 2026][3D Vision][3D shape completion] This paper proposes LaS-Comp, a zero-shot, category-agnostic 3D shape completion framework. It injects known geometry in the spatial domain via an Explicit Replacement Stage (E…
tags:
  - "CVPR 2026"
  - "3D Vision"
  - "3D shape completion"
