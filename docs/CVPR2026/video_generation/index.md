---
title: >-
  CVPR2026 Video Generation Papers · 56 Notes
description: >-
  56 CVPR2026 papers in the Video Generation area, covering Video Generation, Diffusion Models, Speech & Audio, Compression, Dynamic Scenes, Agents and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2026"
  - "Video Generation"
  - "AI paper notes"
...
item_list:
  ...
  - u: "fastlightgen_fast_and_light_video_generation_with_fewer_steps_and_parameters/"
    t: "FastLightGen: Fast and Light Video Generation with Fewer Steps and Parameters"
  - u: "first_frame_is_the_place_to_go_for_video_content_customization/"
    t: "First Frame Is the Place to Go for Video Content Customization"
  - u: "flashmotion_fewstep_controllable_video_generation/"
  ...
  - u: "from_static_to_dynamic_exploring_self-supervised_image-to-video_representation_t/"
    t: "From Static to Dynamic: Exploring Self-supervised Image-to-Video Representation Transfer Learning"
  - u: "generative_neural_video_compression_via_video_diffusion_prior/"
    t: "Generative Neural Video Compression via Video Diffusion Prior"
  - u: "geometry-as-context_modulating_explicit_3d_in_scene-consistent_video_generation_/"
    t: "Geometry-as-context: Modulating Explicit 3D in Scene-consistent Video Generation to Geometry Context"
  - u: "gloria_consistent_character_video_generation_via_content_anchors/"
  ...
  - u: "linvideo_a_post-training_framework_towards_on_attention_in_efficient_video_gener/"
    t: "LinVideo: A Post-Training Framework towards O(n) Attention in Efficient Video Generation"
  - u: "moviedrive_multimodal_multiview_video_diffusion/"
    t: "MoVieDrive: Urban Scene Synthesis with Multi-Modal Multi-View Video Diffusion Transformer"
  - u: "neoverse_enhancing_4d_world_model_with_in-the-wild_monocular_videos/"
    t: "NeoVerse: Enhancing 4D World Model with in-the-wild Monocular Videos"
item_total: 56
---
