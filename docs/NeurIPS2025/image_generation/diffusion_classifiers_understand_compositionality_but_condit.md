...
description: >-
  [NeurIPS 2025 (Datasets & Benchmarks)][Image Generation][diffusion classifier] A comprehensive study of zero-shot diffusion classifiers on compositional understanding tasks: covering 3 diffusion models (SD 1.5/2.0/3-m) ×…
tags:
