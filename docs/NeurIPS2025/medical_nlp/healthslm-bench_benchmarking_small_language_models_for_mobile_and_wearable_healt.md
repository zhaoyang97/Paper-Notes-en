...
description: >-
  [NeurIPS 2025][Medical NLP][small language models] The first benchmark systematically evaluating small language models (SLMs, 1–4B parameters) on mobile and wearable health monitoring tasks, covering zero-shot, few-shot…
tags:
  - "NeurIPS 2025"
  - "Medical NLP"
