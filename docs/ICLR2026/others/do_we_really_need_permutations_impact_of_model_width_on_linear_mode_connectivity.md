...
description: >-
  [ICLR 2026][linear mode connectivity] This paper empirically demonstrates that linear mode connectivity (LMC) between independently trained models can be achieved by simply increasing model width…
tags:
  - "ICLR 2026"
