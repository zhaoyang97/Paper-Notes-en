---
title: >-
  AAAI2026 Autonomous Driving Papers · 57 Notes
description: >-
  57 AAAI2026 papers in the Autonomous Driving area, covering Autonomous Driving, 3D Object Detection, Diffusion Models, Agents, Adversarial Robustness, Re-Identification and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "AAAI2026"
  - "Autonomous Driving"
  - "AI paper notes"
  ...
  - "Re-Identification"
item_list:
  - u: "a_data-driven_model_predictive_control_framework_for_multi-aircraft_tma_routing_/"
    t: "A Data-Driven Model Predictive Control Framework for Multi-Aircraft TMA Routing Under Travel Time Uncertainty"
  - u: "ai-based_traffic_modeling_for_network_security_and_privacy_challenges_ahead/"
    t: "AI-based Traffic Modeling for Network Security and Privacy: Challenges Ahead"
  - u: "backdoor_attacks_on_open_vocabulary_object_detectors_via_multi-modal_prompt_tuni/"
  ...
  - u: "decoupling_scene_perception_and_ego_status_a_multi-context_fusion_approach_for_e/"
    t: "AdaptiveAD: Decoupling Scene Perception and Ego Status for End-to-End Autonomous Driving"
  - u: "differentiable_semantic_meta-learning_framework_for_long-tail_motion_forecasting/"
    t: "SAML: A Differentiable Semantic Meta-Learning Framework for Long-Tail Motion Prediction"
  - u: "difficulty-aware_label-guided_denoising_for_monocular_3d_object_detection/"
    t: "Difficulty-Aware Label-Guided Denoising for Monocular 3D Object Detection"
  - u: "diffrefiner_coarse_to_fine_trajectory_planning_via_diffusion_refinement_with_sem/"
    t: "DiffRefiner: Coarse to Fine Trajectory Planning via Diffusion Refinement with Semantic Interaction for End to End Autonomous Driving"
  - u: "drive_as_you_like_strategy-level_motion_planning_based_on_a_multi-head_diffusion/"
    t: "Drive As You Like: Strategy-Level Motion Planning Based on A Multi-Head Diffusion Model"
  - u: "driveflow_rectified_flow_adaptation_for_robust_3d_object_detection_in_autonomous/"
    t: "DriveFlow: Rectified Flow Adaptation for Robust 3D Object Detection in Autonomous Driving"
  - u: "drivesuprim_towards_precise_trajectory_selection_for_end-to-end_planning/"
    t: "DriveSuprim: Towards Precise Trajectory Selection for End-to-End Planning"
  - u: "dual-branch_spatial-temporal_self-supervised_representation_for_enhanced_road_ne/"
    t: "Dual-branch Spatial-Temporal Self-supervised Representation for Enhanced Road Network Learning"
  - u: "expertad_enhancing_autonomous_driving_systems_with_mixture_of_experts/"
    t: "ExpertAD: Enhancing Autonomous Driving Systems with Mixture of Experts"
  - u: "exploring_surround-view_fisheye_camera_3d_object_detection/"
    t: "Exploring Surround-View Fisheye Camera 3D Object Detection"
  - u: "fastdrivevla_efficient_end-to-end_driving_via_plug-and-play_/"
    t: "FastDriveVLA: Efficient End-to-End Driving via Plug-and-Play Reconstruction-based Token Pruning"
  - u: "fine-grained_representation_for_lane_topology_reasoning/"
    t: "Fine-Grained Representation for Lane Topology Reasoning"
  ...
  - u: "hd2-ssc_high-dimension_high-density_semantic_scene_completion_for_autonomous_dri/"
    t: "HD2-SSC: High-Dimension High-Density Semantic Scene Completion for Autonomous Driving"
  - u: "hierarchical_prompt_learning_for_image-_and_text-based_person_re-identification/"
    t: "Hierarchical Prompt Learning for Image- and Text-Based Person Re-Identification"
  - u: "i-inr_iterative_implicit_neural_representations/"
    t: "I-INR: Iterative Implicit Neural Representations"
  - u: "lidar-gsimproving_lidar_gaussian_reconstruction_via_diffusion_priors/"
    t: "LiDAR-GS++: Improving LiDAR Gaussian Reconstruction via Diffusion Priors"
  - u: "lidarcrafter_dynamic_4d_world_modeling_from_lidar_sequences/"
...
**🤖 AAAI2026** · **57** paper notes

📌 **Same area in other venues:** [🧪 ICML2026 (6)](../../ICML2026/autonomous_driving/index.md) · [📷 CVPR2026 (89)](../../CVPR2026/autonomous_driving/index.md) · [🔬 ICLR2026 (18)](../../ICLR2026/autonomous_driving/index.md) · [🧠 NeurIPS2025 (49)](../../NeurIPS2025/autonomous_driving/index.md) · [📹 ICCV2025 (93)](../../ICCV2025/autonomous_driving/index.md)
...
**[SPARC: OOD Generalization for Controlling 100 Unseen Vehicles with a Single Policy](out-of-distribution_generalization_with_a_sparc_racing_100_u.md)**
...
**[PriorDrive: Enhancing Online HD Map Construction with Unified Vector Priors](priordrive_enhancing_online_hd_mapping_with_unified_vector_p.md)**
...
**[ReflexDiffusion: Reflexion-Enhanced Trajectory Planning for High Lateral Acceleration in Autonomous Driving](reflexdiffusion_reflection-enhanced_trajectory_planning_for_.md)**
