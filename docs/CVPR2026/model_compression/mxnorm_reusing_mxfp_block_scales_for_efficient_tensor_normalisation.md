...
description: >-
  [CVPR 2026][Model Compression][RMSNorm] GPU matrix multiplication throughput has improved 80x (V100 to GB200) while reduction/elementwise operations improved only 5-9x…
tags:
  - "CVPR 2026"
  - "Model Compression"
  - "RMSNorm"
...
- [\[ICML 2026\] Finer Parameter Steps for Low-Rank PEFT: A Controlled Study with CP Tensor Adapters](../../ICML2026/model_compression/finer_parameter_steps_for_low-rank_peft_a_controlled_study_with_cp_tensor_adapte.md)
