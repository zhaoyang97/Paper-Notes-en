...
📌 **Same area in other venues:** [📷 CVPR2026 (20)](../../CVPR2026/llm_reasoning/index.md) · [💬 ACL2026 (81)](../../ACL2026/llm_reasoning/index.md) · [🔬 ICLR2026 (82)](../../ICLR2026/llm_reasoning/index.md) · [🤖 AAAI2026 (37)](../../AAAI2026/llm_reasoning/index.md) · [🧠 NeurIPS2025 (81)](../../NeurIPS2025/llm_reasoning/index.md) · [📹 ICCV2025 (3)](../../ICCV2025/llm_reasoning/index.md)
...
**[Beyond Two-Stage Training: Cooperative SFT and RL for LLM Reasoning](beyond_two-stage_training_cooperative_sft_and_rl_for_llm_reasoning.md)**
...
**[Biases in the Blind Spot: Detecting What LLMs Fail to Mention](biases_in_the_blind_spot_detecting_what_llms_fail_to_mention.md)**
...
**[Blending Supervised and Reinforcement Fine-Tuning with Prefix Sampling](blending_supervised_and_reinforcement_fine-tuning_with_prefix_sampling.md)**
...
**[Clustering as Reasoning: A $k$-Means Interpretation of Chain-of-Thought Graph Learning](clustering_as_reasoning_a_k-means_interpretation_of_chain-of-thought_graph_learn.md)**
...
**[Deliberate Evolution: Agentic Reasoning for Sample-Efficient Symbolic Regression with LLMs](deliberate_evolution_agentic_reasoning_for_sample-efficient_symbolic_regression_.md)**
...
**[DenseSteer: Steering Small Language Models towards Dense Math Reasoning](densesteer_steering_small_language_models_towards_dense_math_reasoning.md)**
...
**[Diagnosing Multi-step Reasoning Failures in Black-box LLMs via Stepwise Confidence Attribution](diagnosing_multi-step_reasoning_failures_in_black-box_llms_via_stepwise_confiden.md)**
...
**[Diversity Matters: Revisiting Test-Time Compute in Vision-Language Models](diversity_matters_revisiting_test-time_compute_in_vision-language_models.md)**
...
**[Diversity Over Frequency: Rethinking Tool Use in Visual Chain-of-Thought Agents](diversity_over_frequency_rethinking_tool_use_in_visual_chain-of-thought_agents.md)**
...
**[ForesightKV: Optimizing KV Cache Eviction for Reasoning Models by Learning Long-Term Contribution](foresightkv_optimizing_kv_cache_eviction_for_reasoning_models_by_learning_long-t.md)**
...
**[How Far Ahead Do LLMs Plan? Uncovering the Latent Horizon in Chain-of-Thought Reasoning](how_far_ahead_do_llms_plan_uncovering_the_latent_horizon_in_chain-of-thought_rea.md)**
...
**[MOSAIC: Learning When to Act or Refuse — Guarding Agentic Reasoning Models for Safe Multi-step Tool Use](learning_when_to_act_or_refuse_guarding_agentic_reasoning_models_for_safe_multi-.md)**
...
**[Mean-Shift PCA by Knockoff Mean](mean-shift_pca_by_knockoff_mean.md)**
...
**[Measuring Weak-to-Strong Legibility of Reasoning Models](measuring_weak-to-strong_legibility_of_reasoning_models.md)**
...
**[On the Generalization Gap in Self-Evolving Language Model Reasoning](on_the_generalization_gap_in_self-evolving_language_model_reasoning.md)**
...
**[PowerFlow: Unlocking the Dual Nature of LLMs via Principled Distribution Matching](powerflow_unlocking_the_dual_nature_of_llms_via_principled_distribution_matching.md)**
...
**[Prioritize the Process, Not Just the Outcome: Rewarding Latent Thought Trajectories Improves Reasoning in Looped Language Models](prioritize_the_process_not_just_the_outcome_rewarding_latent_thought_trajectorie.md)**
...
**[Prompt Injection as Role Confusion](prompt_injection_as_role_confusion.md)**
...
**[Reasoning Can Be Restored by Correcting a Few Decision Tokens](reasoning_can_be_restored_by_correcting_a_few_decision_tokens.md)**
...
**[Reasoning Structure of Large Language Models](reasoning_structure_of_large_language_models.md)**
...
**[Scientific Logicality Enriched Methodology for LLM Reasoning: A Practice in Physics](scientific_logicality_enriched_methodology_for_llm_reasoning_a_practice_in_physi.md)**
...
**[SmartThinker: Progressive Chain-of-Thought Length Calibration for Efficient Large Language Model Reasoning](smartthinker_progressive_chain-of-thought_length_calibration_for_efficient_large.md)**
...
**[Stabilizing Recurrent Dynamics for Test-Time Scalable Latent Reasoning in Looped Language Models](stabilizing_recurrent_dynamics_for_test-time_scalable_latent_reasoning_in_looped.md)**
...
**[TRACE: Evaluating LLM CoT Reasoning Process Quality with the Toulmin Argumentation Model](trace_toulmin-based_reasoning_assessment_through_constructive_elements_for_llm_c.md)**
...
**[UCPO: Uncertainty-Aware Policy Optimization](ucpo_uncertainty-aware_policy_optimization.md)**
...
**[UniScale: Adaptive Unified Inference Scaling through Online Joint Optimization of Model Routing and Test-Time Scaling](uniscale_adaptive_unified_inference_scaling_via_online_joint_optimization_of_mod.md)**
