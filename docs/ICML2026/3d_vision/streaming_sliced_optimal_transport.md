...
description: >-
  [ICML 2026][3D Vision][Streaming OT] Stream-SW is the first algorithm capable of estimating the sliced Wasserstein distance on "sample streams": for each 1D projection…
tags:
  - "ICML 2026"
  - "3D Vision"
  - "Streaming OT"
