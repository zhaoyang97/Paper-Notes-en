...
description: >-
  [ACL 2026][Robotics][Task Vector] DeCoVec constructs task vectors in the decoding space (output logits) by contrasting few-shot and zero-shot logit distributions: $\mathbf{v}_\mathcal{T}^t = \mathbf{z}_{\text{icl}}^t - \…
tags:
  - "ACL 2026"
  - "Robotics"
  - "Task Vector"
