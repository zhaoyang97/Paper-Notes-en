...
description: >-
  [ICML 2026][Model Compression][Test-Time Training] The authors observe that the inner model of two-layer TTT is structurally equivalent to Softmax attention (Softmax can be viewed as a two-layer dynamic MLP). This enable…
tags:
  - "ICML 2026"
  - "Model Compression"
  - "Test-Time Training"
