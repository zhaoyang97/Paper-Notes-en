...
description: >-
  [CVPR2026][Object Detection][Anomaly Detection] This paper proposes UniMMAD, the first unified framework that handles multi-modal and multi-class anomaly detection simultaneously with a single parameter set. The core con…
tags:
  - "CVPR2026"
  - "Object Detection"
  - "Anomaly Detection"
