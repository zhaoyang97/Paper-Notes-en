...
description: >-
  [ICLR 2026][LLM Pretraining][training loss curve collapse] This paper demonstrates that the training loss curves (TLCs) of LLM families "collapse" onto a single universal curve when optimization hyperparameters are match…
tags:
  - "ICLR 2026"
  - "LLM Pretraining"
