...
description: >-
  [CVPR 2026][Computational Biology][Spatial transcriptomics] This paper proposes SpaHGC, a multimodal heterogeneous graph framework that constructs three types of subgraphs—intra-target-slice (TS), cross-slice (CS)…
tags:
  - "CVPR 2026"
