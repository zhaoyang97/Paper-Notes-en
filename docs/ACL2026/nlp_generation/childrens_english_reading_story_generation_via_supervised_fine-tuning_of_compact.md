...
description: >-
  [ACL 2026][Text Generation][Children's Reading] The authors utilized 2,580 stories generated by GPT-4o / Llama-3.3-70B corresponding to the UFLI K–2 English reading curriculum to perform four SFT designs (baseline, Good Stories, Rewarded SFT, and simulated children's pronunciation errors) on three 8B models (Llama 3 / Granite 3.3 / Apertus). The results demonstrate that **compact models + appropriate SFT strategies** can **outperform zero-shot GPT-4o and Llama-3.3-70B** on ke…
tags:
  - "ACL 2026"
  - "Text Generation"
  - "Children's Reading"
