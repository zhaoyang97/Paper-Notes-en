...
description: >-
  1527 ICLR2026 paper notes covering Image Generation (149), Reinforcement Learning (138), Model Compression (90), Multimodal VLM (86), 3D Vision (63), LLM Reasoning (63), Interpretability (54), LLM Evaluation (53) and other 46 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICLR2026"
...
**[BEAT: Visual Backdoor Attacks on VLM-based Embodied Agents via Contrastive Trigger Learning](llm_safety/beat_visual_backdoor_attacks_on_vlm-based_embodied_agents_via_contrastive_trigge.md)**
...
**[Converge Faster, Talk Less: Hessian-Informed Federated Zeroth-Order Optimization](llm_safety/converge_faster_talk_less_hessian-informed_federated_zeroth-order_optimization.md)**
...
**[Do Vision-Language Models Respect Contextual Integrity in Location Disclosure?](llm_safety/do_vision-language_models_respect_contextual_integrity_in_location_disclosure.md)**
...
**[Doxing via the Lens: Revealing Location-related Privacy Leakage on Multi-modal Large Reasoning Models](llm_safety/doxing_via_the_lens_revealing_location-related_privacy_leakage_in_vlms.md)**
...
**[Efficient Adversarial Attacks on High-dimensional Offline Bandits](llm_safety/efficient_adversarial_attacks_on_high-dimensional_offline_bandits.md)**
...
**[ExpGuard: LLM Content Moderation in Specialized Domains](llm_safety/expguard_llm_content_moderation_in_specialized_domains.md)**
...
**[Exposing Hidden Biases in Text-to-Image Models via Automated Prompt Search](llm_safety/exposing_hidden_biases_in_text-to-image_models_via_automated_prompt_search.md)**
...
**[LLM Unlearning with LLM Beliefs](llm_safety/llm_unlearning_with_llm_beliefs.md)**
...
**[Model Collapse Is Not a Bug but a Feature in Machine Unlearning for LLMs](llm_safety/model_collapse_is_not_a_bug_but_a_feature_in_machine_unlearning_for_llms.md)**
...
**[Moving Beyond Medical Exams: A Clinician-Annotated Fairness Dataset of Real-World Tasks and Ambiguity in Mental Healthcare](llm_safety/moving_beyond_medical_exams_a_clinician-annotated_fairness_dataset_of_real-world.md)**
...
**[No Caption, No Problem: Caption-Free Membership Inference via Model-Fitted Embeddings](llm_safety/no_caption_no_problem_caption-free_membership_inference_via_model-fitted_embeddi.md)**
...
**[Reasoning or Retrieval? A Study of Answer Attribution on Large Reasoning Models](llm_safety/reasoning_or_retrieval_a_study_of_answer_attribution_on_large_reasoning_models.md)**
...
**[PURGE: Reinforcement Unlearning via Group Relative Policy Optimization](llm_safety/reinforcement_unlearning_via_group_relative_policy_optimization.md)**
...
**[Revisiting the Past: Data Unlearning with Model State History](llm_safety/revisiting_the_past_data_unlearning_with_model_state_history.md)**
...
**[Stop Tracking Me! Proactive Defense Against Attribute Inference Attack in LLMs](llm_safety/stop_tracking_me_proactive_defense_against_attribute_inference_attack_in_llms.md)**
...
**[Supervised Reinforcement Learning: From Expert Trajectories to Step-wise Reasoning](llm_safety/supervised_reinforcement_learning_from_expert_trajectories_to_step-wise_reasonin.md)**
...
**[Robustness and Radioactivity of Watermarks in Federated Learning May Be at Odds](llm_safety/watermark_robustness_and_radioactivity_may_be_at_odds_in_federated_learning.md)**
...
**[wd1: Weighted Policy Optimization for Reasoning in Diffusion Language Models](llm_safety/wd1_weighted_policy_optimization_for_reasoning_in_diffusion_language_models.md)**
...
**[Biologically Plausible Online Hebbian Meta-Learning: Two-Timescale Local Rules for Spiking Neural Brain Interfaces](medical_imaging/biologically_plausible_online_hebbian_meta-learning_two-timescale_local_rules_fo.md)**
...
**[LaVCa: LLM-assisted Visual Cortex Captioning](medical_imaging/lavca_llm-assisted_visual_cortex_captioning.md)**
...
**[Neural Synchrony Between Socially Interacting Language Models](medical_imaging/neural_synchrony_between_socially_interacting_language_models.md)**
...
**[SEED: Towards More Accurate Semantic Evaluation for Visual Brain Decoding](medical_imaging/seed_towards_more_accurate_semantic_evaluation_for_visual_brain_decoding.md)**
...
**[Uni-NTFM: A Unified Foundation Model for EEG Signal Representation Learning](medical_imaging/uni-ntfm_a_unified_foundation_model_for_eeg_signal_representation_learning.md)**
...
**[Policy Myopia as a Mechanism of Gradual Disempowerment in Post-AGI Governance](ai_safety/policy_myopia_as_a_mechanism_of_gradual_disempowerment_in_post-agi_governance_ci.md)**
...
**[AFD-INSTRUCTION: A Comprehensive Antibody Instruction Dataset with Functional Annotations for LLM-Based Understanding and Design](computational_biology/afd-instruction_a_comprehensive_antibody_instruction_dataset_with_functional_ann.md)**
...
**[AntigenLM: Structure-Aware DNA Language Modeling for Influenza](computational_biology/antigenlm_structure-aware_dna_language_modeling_for_influenza.md)**
...
**[ConfHit: Conformal Generative Design with Oracle Free Guarantees](computational_biology/confhit_conformal_generative_design_with_oracle_free_guarantees.md)**
...
**[Controlling Repetition in Protein Language Models](computational_biology/controlling_repetition_in_protein_language_models.md)**
...
**[CryoNet.Refine: A One-step Diffusion Model for Rapid Refinement of Structural Models with Cryo-EM Density Map Restraints](computational_biology/cryonetrefine_a_one-step_diffusion_model_for_rapid_refinement_of_structural_mode.md)**
...
**[Discrete Diffusion Trajectory Alignment via Stepwise Decomposition](computational_biology/discrete_diffusion_trajectory_alignment_via_stepwise_decomposition.md)**
...
**[DistMLIP: A Distributed Inference Platform for Machine Learning Interatomic Potentials](computational_biology/distmlip_a_distributed_inference_platform_for_machine_learning_interatomic_poten.md)**
...
**[DriftLite: Lightweight Drift Control for Inference-Time Scaling of Diffusion Models](computational_biology/driftlite_lightweight_drift_control_for_inference-time_scaling_of_diffusion_mode.md)**
...
**[EvoFlows: Evolutionary Edit-Based Flow-Matching for Protein Engineering](computational_biology/evoflows_evolutionary_edit-based_flow-matching_for_protein_engineering.md)**
...
**[Fine-Tuning Diffusion Models via Intermediate Distribution Shaping](computational_biology/fine-tuning_diffusion_models_via_intermediate_distribution_shaping.md)**
...
**[Fusing Pixels and Genes: Spatially-Aware Learning in Computational Pathology](computational_biology/fusing_pixels_and_genes_spatially-aware_learning_in_computational_pathology.md)**
...
**[HistoPrism: Unlocking Functional Pathway Analysis from Pan-Cancer Histology via Gene Expression Prediction](computational_biology/histoprism_unlocking_functional_pathway_analysis_from_pan-cancer_histology_via_g.md)**
...
**[How to Make the Most of Your Masked Language Model for Protein Engineering](computational_biology/how_to_make_the_most_of_your_masked_language_model_for_protein_engineering.md)**
...
**[Intrinsic Lorentz Neural Network](computational_biology/intrinsic_lorentz_neural_network.md)**
...
**[mCLM: A Modular Chemical Language Model that Generates Functional and Makeable Molecules](computational_biology/mclm_a_modular_chemical_language_model_that_generates_functional_and_makeable_mo.md)**
...
**[Protein as a Second Language for LLMs](computational_biology/protein_as_a_second_language_for_llms.md)**
...
**[Protein Counterfactuals via Diffusion-Guided Latent Optimization](computational_biology/protein_counterfactuals_via_diffusion-guided_latent_optimization.md)**
...
**[Protein Structure Tokenization via Geometric Byte Pair Encoding](computational_biology/protein_structure_tokenization_via_geometric_byte_pair_encoding.md)**
...
**[Reverse Distillation: Consistently Scaling Protein Language Model Representations](computational_biology/reverse_distillation_consistently_scaling_protein_language_model_representations.md)**
...
**[Scalable Spatio-Temporal SE(3) Diffusion for Long-Horizon Protein Dynamics](computational_biology/scalable_spatio-temporal_se3_diffusion_for_long-horizon_protein_dynamics.md)**
...
**[SynCoGen: Synthesizable 3D Molecule Generation via Joint Reaction and Coordinate Modeling](computational_biology/syncogen_synthesizable_3d_molecule_generation_via_joint_reaction_and_coordinate_.md)**
...
**[Thompson Sampling via Fine-Tuning of LLMs](computational_biology/thompson_sampling_via_fine-tuning_of_llms.md)**
...
**[Tracing Pharmacological Knowledge in Large Language Models](computational_biology/tracing_pharmacological_knowledge_in_large_language_models.md)**
...
**[Unified Biomolecular Trajectory Generation via Pretrained Variational Bridge](computational_biology/unified_biomolecular_trajectory_generation_via_pretrained_variational_bridge.md)**
...
**[Ultra-Fast Language Generation via Discrete Diffusion Divergence Instruct](llm_efficiency/ultra-fast_language_generation_via_discrete_diffusion_divergence_instruct.md)**
...
**[Augmenting Representations with Scientific Papers](physics/augmenting_representations_with_scientific_papers.md)**
...
**[Deep Learning for Subspace Regression](physics/deep_learning_for_subspace_regression.md)**
...
**[DGNet: Discrete Green Networks for Data-Efficient Learning of Spatiotemporal PDEs](physics/dgnet_discrete_green_networks_for_data-efficient_learning_of_spatiotemporal_pdes.md)**
...
**[DRIFT-Net: A Spectral--Coupled Neural Operator for PDEs Learning](physics/drift-net_a_spectral--coupled_neural_operator_for_pdes_learning.md)**
...
**[Empirical Stability Analysis of Kolmogorov-Arnold Networks in Hard-Constrained Recurrent Physics-Informed Discovery](physics/empirical_stability_analysis_of_kolmogorov-arnold_networks_in_hard-constrained_r.md)**
...
**[HyperKKL: Enabling Non-Autonomous State Estimation through Dynamic Weight Conditioning](physics/hyperkkl_enabling_non-autonomous_state_estimation_through_dynamic_weight_conditi.md)**
...
**[Learning-guided Kansa Collocation for Forward and Inverse PDE Problems](physics/learning-guided_kansa_collocation_for_forward_and_inverse_pde_problems.md)**
...
**[One Operator to Rule Them All? On Boundary-Indexed Operator Families in Neural PDE Solvers](physics/one_operator_to_rule_them_all_on_boundary-indexed_operator_families_in_neural_pd.md)**
...
**[Supervised Metric Regularization Through Alternating Optimization for Multi-Regime PINNs](physics/supervised_metric_regularization_through_alternating_optimization_for_multi-regi.md)**
...
**[Enhancing Hallucination Detection through Noise Injection](hallucination/enhancing_hallucination_detection_through_noise_injection.md)**
...
**[Hallucination Begins Where Saliency Drops](hallucination/hallucination_begins_where_saliency_drops.md)**
...
**[Look Carefully: Adaptive Visual Reinforcements in Multimodal Large Language Models for Hallucination Mitigation](hallucination/look_carefully_adaptive_visual_reinforcements_in_multimodal_large_language_model.md)**
...
**[LUMINA: Detecting Hallucinations in RAG System with Context-Knowledge Signals](hallucination/lumina_detecting_hallucinations_in_rag_system_with_context-knowledge_signals.md)**
...
**[SHIELD: Suppressing Hallucinations In LVLM Encoders via Bias and Vulnerability Defense](hallucination/shield_suppressing_hallucinations_in_lvlm_encoders_via_bias_and_vulnerability_de.md)**
...
**[Token-Guard: Towards Token-Level Hallucination Control via Self-Checking Decoding](hallucination/token-guard_towards_token-level_hallucination_control_via_self-checking_decoding.md)**
...
**[VeriTrail: Closed-Domain Hallucination Detection with Traceability](hallucination/veritrail_closed-domain_hallucination_detection_with_traceable_evidence_synthes.md)**
...
**[BiomedSQL: Text-to-SQL for Scientific Reasoning on Biomedical Knowledge Bases](medical_nlp/biomedsql_text-to-sql_for_scientific_reasoning_on_biomedical_knowledge_bases.md)**
...
**[MedAgentGym: A Scalable Agentic Training Environment for Code-Centric Reasoning in Biomedical Data Science](medical_nlp/medagentgym_agentic_training_biomedical.md)**
