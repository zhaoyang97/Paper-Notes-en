...
description: >-
  [ICLR 2026][Computational Biology][Set prediction] CORDS is a framework that bijectively maps variable-size discrete sets (detection boxes, molecular atoms) to continuous density and feature fields…
tags:
  - "ICLR 2026"
