---
title: >-
  CVPR2026 VLM Efficiency Papers · 62 Notes
description: >-
  62 CVPR2026 papers in the VLM Efficiency area, covering Multimodal/VLM, Model Compression, Compression, LLM, Diffusion Models and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "CVPR2026"
  - "VLM Efficiency"
  - "AI paper notes"
...
item_list:
  ...
  - u: "better_stronger_faster_tackling_the_trilemma_in_mllm-based_segmentation_with_sim/"
    t: "Better, Stronger, Faster: Tackling the Trilemma in MLLM-based Segmentation with Simultaneous Textual Mask Prediction"
  ...
  - u: "curvature-aware_zeroth-order_optimization_for_memory-efficient_test-time_adaptat/"
    t: "Curvature-Aware Zeroth-Order Optimization for Memory-Efficient Test-Time Adaptation"
  - u: "differentiable_vector_quantization_for_rate-distortion_optimization_of_generativ/"
    t: "Differentiable Vector Quantization for Rate-Distortion Optimization of Generative Image Compression"
  - u: "docpruneefficient_document_question_answering_via_background_question_and_compre/"
    t: "DocPrune: Efficient Document Question Answering via Background, Question, and Comprehension-aware Token Pruning"
  - u: "duet-vlm_dual_stage_unified_efficient_token_reduction_for_vlm_training_and_infer/"
    t: "DUET-VLM: Dual Stage Unified Efficient Token Reduction for VLM Training and Inference"
  - u: "dynamic_token_reweighting_for_robust_vision-language_models/"
    t: "Dynamic Token Reweighting for Robust Vision-Language Models"
  - u: "evocomp_learning_visual_token_compression_for_multimodal_large_language_models_v/"
    t: "EvoComp: Learning Visual Token Compression for Multimodal Large Language Models via Semantic-Guided Evolutionary Labeling"
  - u: "fine-grained_post-training_quantization_for_large_vision_language_models_with_qu/"
    t: "Fine-Grained Post-Training Quantization for Large Vision Language Models with Quantization-Aware Integrated Gradients"
  - u: "flashcache_frequency_kv_cache_compression/"
    t: "FlashCache: Frequency-Domain-Guided Outlier-KV-Aware Multimodal KV Cache Compression"
  - u: "focusui_efficient_ui_grounding_via_position-preserving_visual_token_selection/"
    t: "FocusUI: Efficient UI Grounding via Position-Preserving Visual Token Selection"
  - u: "groundvts_visual_token_sampling_in_multimodal_large_language_models_for_video_te/"
    t: "GroundVTS: Visual Token Sampling in Multimodal Large Language Models for Video Temporal Grounding"
  - u: "hawk_head_importance-aware_visual_token_pruning_in_multimodal_models/"
    t: "HAWK: Head Importance-Aware Visual Token Pruning in Multimodal Models"
  - u: "hi-lo_prune_look_at_what_youll_lose_before_pruning_with_hierarchical_token_selec/"
    t: "Hi-Lo Prune: Look at What You'll Lose before Pruning with Hierarchical Token Selection"
  - u: "httm_head-wise_temporal_token_merging_for_faster_vggt/"
    t: "HTTM: Head-wise Temporal Token Merging for Faster VGGT"
  - u: "hybrid_token_compression_for_vision-language_models/"
    t: "Hybrid Token Compression for Vision-Language Models"
  - u: "if-prune_information-flow_guided_token_pruning_for_efficient_vision-language_mod/"
    t: "IF-Prune: Information-Flow Guided Token Pruning for Efficient Vision-Language Models"
  - u: "lift_and_place_a_simple_stable_and_effective_knowledge_distillation_framework_fo/"
    t: "LIFT and PLACE: A Simple, Stable, and Effective Knowledge Distillation Framework for Lightweight Diffusion Models"
  - u: "litevggt_boosting_vanilla_vggt_via_geometry-aware_cached_token_merging/"
    t: "LiteVGGT: Boosting Vanilla VGGT via Geometry-aware Cached Token Merging"
  - u: "ls-vit_least-squares_hessian_based_block_reconstruction_for_low-bit_post-trainin/"
    t: "LS-ViT: Least-Squares Hessian Based Block Reconstruction for Low-Bit Post-Training Quantization of Vision Transformers"
  - u: "masquant_modality-aware_smoothing_quantization_for_multimodal_large_language_mod/"
    t: "MASQuant: Modality-Aware Smoothing Quantization for Multimodal Large Language Models"
  - u: "merge3d_efficient_3d_multimodal_llms_via_joint_2d-3d_token_merging/"
    t: "Merge3D: Efficient 3D Multimodal LLMs via Joint 2D-3D Token Merging"
item_total: 62
---
...
**📷 CVPR2026** · **62** paper notes

📌 **Same area in other venues:** [🔬 ICLR2026 (18)](../../ICLR2026/vlm_efficiency/index.md) · [💬 ACL2026 (6)](../../ACL2026/vlm_efficiency/index.md) · [🧪 ICML2026 (4)](../../ICML2026/vlm_efficiency/index.md) · [🤖 AAAI2026 (5)](../../AAAI2026/vlm_efficiency/index.md) · [🧠 NeurIPS2025 (8)](../../NeurIPS2025/vlm_efficiency/index.md) · [📹 ICCV2025 (11)](../../ICCV2025/vlm_efficiency/index.md)

🔥 **Top topics:** Multimodal/VLM ×31 · Model Compression ×20 · Compression ×9 · LLM ×7 · Diffusion Models ×3
