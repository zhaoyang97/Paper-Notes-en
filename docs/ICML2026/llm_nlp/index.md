---
title: >-
  ICML2026 LLM / NLP Papers · 39 Notes
description: >-
  39 ICML2026 papers in the LLM / NLP area, covering LLM, Diffusion Models, Adversarial Robustness and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "LLM / NLP"
  - "AI paper notes"
...
item_list:
  ...
  - u: "escaping_mode_collapse_in_llm_generation_via_geometric_regulation/"
    t: "Escaping Mode Collapse in LLM Generation via Geometric Regulation"
  ...
  - u: "ive_seen_how_this_goes_characterizing_diversity_via_progressive_conditional_surp/"
    t: "\"I've Seen How This Goes\": Characterizing LLM and Human Writing Diversity via Progressive Conditional Surprisal"
  ...
  - u: "model-preserving_adaptive_rounding/"
    t: "YAQA: End-to-End KL Minimization LLM Adaptive Weight Quantization"
  - u: "multi-agent_teams_hold_experts_back/"
    t: "Multi-Agent Teams Hold Experts Back: Why Self-Organizing LLM Teams Cannot Retain \"Experts\""
...
📌 **Same area in other venues:** [💬 ACL2026 (59)](../../ACL2026/llm_nlp/index.md) · [📷 CVPR2026 (9)](../../CVPR2026/llm_nlp/index.md) · [🔬 ICLR2026 (35)](../../ICLR2026/llm_nlp/index.md) · [🤖 AAAI2026 (32)](../../AAAI2026/llm_nlp/index.md) · [🧠 NeurIPS2025 (48)](../../NeurIPS2025/llm_nlp/index.md) · [📹 ICCV2025 (6)](../../ICCV2025/llm_nlp/index.md)

🔥 **Top topics:** LLM ×15 · Diffusion Models ×4 · Adversarial Robustness ×2
...
**["I've Seen How This Goes": Characterizing LLM and Human Writing Diversity via Progressive Conditional Surprisal](ive_seen_how_this_goes_characterizing_diversity_via_progressive_conditional_surp.md)**
...
**[YAQA: End-to-End KL Minimization LLM Adaptive Weight Quantization](model-preserving_adaptive_rounding.md)**
...
**[Multi-Agent Teams Hold Experts Back: Why Self-Organizing LLM Teams Cannot Retain "Experts"](multi-agent_teams_hold_experts_back.md)**
...
**[SPA-Cache: Singular Proxies for Adaptive Caching in Diffusion Language Models](spa-cache_singular_proxies_for_adaptive_caching_in_diffusion_language_models.md)**
...
**[Structured Generalized Linear Token Mixing: Shifting Gears Between Complexity and Expressivity with SND + Kronecker](trading_complexity_for_expressivity_through_structured_generalized_linear_token_.md)**
...
**[In-Context Routing (ICR): Train Once, Use Everywhere via Attention-Level Implicit ICL](train_once_reuse_everywhere_generalizable_implicit_in-context_learning_by_routin.md)**
...
**[Universal Reasoner: Composable Plug-and-Play Reasoners for Frozen LLMs](universal_reasoner_a_single_composable_plug-and-play_reasoner_for_frozen_llms.md)**
