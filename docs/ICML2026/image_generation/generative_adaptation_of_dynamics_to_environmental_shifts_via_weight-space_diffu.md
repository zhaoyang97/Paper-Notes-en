...
description: >-
  [ICML 2026][Image Generation][Weight-space diffusion] DynaDiff reframes the meta-learning problem of "training a predictor for a new environment" as a conditional sampling task of "directly generating the full network we…
tags:
  - "ICML 2026"
  - "Image Generation"
