---
title: >-
  CVPR2026 Accepted Papers List · 3703 Notes
description: >-
...
[Browse all 39 LLM Agent papers →](llm_agent/)
...
[Browse all 11 LLM Safety papers →](llm_safety/)

---

## 👻 Hallucination Detection (32) { #hallucination }
...
[Browse all 32 Hallucination Detection papers →](hallucination/)
...
## 🎨 Image Generation (434) { #image_generation }
...
[Browse all 434 Image Generation papers →](image_generation/)

---

## 🎬 Video Generation (152) { #video_generation }
...
**[Archon: A Unified Multimodal Model for Holistic Digital Human Generation](video_generation/archon_a_unified_multimodal_model_for_holistic_digital_human_generation.md)**
...
**[Are Image-to-Video Models Good Zero-Shot Image Editors?](video_generation/are_image-to-video_models_good_zero-shot_image_editors.md)**
...
[Browse all 152 Video Generation papers →](video_generation/)

---

## 🧩 Multimodal VLM (388) { #multimodal_vlm }
...
[Browse all 388 Multimodal VLM papers →](multimodal_vlm/)

---

## 🧠 VLM Reasoning (144) { #vlm_reasoning }
...
[Browse all 144 VLM Reasoning papers →](vlm_reasoning/)

---

## ⚡ VLM Efficiency (62) { #vlm_efficiency }
...
[Browse all 62 VLM Efficiency papers →](vlm_efficiency/)
...
## 🔎 AIGC Detection (7) { #aigc_detection }
...
[Browse all 646 3D Vision papers →](3d_vision/)

---

## 🎯 Object Detection (97) { #object_detection }
...
[Browse all 97 Object Detection papers →](object_detection/)

---

## ✂️ Segmentation (117) { #segmentation }
...
[Browse all 117 Segmentation papers →](segmentation/)

---

## 🖼️ Image Restoration (107) { #image_restoration }
...
[Browse all 107 Image Restoration papers →](image_restoration/)

---

## 🛰️ Remote Sensing (57) { #remote_sensing }
...
[Browse all 57 Remote Sensing papers →](remote_sensing/)
...
## 🧑 Human Understanding (138) { #human_understanding }
...
**[BoostSLT: Boosting Sign Language Translation via a Plug-and-Play Diffusion-Based Semantic Enhancer](human_understanding/boostslt_boosting_sign_language_translation_via_a_plug-and-play_diffusion-based_.md)**
...
[Browse all 138 Human Understanding papers →](human_understanding/)

---

## 📹 Video Understanding (178) { #video_understanding }
...
**[Asynchronous Temporal Modeling with Two-Agent Framework for Streaming Dense Video Captioning](video_understanding/asynchronous_temporal_modeling_with_two-agent_framework_for_streaming_dense_vide.md)**
...
[Browse all 178 Video Understanding papers →](video_understanding/)

---

## 🚗 Autonomous Driving (140) { #autonomous_driving }
...
**[CARD: A Multi-Modal Automotive Dataset for Dense 3D Reconstruction in Challenging Road Topography](autonomous_driving/card_a_multi-modal_automotive_dataset_for_dense_3d_reconstruction_in_challenging.md)**
...
[Browse all 140 Autonomous Driving papers →](autonomous_driving/)

---

## 🤖 Robotics & Embodied AI (130) { #robotics }
...
[Browse all 130 Robotics & Embodied AI papers →](robotics/)

---

## 🎮 Reinforcement Learning (23) { #reinforcement_learning }
...
**[Local Motion Matters: A Deconstruct-Recompose Paradigm for Reinforcement Learning Pre-training from Videos](reinforcement_learning/local_motion_matters_a_deconstruct-recompose_paradigm_for_reinforcement_learning.md)**
...
[Browse all 23 Reinforcement Learning papers →](reinforcement_learning/)

---

## 🔄 Self-Supervised Learning (89) { #self_supervised }
...
[Browse all 89 Self-Supervised Learning papers →](self_supervised/)
...
## 🔬 Interpretability (33) { #interpretability }
...
[Browse all 33 Interpretability papers →](interpretability/)

---

## 📦 Model Compression (98) { #model_compression }
...
[Browse all 98 Model Compression papers →](model_compression/)
...
## 🤝 Federated Learning (18) { #federated_learning }
...
**[GDFA: Geometry-Driven Federated Unlearning with Directional Task Vector Alignment](federated_learning/gdfa_geometry-driven_federated_unlearning_with_directional_task_vector_alignment.md)**
...
[Browse all 18 Federated Learning papers →](federated_learning/)
...
## 🏥 Medical Imaging (163) { #medical_imaging }
...
[Browse all 163 Medical Imaging papers →](medical_imaging/)

---

## 🧬 Computational Biology (19) { #computational_biology }
...
[Browse all 19 Computational Biology papers →](computational_biology/)

---

## 🛡️ AI Safety (143) { #ai_safety }
...
**[Bias at the End of the Score](ai_safety/bias_at_the_end_of_the_score.md)**
...
[Browse all 143 AI Safety papers →](ai_safety/)
...
**[Bias In, Bias Out? Finding Unbiased Subnetworks in Vanilla Models](others/bias_in_bias_out_finding_unbiased_subnetworks_in_vanilla_models.md)**
...
[Browse all 98 Others papers →](others/)
...
## 🔍 Information Retrieval & RAG (9) { #information_retrieval }
...
**[Language-driven Fine-grained Retrieval](information_retrieval/language-driven_fine-grained_retrieval.md)**
...
**[Mask to Align, Weight to Disambiguate: Reliable Unsupervised Cross-Modal Hashing with Masked-Weight Contrast](information_retrieval/mask_to_align_weight_to_disambiguate_reliable_unsupervised_cross-modal_hashing_w.md)**
...
**[POGA: Paraphrased and Oppositional Graph Alignment for Fine-Grained Cross-Modal Retrieval](information_retrieval/poga_paraphrased_and_oppositional_graph_alignment_for_fine-grained_cross-modal_r.md)**
...
**[ProM3E: Probabilistic Masked MultiModal Embedding Model for Ecology](information_retrieval/prom3e_probabilistic_masked_multimodal_embedding_model_for_ecology.md)**
