...
description: >-
  [ICLR 2026][Causal Inference][LLM uncertainty] This paper proposes SelfReflect — an information-theoretic distance metric that measures the discrepancy between an LLM's self-reported uncertainty summary and its true inte…
tags:
  - "ICLR 2026"
  - "Causal Inference"
  - "LLM uncertainty"
