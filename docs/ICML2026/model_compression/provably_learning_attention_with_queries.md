...
description: >-
  [ICML 2026][Model Compression][model stealing] The authors prove that single-head softmax attention can be exactly recovered with remarkable simplicity under value-query access—requiring only $O(d^2)$ queries…
tags:
  - "ICML 2026"
  - "Model Compression"
  - "model stealing"
