...
description: >-
  [ICML 2026][Image Generation][Offline BBO] SPADE replaces the traditional regression surrogate with a conditional diffusion model to model $p(y\mid\boldsymbol{x})$…
tags:
  - "ICML 2026"
  - "Image Generation"
  - "Offline BBO"
