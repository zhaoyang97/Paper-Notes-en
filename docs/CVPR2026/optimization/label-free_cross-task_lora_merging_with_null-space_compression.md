...
description: >-
  [CVPR 2026][Optimization][Model Merging] Motivated by the observation that the null-space ratio of the down-projection matrix $\mathbf{A}$ decreases during LoRA fine-tuning and is strongly correlated with task performanc…
tags:
  - "CVPR 2026"
  - "Optimization"
  - "Model Merging"
