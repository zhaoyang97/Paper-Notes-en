---
title: >-
  ICML2026 Accepted Papers List · 1463 Notes
description: >-
  1463 ICML2026 paper notes covering Image Generation (125), Model Compression (100), Multimodal VLM (99), Reinforcement Learning (95), Interpretability (71), Optimization & Theory (64), LLM Reasoning (63), LLM Safety (46) and other 50 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
...
item_list:
  ...
  - u: "image_generation/beyond_generative_priors_minority_sampling_with_jepa-guided_diffusion/"
  ...
  - u: "image_generation/dgs-net_distillation-guided_gradient_surgery_for_clip_fine-tuning_in_ai-generate/"
    t: "DGS-Net: Distillation-Guided Gradient Surgery for CLIP Fine-Tuning in AI-Generated Image Detection"
  - u: "image_generation/diagnosing_and_correcting_concept_omission_in_multimodal_diffusion_transformers/"
...
[Browse all 46 LLM Safety papers →](llm_safety/)
...
## ⚡ LLM Efficiency (32) { #llm_efficiency }
...
**[Do Transformers Need Three Projections? A Systematic Study of QKV Sharing Schemes](llm_efficiency/do_transformers_need_three_projections_systematic_study_of_qkv_variants.md)**
...
**[DOT-MoE: Converting Dense LLMs to MoE with Differentiable Optimal Transport](llm_efficiency/dot-moe_differentiable_optimal_transport_for_moefication.md)**
...
[Browse all 32 LLM Efficiency papers →](llm_efficiency/)

---

## ⚖️ Alignment & RLHF (26) { #llm_alignment }
...
**[GIST: Targeted Data Selection for Instruction Tuning via Gradient Subspace Projection](llm_alignment/gist_targeted_data_selection_for_instruction_tuning_via_coupled_optimization_geo.md)**
...
[Browse all 26 Alignment & RLHF papers →](llm_alignment/)
...
## 📚 Pretraining (22) { #llm_pretraining }
...
[Browse all 22 Pretraining papers →](llm_pretraining/)

---

## 👻 Hallucination Detection (19) { #hallucination }

**[Adaptive Residual-Update Steering for Low-Overhead Hallucination Mitigation in Large Vision Language Models](hallucination/adaptive_residual-update_steering_for_low-overhead_hallucination_mitigation_in_l.md)**
...
**[Automatic Layer Selection for Hallucination Detection](hallucination/automatic_layer_selection_for_hallucination_detection.md)**
...
**[Building Reliable Long-Form Generation via Hallucination Rejection Sampling](hallucination/building_reliable_long-form_generation_via_hallucination_rejection_sampling.md)**
...
**[Capturing Gaze Shifts for Guidance: Cross-Modal Fusion Enhancement for VLM Hallucination Mitigation](hallucination/capturing_gaze_shifts_for_guidance_cross-modal_fusion_enhancement_for_vlm_halluc.md)**
...
**[Finding the Correct Visual Evidence Without Forgetting: Mitigating Hallucination in LVLMs via Inter-Layer Visual Attention Discrepancy](hallucination/finding_the_correct_visual_evidence_without_forgetting_mitigating_hallucination_.md)**
...
**[From Flat Facts to Sharp Hallucinations: Detecting Stubborn Errors via Gradient Sensitivity](hallucination/from_flat_facts_to_sharp_hallucinations_detecting_stubborn_errors_via_gradient_s.md)**
...
**[From Out-of-Distribution Detection to Hallucination Detection: A Geometric View](hallucination/from_out-of-distribution_detection_to_hallucination_detection_a_geometric_view.md)**
...
**[Hallucination is a Consequence of Space-Optimality: A Rate-Distortion Theorem for Membership Testing](hallucination/hallucination_is_a_consequence_of_space-optimality_a_rate-distortion_theorem_for.md)**
...
**[Hallucinations Undermine Trust; Metacognition is a Way Forward](hallucination/hallucinations_undermine_trust_metacognition_is_a_way_forward.md)**
...
**[Harnessing Reasoning Trajectories for Hallucination Detection via Answer-agreement Representation Shaping](hallucination/harnessing_reasoning_trajectories_for_hallucination_detection_via_answer-agreeme.md)**
...
[Browse all 19 Hallucination Detection papers →](hallucination/)
...
**[MASPOB: Multi-Agent Prompt Optimization via GNN Surrogate + LinUCB + Coordinate Ascent](multi_agent/maspob_bandit-based_prompt_optimization_for_multi-agent_systems_with_graph_neura.md)**
...
**["I've Seen How This Goes": Characterizing LLM and Human Writing Diversity via Progressive Conditional Surprisal](llm_nlp/ive_seen_how_this_goes_characterizing_diversity_via_progressive_conditional_surp.md)**
...
## 🔍 Information Retrieval & RAG (23) { #information_retrieval }
...
[Browse all 23 Information Retrieval & RAG papers →](information_retrieval/)

---

## 💻 Code Intelligence (15) { #code_intelligence }
...
[Browse all 15 Code Intelligence papers →](code_intelligence/)

---

## 🗣️ Dialogue Systems (4) { #dialogue }
...
## 🌐 Multilingual & Translation (3) { #multilingual_mt }
...
## 🎨 Image Generation (125) { #image_generation }
...
[Browse all 125 Image Generation papers →](image_generation/)

---

## 🧩 Multimodal VLM (99) { #multimodal_vlm }
...
[Browse all 99 Multimodal VLM papers →](multimodal_vlm/)
...
## 🎬 Video Generation (28) { #video_generation }
...
[Browse all 28 Video Generation papers →](video_generation/)
...
[Browse all 24 3D Vision papers →](3d_vision/)

---

## 📹 Video Understanding (17) { #video_understanding }
...
[Browse all 17 Video Understanding papers →](video_understanding/)

---

## 🖼️ Image Restoration (16) { #image_restoration }
...
[Browse all 16 Image Restoration papers →](image_restoration/)

---

## ✂️ Segmentation (13) { #segmentation }
...
[Browse all 13 Segmentation papers →](segmentation/)

---

## 🎯 Object Detection (6) { #object_detection }
...
## 🧑 Human Understanding (4) { #human_understanding }
...
## 🛰️ Remote Sensing (3) { #remote_sensing }
...
## 🎮 Reinforcement Learning (95) { #reinforcement_learning }
...
[Browse all 95 Reinforcement Learning papers →](reinforcement_learning/)
...
## 🎁 Recommender Systems (11) { #recommender }
...
[Browse all 11 Recommender Systems papers →](recommender/)

---

## 🚗 Autonomous Driving (6) { #autonomous_driving }
...
## 🔬 Interpretability (71) { #interpretability }
...
[Browse all 71 Interpretability papers →](interpretability/)

---

## 📐 Optimization & Theory (64) { #optimization }
...
[Browse all 64 Optimization & Theory papers →](optimization/)

---

## 📈 Time Series (32) { #time_series }
...
[Browse all 32 Time Series papers →](time_series/)

---

## 🕸️ Graph Learning (31) { #graph_learning }
...
[Browse all 31 Graph Learning papers →](graph_learning/)

---

## 🔄 Self-Supervised Learning (24) { #self_supervised }
...
[Browse all 24 Self-Supervised Learning papers →](self_supervised/)

---

## 📐 Learning Theory (17) { #learning_theory }
...
[Browse all 17 Learning Theory papers →](learning_theory/)

---

## 🔗 Causal Inference (15) { #causal_inference }
...
[Browse all 15 Causal Inference papers →](causal_inference/)

---

## 🛡️ AI Safety (41) { #ai_safety }
...
[Browse all 41 AI Safety papers →](ai_safety/)

---

## 🧬 Computational Biology (36) { #computational_biology }
...
**[CoSiNE: Conditional Site-Independent Neural Evolution Model for Antibody Sequences](computational_biology/conditionally_site-independent_neural_evolution_of_antibody_sequences.md)**
...
[Browse all 36 Computational Biology papers →](computational_biology/)

---

## ⚛️ Physics & Scientific Computing (26) { #physics }
...
[Browse all 26 Physics & Scientific Computing papers →](physics/)

---

## 🏥 Medical Imaging (24) { #medical_imaging }
...
[Browse all 24 Medical Imaging papers →](medical_imaging/)

---

## 👥 Social Computing (8) { #social_computing }
...
[Browse all 63 Others papers →](others/)
