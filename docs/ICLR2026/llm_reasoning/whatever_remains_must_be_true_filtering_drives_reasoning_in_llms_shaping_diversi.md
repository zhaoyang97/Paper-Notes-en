...
description: >-
  [ICLR 2026][LLM Reasoning][α-divergence] This paper proposes the DMVR framework and the α-DPG algorithm. By explicitly defining a target distribution that "filters out incorrect answers" and approximating it via the α-di…
tags:
  - "ICLR 2026"
  - "LLM Reasoning"
  - "α-divergence"
