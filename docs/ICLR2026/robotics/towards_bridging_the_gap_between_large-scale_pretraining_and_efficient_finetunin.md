...
description: >-
  [ICLR 2026][Robotics][humanoid robot control] LIFT proposes a three-stage pretraining-finetuning framework: (i) large-scale parallel SAC pretraining for zero-shot deployment…
tags:
  - "ICLR 2026"
  - "Robotics"
