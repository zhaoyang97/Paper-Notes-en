...
description: >-
  [CVPR 2026][Autonomous Driving][3D Geometric Perception] This paper proposes VGGDrive, a framework that injects cross-view geometric perception into VLMs via a frozen 3D visual foundation model (VGGT). A plug-and-play CV…
tags:
  - "CVPR 2026"
  - "Autonomous Driving"
