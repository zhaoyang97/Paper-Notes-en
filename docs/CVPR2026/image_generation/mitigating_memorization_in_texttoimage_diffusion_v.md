...
description: >-
  [CVPR 2026][Image Generation][diffusion model memorization] This paper proposes two complementary modules — Region-Aware Prompt Augmentation at Training time (RAPTA) and Attention-Driven Multimodal Copy Detection (ADMCD)…
tags:
  - "CVPR 2026"
  - "Image Generation"
