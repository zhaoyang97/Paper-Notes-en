...
description: >-
  [ICLR 2026][Image Generation][Geographical diversity] The GeoDiv framework is proposed to utilize the world knowledge of LLMs and VLMs to systematically evaluate the geographical diversity of T2I models across two dimensions: the Socio-Economic Visual Index (SEVI) and the Visual Diversity Index (VDI). It reveals systematic impoverishment biases in models against countries such as India and Nigeria.
tags:
  - "ICLR 2026"
  - "Image Generation"
