---
title: >-
  ICML2026 LLM Agent Papers · 59 Notes
description: >-
  59 ICML2026 papers in the LLM Agent area, covering LLM, Agents, Reasoning, Reinforcement Learning and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "LLM Agent"
  - "AI paper notes"
...
item_list:
  ...
  - u: "a_systematic_study_of_behavioral_cloning_for_scientific_data_annotation/"
    t: "A Systematic Study of Behavioral Cloning for Scientific Data Annotation"
  ...
  - u: "adamem_test-time_adaptive_memory_for_language_agents/"
    t: "AdaMEM: Test-Time Adaptive Memory for Language Agents"
  ...
  - u: "agentic_monte_carlo_simulating_reinforcement_learning_for_black-box_agents/"
    t: "Agentic Monte Carlo: Simulating Reinforcement Learning for Black-Box Agents"
  ...
  - u: "closing_the_feedback_loop_from_experience_extraction_to_insight_governance_in_ve/"
    t: "Closing the Feedback Loop: From Experience Extraction to Insight Governance in Verbal Reinforcement Learning"
  - u: "coda-bench_can_code_agents_handle_data-intensive_tasks/"
    t: "CoDA-Bench: Can Code Agents Handle Data-Intensive Tasks?"
  - u: "collabbench_benchmarking_and_unleashing_collaborative_ability_of_llms_with_diver/"
    t: "CollabBench: Benchmarking and Unleashing Collaborative Ability of LLMs with Diverse Players via Proactive Engagement"
  ...
  - u: "evoclaw_evaluating_ai_agents_on_continuous_software_evolution/"
    t: "EvoClaw: Evaluating AI Agents on Continuous Software Evolution"
  ...
  - u: "from_player_to_master_enhancing_test-time_learning_of_llm_agents_via_reinforceme/"
    t: "From Player to Master: Enhancing Test-Time Learning of LLM Agents via Reinforcement Learning over Memory"
  ...
  - u: "its_a_trap_task-redirecting_agent_persuasion_benchmark_for_web_agents/"
    t: "It's a TRAP! Task-Redirecting Agent Persuasion Benchmark for Web Agents"
  ...
  - u: "macarena_benchmarking_computer_use_agents_on_an_online_macos_environment/"
    t: "MacArena: Benchmarking Computer Use Agents on an Online macOS Environment"
  - u: "mcp-persona_benchmarking_llm_agents_on_real-world_personal_applications_via_envi/"
    t: "MCP-Persona: Evaluating LLM Agent Capabilities in Real-World Personal Applications via Environment Simulation"
  - u: "measuring_agents_in_production/"
    t: "Measuring Agents in Production"
  - u: "memory_is_reconstructed_not_retrieved_graph_memory_for_llm_agents/"
    t: "Memory is Reconstructed, Not Retrieved: Graph Memory for LLM Agents"
...
📌 **Same area in other venues:** [📷 CVPR2026 (39)](../../CVPR2026/llm_agent/index.md) · [🔬 ICLR2026 (162)](../../ICLR2026/llm_agent/index.md) · [💬 ACL2026 (82)](../../ACL2026/llm_agent/index.md) · [🤖 AAAI2026 (33)](../../AAAI2026/llm_agent/index.md) · [🧠 NeurIPS2025 (39)](../../NeurIPS2025/llm_agent/index.md) · [📹 ICCV2025 (4)](../../ICCV2025/llm_agent/index.md)
...
**[A Systematic Study of Behavioral Cloning for Scientific Data Annotation](a_systematic_study_of_behavioral_cloning_for_scientific_data_annotation.md)**
...
**[ACON: Optimizing Context Compression for Long-horizon LLM Agents](acon_optimizing_context_compression_for_long-horizon_llm_agents.md)**
...
**[AdaMEM: Test-Time Adaptive Memory for Language Agents](adamem_test-time_adaptive_memory_for_language_agents.md)**
...
**[Agent JIT Compilation for Latency-Optimizing Web Agent Planning and Scheduling](agent_jit_compilation_for_latency-optimizing_web_agent_planning_and_scheduling.md)**
...
**[Agentic Monte Carlo: Simulating Reinforcement Learning for Black-Box Agents](agentic_monte_carlo_simulating_reinforcement_learning_for_black-box_agents.md)**
...
**[Answer Only as Precisely as Justified: Calibrated Claim-Level Specificity Control for Agentic Systems](answer_only_as_precisely_as_justified_calibrated_claim-level_specificity_control.md)**
...
**[AutoRPA: Efficient GUI Automation through LLM-Driven Code Synthesis from Interactions](autorpa_efficient_gui_automation_through_llm-driven_code_synthesis_from_interact.md)**
...
**[Closing the Feedback Loop: From Experience Extraction to Insight Governance in Verbal Reinforcement Learning](closing_the_feedback_loop_from_experience_extraction_to_insight_governance_in_ve.md)**
...
**[CoDA-Bench: Can Code Agents Handle Data-Intensive Tasks?](coda-bench_can_code_agents_handle_data-intensive_tasks.md)**
...
**[CollabBench: Benchmarking and Unleashing Collaborative Ability of LLMs with Diverse Players via Proactive Engagement](collabbench_benchmarking_and_unleashing_collaborative_ability_of_llms_with_diver.md)**
...
**[Constitutional Black-Box Monitoring for Scheming in LLM Agents](constitutional_black-box_monitoring_for_scheming_in_llm_agents.md)**
...
**[EvoClaw: Evaluating AI Agents on Continuous Software Evolution](evoclaw_evaluating_ai_agents_on_continuous_software_evolution.md)**
...
**[From Player to Master: Enhancing Test-Time Learning of LLM Agents via Reinforcement Learning over Memory](from_player_to_master_enhancing_test-time_learning_of_llm_agents_via_reinforceme.md)**
...
**[Hunt Instead of Wait: Evaluating Deep Data Research on Large Language Models](hunt_instead_of_wait_evaluating_deep_data_research_on_large_language_models.md)**
...
**[It's a TRAP! Task-Redirecting Agent Persuasion Benchmark for Web Agents](its_a_trap_task-redirecting_agent_persuasion_benchmark_for_web_agents.md)**
...
**[Learning Efficient Guardrails for Compliance](learning_efficient_guardrails_for_compliance.md)**
...
**[LLM Agents Are the Antidote to Walled Gardens](llm_agents_are_the_antidote_to_walled_gardens.md)**
...
**[MacArena: Benchmarking Computer Use Agents on an Online macOS Environment](macarena_benchmarking_computer_use_agents_on_an_online_macos_environment.md)**
...
**[MCP-Persona: Evaluating LLM Agent Capabilities in Real-World Personal Applications via Environment Simulation](mcp-persona_benchmarking_llm_agents_on_real-world_personal_applications_via_envi.md)**
...
**[Measuring Agents in Production](measuring_agents_in_production.md)**
...
**[Memory is Reconstructed, Not Retrieved: Graph Memory for LLM Agents](memory_is_reconstructed_not_retrieved_graph_memory_for_llm_agents.md)**
...
**[NaviAgent: Graph-Driven Bilevel Planning for Scalable Tool Orchestration](naviagent_graph-driven_bilevel_planning_for_scalable_tool_orchestration.md)**
...
**[On Information Self-Locking in Reinforcement Learning for Active Reasoning of LLM Agents](on_information_self-locking_in_reinforcement_learning_for_active_reasoning_of_ll.md)**
...
**[Persona2Web: Benchmarking Personalized Web Agents for Contextual Reasoning with User History](persona2web_benchmarking_personalized_web_agents_for_contextual_reasoning_with_u.md)**
...
**[Position: Modular Memory is the Key to Continual Learning Agents](position_modular_memory_is_the_key_to_continual_learning_agents.md)**
...
**[Post-Training LLMs as Better Decision-Making Agents: A Regret-Minimization Approach](post-training_llms_as_better_decision-making_agents_a_regret-minimization_approa.md)**
...
**[Process Reward Agents for Steering Knowledge-Intensive Reasoning](process_reward_agents_for_steering_knowledge-intensive_reasoning.md)**
...
**[Recovering Policy-Induced Errors: Benchmarking and Trajectory Synthesis for Robust GUI Agents](recovering_policy-induced_errors_benchmarking_and_trajectory_synthesis_for_robus.md)**
...
**[ReflexGrad: Within-Episode Failure Recovery in LLM Agents via Progress-Gated Dual-Process Routing](reflexgrad_within-episode_failure_recovery_in_llm_agents_via_progress-gated_dual.md)**
...
**[Rule2DRC: Benchmarking LLM Agents for DRC Script Synthesis with Execution-Guided Test Generation](rule2drc_benchmarking_llm_agents_for_drc_script_synthesis_with_execution-guided_.md)**
...
**[Scaling, Benchmarking, and Reasoning of Vision-Language Agents for Mobile GUI Navigation](scaling_benchmarking_and_reasoning_of_vision-language_agents_for_mobile_gui_navi.md)**
...
**[Scaling Small Agents Through Strategy Auctions](scaling_small_agents_through_strategy_auctions.md)**
...
**[SE-GA: Memory-Augmented Self-Evolution for GUI Agents](se-ga_memory-augmented_self-evolution_for_gui_agents.md)**
...
**[Self-evolving LLM agents with in-distribution Optimization](self-evolving_llm_agents_with_in-distribution_optimization.md)**
...
**[Skill-Pro: Learning Reusable Skills from Experience via Non-Parametric PPO for LLM Agents](skill-pro_learning_reusable_skills_from_experience_via_non-parametric_ppo_for_ll.md)**
...
**[Talk, Judge, Cooperate: Gossip-Driven Indirect Reciprocity in Self-Interested LLM Agents](talk_judge_cooperate_gossip-driven_indirect_reciprocity_in_self-interested_llm_a.md)**
...
**[Think Twice Before You Act: Enhancing Agent Behavioral Safety with Thought Correction](think_twice_before_you_act_enhancing_agent_behavioral_safety_with_thought_correc.md)**
...
**[Towards a Science of AI Agent Reliability](towards_a_science_of_ai_agent_reliability.md)**
...
**[Towards Diverse Scientific Hypothesis Search with Large Language Models](towards_diverse_scientific_hypothesis_search_with_large_language_models.md)**
...
**[Towards Feedback-to-Plan Decisions for Self-Evolving LLM Agents in CUDA Kernel Generation](towards_feedback-to-plan_decisions_for_self-evolving_llm_agents_in_cuda_kernel_g.md)**
...
**[Towards Pareto-Optimal Tool-Integrated Agents with Pareto Ranking Policy Optimization](towards_pareto-optimal_tool-integrated_agents_with_pareto_ranking_policy_optimiz.md)**
...
**[Weasel: Achieving Out-of-Distribution Generalization for Web Agents via Importance-Diversity Data Selection](weasel_out-of-domain_generalization_for_web_agents_via_importance-diversity_data.md)**
...
**[Web Agents Should Use Typed Actions Instead of Click-Based Browsing](web_agents_should_use_typed_actions_instead_of_click-based_browsing.md)**
