---
title: >-
  ICML2026 Model Compression Papers · 100 Notes
description: >-
  100 ICML2026 papers in the Model Compression area, covering Model Compression, LLM, Compression, Reasoning, Adversarial Robustness, Diffusion Models and more. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ICML2026"
  - "Model Compression"
  - "AI paper notes"
...
item_list:
  ...
  - u: "active_budget_allocation_for_efficient_scaling_law_estimation_via_surrogate-guid/"
    t: "Active Budget Allocation for Efficient Scaling Law Estimation via Surrogate-Guided Pruning"
  ...
  - u: "advantage_collapse_in_group_relative_policy_optimization_diagnosis_and_mitigatio/"
    t: "Advantage Collapse in Group Relative Policy Optimization: Diagnosis and Mitigation"
  - u: "an_algebraic_view_of_the_expressivity_of_recurrent_language_models/"
    t: "An Algebraic View of the Expressivity of Recurrent Language Models"
  - u: "arcvq-vae_a_spherical_vector_quantization_framework_with_arccosine_additive_marg/"
    t: "ArcVQ-VAE: A Spherical Vector Quantization Framework with ArcCosine Additive Margin"
  - u: "area_attribute_extraction_and_aggregation_for_clip-based_class-incremental_learn/"
    t: "AREA: Attribute Extraction and Aggregation for CLIP-Based Class-Incremental Learning"
  - u: "auditing_and_fixing_economic_validity_in_tabular_foundation_models_for_discrete_/"
    t: "Auditing and Fixing Economic Validity in Tabular Foundation Models for Discrete Choice"
  - u: "beyond_temperature_hyperfitting_as_a_late-stage_geometric_expansion/"
    t: "Beyond Temperature: Hyperfitting as a Late-Stage Geometric Expansion"
  - u: "beyond_tokens_enhancing_rtl_quality_estimation_via_structural_graph_learning/"
    t: "Beyond Tokens: Enhancing RTL Quality Estimation via Structural Graph Learning"
  - u: "bioarc_discovering_optimal_neural_architectures_for_biological_foundation_models/"
    t: "BioArc: Discovering Optimal Neural Architectures for Biological Foundation Models"
  - u: "bounded_hyperbolic_tangent_a_stable_and_efficient_alternative_to_pre-layer_norma/"
    t: "Bounded Hyperbolic Tangent: A Stable and Efficient Alternative to Pre-Layer Normalization in Large Language Models"
  - u: "breaking_the_moe_llm_trilemma_dynamic_expert_clustering_with_structured_compress/"
    t: "Breaking the MoE LLM Trilemma: Dynamic Expert Clustering with Structured Compression"
  - u: "causal_forcing_autoregressive_diffusion_distillation_done_right_for_high-quality/"
    t: "Causal Forcing: Autoregressive Diffusion Distillation Done Right for High-Quality Real-Time Interactive Video"
  - u: "compositional_consistency-guided_decoding_for_three-way_logical_question_answeri/"
    t: "Compositional Consistency-Guided Decoding for Three-Way Logical Question Answering"
  - u: "compress_then_merge_from_multiple_loras_into_one_low-rank_adapter/"
    t: "Compress then Merge: From Multiple LoRAs into One Low-Rank Adapter"
  - u: "continual_model_routing_in_evolving_model_hubs/"
    t: "Continual Model Routing in Evolving Model Hubs"
  - u: "critique-guided_distillation_for_robust_reasoning_via_refinement/"
    t: "Critique-Guided Distillation for Robust Reasoning via Refinement"
  - u: "dag-moe_from_simple_mixture_to_structural_aggregation_in_mixture-of-experts/"
    t: "DAG-MoE: From Simple Mixture to Structural Aggregation in Mixture-of-Experts"
  ...
  - u: "decouple_searching_from_training_scaling_data_mixing_via_model_merging_for_large/"
    t: "Decouple Searching from Training: Scaling Data Mixing via Model Merging for Large Language Model Pre-training"
  - u: "demystifying_when_pruning_works_via_representation_hierarchies/"
    t: "Demystifying When Pruning Works via Representation Hierarchies"
  - u: "detecting_fluent_optimization-based_adversarial_prompts_via_sequential_entropy_c/"
    t: "Detecting Fluent Optimization-Based Adversarial Prompts via Sequential Entropy Changes"
  - u: "dispersion_loss_counteracts_embedding_condensation_and_improves_generalization_i/"
    t: "Dispersion Loss Counteracts Embedding Condensation and Improves Generalization in Small Language Models"
  - u: "diverdiving_deeper_into_distilled_data_via_expressive_semantic_recovery/"
    t: "DIVER: Diving Deeper into Distilled Data via Expressive Semantic Recovery"
  - u: "dont_ignore_the_tail_decoupling_top-k_probabilities_for_efficient_language_model/"
    t: "Don't Ignore the Tail: Decoupling top-K Probabilities for Efficient Language Model Distillation"
  - u: "dsl-topic_improving_topic_modeling_by_distilling_soft_labelsfrom_language_models/"
    t: "DSL-Topic: Improving Topic Modeling by Distilling Soft Labels from Language Models"
  - u: "easier_to_judge_than_to_find_predicting_in-context_learning_success_for_demonstr/"
...
**🧪 ICML2026** · **100** paper notes

📌 **Same area in other venues:** [💬 ACL2026 (59)](../../ACL2026/model_compression/index.md) · [📷 CVPR2026 (54)](../../CVPR2026/model_compression/index.md) · [🔬 ICLR2026 (100)](../../ICLR2026/model_compression/index.md) · [🤖 AAAI2026 (60)](../../AAAI2026/model_compression/index.md) · [🧠 NeurIPS2025 (140)](../../NeurIPS2025/model_compression/index.md) · [📹 ICCV2025 (52)](../../ICCV2025/model_compression/index.md)

🔥 **Top topics:** Model Compression ×17 · LLM ×15 · Compression ×11 · Reasoning ×5 · Adversarial Robustness ×4
...
**[Active Budget Allocation for Efficient Scaling Law Estimation via Surrogate-Guided Pruning](active_budget_allocation_for_efficient_scaling_law_estimation_via_surrogate-guid.md)**
...
**[Advantage Collapse in Group Relative Policy Optimization: Diagnosis and Mitigation](advantage_collapse_in_group_relative_policy_optimization_diagnosis_and_mitigatio.md)**
...
**[An Algebraic View of the Expressivity of Recurrent Language Models](an_algebraic_view_of_the_expressivity_of_recurrent_language_models.md)**
...
**[AREA: Attribute Extraction and Aggregation for CLIP-Based Class-Incremental Learning](area_attribute_extraction_and_aggregation_for_clip-based_class-incremental_learn.md)**
...
**[Auditing and Fixing Economic Validity in Tabular Foundation Models for Discrete Choice](auditing_and_fixing_economic_validity_in_tabular_foundation_models_for_discrete_.md)**
...
**[Beyond Temperature: Hyperfitting as a Late-Stage Geometric Expansion](beyond_temperature_hyperfitting_as_a_late-stage_geometric_expansion.md)**
...
**[Beyond Tokens: Enhancing RTL Quality Estimation via Structural Graph Learning](beyond_tokens_enhancing_rtl_quality_estimation_via_structural_graph_learning.md)**
...
**[BioArc: Discovering Optimal Neural Architectures for Biological Foundation Models](bioarc_discovering_optimal_neural_architectures_for_biological_foundation_models.md)**
...
**[Bounded Hyperbolic Tangent: A Stable and Efficient Alternative to Pre-Layer Normalization in Large Language Models](bounded_hyperbolic_tangent_a_stable_and_efficient_alternative_to_pre-layer_norma.md)**
...
**[Causal Forcing: Autoregressive Diffusion Distillation Done Right for High-Quality Real-Time Interactive Video](causal_forcing_autoregressive_diffusion_distillation_done_right_for_high-quality.md)**
...
**[Compositional Consistency-Guided Decoding for Three-Way Logical Question Answering](compositional_consistency-guided_decoding_for_three-way_logical_question_answeri.md)**
...
**[Compress then Merge: From Multiple LoRAs into One Low-Rank Adapter](compress_then_merge_from_multiple_loras_into_one_low-rank_adapter.md)**
...
**[Continual Model Routing in Evolving Model Hubs](continual_model_routing_in_evolving_model_hubs.md)**
...
**[Critique-Guided Distillation for Robust Reasoning via Refinement](critique-guided_distillation_for_robust_reasoning_via_refinement.md)**
...
**[DAG-MoE: From Simple Mixture to Structural Aggregation in Mixture-of-Experts](dag-moe_from_simple_mixture_to_structural_aggregation_in_mixture-of-experts.md)**
...
**[Decouple Searching from Training: Scaling Data Mixing via Model Merging for Large Language Model Pre-training](decouple_searching_from_training_scaling_data_mixing_via_model_merging_for_large.md)**
...
**[Detecting Fluent Optimization-Based Adversarial Prompts via Sequential Entropy Changes](detecting_fluent_optimization-based_adversarial_prompts_via_sequential_entropy_c.md)**
...
**[DIVER: Diving Deeper into Distilled Data via Expressive Semantic Recovery](diverdiving_deeper_into_distilled_data_via_expressive_semantic_recovery.md)**
...
**[DSL-Topic: Improving Topic Modeling by Distilling Soft Labels from Language Models](dsl-topic_improving_topic_modeling_by_distilling_soft_labelsfrom_language_models.md)**
...
**[Easier to Judge Than to Find: Predicting In-Context Learning Success for Demonstration Selection](easier_to_judge_than_to_find_predicting_in-context_learning_success_for_demonstr.md)**
...
**[Effective Model Pruning: Measure the Redundancy of Model Components](effective_model_pruning_measure_the_redundancy_of_model_components.md)**
...
**[Efficient Learned Image Compression without Entropy Coding](efficient_learned_image_compression_without_entropy_coding.md)**
...
**[End-to-End Compression for Tabular Foundation Models](end-to-end_compression_for_tabular_foundation_models.md)**
...
**[Energy-Structured Low-Rank Adaptation for Continual Learning](energy-structured_low-rank_adaptation_for_continual_learning.md)**
...
**[Entropy-Aware On-Policy Distillation of Language Models](entropy-aware_on-policy_distillation_of_language_models.md)**
...
**[EpiCache: Episodic KV Cache Management for Long-Term Conversation on Resource-Constrained Environments](epicache_episodic_kv_cache_management_for_long-term_conversation_on_resource-con.md)**
...
**[Event2Vec: Processing Neuromorphic Events Directly by Representations in Vector Space](event2vec_processing_neuromorphic_events_directly_by_representations_in_vector_s.md)**
...
**[EVL-ECG: Efficient ECG Interpretation With Multi-Aspect Heterogeneous Knowledge Distillation](evl-ecg_efficient_ecg_interpretation_with_multi-aspect_heterogeneous_knowledge_d.md)**
...
**[Exploiting Weight-Space Symmetries for Approximating Curvature](exploiting_weight-space_symmetries_for_approximating_curvature.md)**
...
**[FedSDR: Federated Self-Distillation with Rectification](fedsdr_federated_self-distillation_with_rectification.md)**
...
**[Finer Parameter Steps for Low-Rank PEFT: A Controlled Study with CP Tensor Adapters](finer_parameter_steps_for_low-rank_peft_a_controlled_study_with_cp_tensor_adapte.md)**
...
**[Float8@2bits: Entropy Coding Enables Data-Free Model Compression](float82bits_entropy_coding_enables_data-free_model_compression.md)**
...
**[GEMQ: Global Expert-Level Mixed-Precision Quantization for MoE LLMs](gemq_global_expert-level_mixed-precision_quantization_for_moe_llms.md)**
...
**[Geo-Expert: Fine-tuning 8B Models into Expert-Level Geological Reasoning LLMs using LoRA](geo-expert_towards_expert-level_geological_reasoning_via_parameter-efficient_fin.md)**
...
**[Global Convergence of Adaptive Sensing for Principal Eigenvector Estimation](global_convergence_of_adaptive_sensing_for_principal_eigenvector_estimation.md)**
...
**[IDLM: Inverse-distilled Diffusion Language Models](idlm_inverse-distilled_diffusion_language_models.md)**
...
**[Images as Tables: In-Context Learning with TabPFN for Low-Data Detection of AI-Generated Images](images_as_tables_in-context_learning_with_tabpfn_for_low-data_detection_of_ai-ge.md)**
...
**[Jailbreak to Protect: Buffering and Reinforcing via Temporary Jailbreaking for Safe Fine-Tuning in Large Language Models](jailbreak_to_protect_buffering_and_reinforcing_via_temporary_jailbreaking_for_sa.md)**
...
**[LiftQuant: Continuous Bit-Width LLM via Dimensional Lifting and Projection](liftquant_continuous_bit-width_llm_via_dimensional_lifting_and_projection.md)**
...
**[LK Losses: Direct Acceptance Rate Optimization for Speculative Decoding](lk_losses_direct_acceptance_rate_optimization_for_speculative_decoding.md)**
...
**[MIC: Maximizing Informational Capacity in Adaptive Representations via Isotropic Subspace Alignment](mic_maximizing_informational_capacity_in_adaptive_representations_via_isotropic_.md)**
...
**[Mind Your Margin and Boundary: Are Your Distilled Datasets Truly Robust?](mind_your_margin_and_boundary_are_your_distilled_datasets_truly_robust.md)**
...
**[Multi-Adapter Representation Interventions via Energy Calibration](multi-adapter_representation_interventions_via_energy_calibration.md)**
...
**[NanoQuant: Efficient Sub-1-Bit Quantization of Large Language Models](nanoquant_efficient_sub-1-bit_quantization_of_large_language_models.md)**
...
**[NeUQI: Near-Optimal Uniform Quantization Parameter Initialization for Low-Bit LLMs](neuqi_near-optimal_uniform_quantization_parameter_initialization_for_low-bit_llm.md)**
...
**[Partial Fusion of Neural Networks: Efficient Tradeoffs Between Ensembles and Weight Aggregation](partial_fusion_of_neural_networks_efficient_tradeoffs_between_ensembles_and_weig.md)**
...
**[PRISM: Synergizing Vision Foundation Models via Self-Organized Expert Specialization](prism_synergizing_vision_foundation_models_via_self-organized_expert_specializat.md)**
...
**[Procedural Pretraining: Warming Up Language Models with Abstract Data](procedural_pretraining_warming_up_language_models_with_abstract_data.md)**
...
**[ProjQ: Project-and-Quantize for Adapter-Aware LLM Compression](projq_project-and-quantize_for_adapter-aware_llm_compression.md)**
...
**[Quantifying the Uncertainty of Foundation Models with Singular Value Ensembles](quantifying_the_uncertainty_of_foundation_models_with_singular_value_ensembles.md)**
...
**[RaBiT: Residual-Aware Binarization Training for Accurate and Efficient LLMs](rabit_residual-aware_binarization_training_for_accurate_and_efficient_llms.md)**
...
**[Saliency-Aware Model Merging](saliency-aware_model_merging.md)**
...
**[Selective Coupling of Decoupled Informative Regions: Masked Attention Alignment for Data-Free Quantization of Vision Transformers](selective_coupling_of_decoupled_informative_regions_masked_attention_alignment_f.md)**
...
**[SPEED-Bench: A Unified and Diverse Benchmark for Speculative Decoding](speed-bench_a_unified_and_diverse_benchmark_for_speculative_decoding.md)**
...
**[The Bridge-Garden Dilemma in LLM Distillation: Why Mixing Hard and Soft Labels Works](the_bridge-garden_dilemma_in_llm_distillation_why_mixing_hard_and_soft_labels_wo.md)**
...
**[Toward Understanding Adversarial Distillation: Why Robust Teachers Fail](toward_understanding_adversarial_distillation_why_robust_teachers_fail.md)**
...
**[T3S: Training Trajectory-Aware Token Selection to Break "Imitation Shock" in Reasoning Distillation](training-trajectory-aware_token_selection.md)**
...
**[WinQ: Accelerating Quantization-Aware Training of Language Models Around Saddle Points](winq_accelerating_quantization-aware_training_of_language_models_around_saddle_p.md)**
...
**[WUSH: Near-Optimal Adaptive Transforms for LLM Quantization](wush_near-optimal_adaptive_transforms_for_llm_quantization.md)**
...
**[xKV: Cross-Layer KV-Cache Compression via Aligned Singular Vector Extraction](xkv_cross-layer_kv-cache_compression_via_aligned_singular_vector_extraction.md)**
...
**[ZipMoE: Efficient On-Device MoE Serving via Lossless Compression and Cache-Affinity Scheduling](zipmoe_efficient_on-device_moe_serving_via_lossless_compression_and_cache-affini.md)**
