...
description: >-
  [ACL 2026][LLM Efficiency][SWA] BOSCH decomposes head-level SWA selection into three-stage large neighborhood search, systematically outperforming layer-level heuristics and static head-level methods across 4 models and 4 ratio settings.
tags:
  - ACL 2026
  - LLM Efficiency
