...
description: >-
  [ACL 2026][Multi-Agent][Prompt injection attacks] This paper investigates conjunctive prompt attacks in multi-agent LLM systems: a trigger key embedded in a user query and a hidden template injected into a compromised re…
tags:
  - "ACL 2026"
  - "Multi-Agent"
