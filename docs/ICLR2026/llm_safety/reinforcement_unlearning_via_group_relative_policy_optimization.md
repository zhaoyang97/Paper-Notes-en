...
description: >-
  [ICLR 2026][LLM Safety][Machine Unlearning] PURGE reformulates LLM unlearning as a verifiable RL task, employing the GRPO framework with intrinsic reward signals (penalizing mentions of forbidden concepts) to achieve saf…
tags:
  - "ICLR 2026"
  - "LLM Safety"
  - "Machine Unlearning"
