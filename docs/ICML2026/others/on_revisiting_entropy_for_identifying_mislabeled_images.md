...
description: >-
  [ICML 2026][Mislabeled Image Detection] The authors discover that the phenomenon where "mislabeled samples exhibit persistently high predictive entropy throughout training" is insufficient to distinguish them from hard c…
tags:
  - "ICML 2026"
