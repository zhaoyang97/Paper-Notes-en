...
description: >-
  680 ACL2026 paper notes covering LLM Safety (66), Multimodal VLM (46), LLM Agent (45), LLM Reasoning (44), LLM Evaluation (42), Information Retrieval & RAG (37), Medical Imaging (37), Audio & Speech (35) and other 33 areas. Each note has TL;DR, motivation, method, experiments, highlights, and limitations — 5-minute reads of core ideas.
tags:
  - "ACL2026"
  - "AI paper notes"
...
**[Cognitive Policy-Driven LLM for Diagnosis and Intervention of Cognitive Distortions in Emotional Support Conversation](medical_imaging/cognitive_policy-driven_llm_for_diagnosis_and_intervention_of_cognitive_distorti.md)**
...
**[DART: Mitigating Harm Drift in Difference-Aware LLMs via Distill-Audit-Repair Training](medical_imaging/dart_mitigating_harm_drift_in_difference-aware_llms_via_distill-audit-repair_tra.md)**
...
**[Dialectic-Med: Mitigating Diagnostic Hallucinations via Counterfactual Adversarial Multi-Agent Debate](medical_imaging/dialectic-med_mitigating_diagnostic_hallucinations_via_counterfactual_adversaria.md)**
...
**[ProtoCycle: Reflective Tool-Augmented Planning for Text-Guided Protein Design](medical_imaging/protocycle_reflective_tool-augmented_planning_for_text-guided_protein_design.md)**
