...
description: >-
  [ICML 2026][Multimodal VLM][3D Layout Generation] R³L attributes the two systematic errors in MLLM multi-hop "relative spatial relation" reasoning (semantic drift and metric drift) to "repeated reference frame transforma…
tags:
  - "ICML 2026"
  - "Multimodal VLM"
