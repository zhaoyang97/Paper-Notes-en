...
description: >-
  [ICLR 2026][Interpretability][alignment audit] This paper constructs an automated prompt-level red-teaming pipeline (powered by Claude Opus 4.5) to augment situational awareness and strategic reasoning in existing fine-t…
tags:
  - "ICLR 2026"
  - "Interpretability"
  - "alignment audit"
