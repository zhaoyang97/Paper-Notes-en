...
description: >-
  [ICLR 2026][Model Compression][Model Merging] This paper proposes RAIN-Merging, a gradient-free two-stage model merging method: it first applies null-space projection to preserve the thinking format of Large Reasoning Mo…
tags:
  - "ICLR 2026"
  - "Model Compression"
  - "Model Merging"
